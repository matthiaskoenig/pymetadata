...
with the package: looking up a term in OLS (`pymetadata.webservices.ols`) does not
pay for them. They are generated by the internal `_ontology_builder` module and
