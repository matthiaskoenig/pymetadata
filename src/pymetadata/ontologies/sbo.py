...
class SBO(OntologyTerm):
    """SBO ontology."""

    SBO_0000000: "SBO"
    """systems biology representation: Representation of an entity used in a systems biology knowledge reconstruction, such as a model, pathway, network."""

    SYSTEMS_BIOLOGY_REPRESENTATION: "SBO"
    """systems biology representation: Representation of an entity used in a systems biology knowledge reconstruction, such as a model, pathway, network."""

    SBO_0000001: "SBO"
    """rate law: mathematical description that relates quantities of reactants to the reaction velocity."""

    RATE_LAW: "SBO"
    """rate law: mathematical description that relates quantities of reactants to the reaction velocity."""

    SBO_0000002: "SBO"
    """quantitative systems description parameter: A numerical value that defines certain characteristics of systems or system functions. It may be part of a calculation, but its value is not determined by the form of the equation itself, and may be arbitrarily assigned."""

    QUANTITATIVE_SYSTEMS_DESCRIPTION_PARAMETER: "SBO"
    """quantitative systems description parameter: A numerical value that defines certain characteristics of systems or system functions. It may be part of a calculation, but its value is not determined by the form of the equation itself, and may be arbitrarily assigned."""

    SBO_0000003: "SBO"
    """participant role: The function of a physical or conceptual entity, that is its role, in the execution of an event or process."""

    PARTICIPANT_ROLE: "SBO"
    """participant role: The function of a physical or conceptual entity, that is its role, in the execution of an event or process."""

    SBO_0000004: "SBO"
    """modelling framework: Set of assumptions that underlay a mathematical description."""

    MODELLING_FRAMEWORK: "SBO"
    """modelling framework: Set of assumptions that underlay a mathematical description."""

    SBO_0000005: "SBO"
    """obsolete mathematical expression: The description of a system in mathematical terms."""

    OBSOLETE_MATHEMATICAL_EXPRESSION: "SBO"
    """obsolete mathematical expression: The description of a system in mathematical terms."""

    SBO_0000006: "SBO"
    """obsolete parameter: A numerical value that represents the amount of some entity, process or mathematical function of the system."""

    OBSOLETE_PARAMETER: "SBO"
    """obsolete parameter: A numerical value that represents the amount of some entity, process or mathematical function of the system."""

    SBO_0000007: "SBO"
    """obsolete participant type: The 'kind' of entity involved in some process, action or reaction in the system. This may be enzyme, simple chemical, etc.."""

    OBSOLETE_PARTICIPANT_TYPE: "SBO"
    """obsolete participant type: The 'kind' of entity involved in some process, action or reaction in the system. This may be enzyme, simple chemical, etc.."""

    SBO_0000008: "SBO"
    """obsolete modelling framework: Basic assumptions that underlie a mathematical model."""

    OBSOLETE_MODELLING_FRAMEWORK: "SBO"
    """obsolete modelling framework: Basic assumptions that underlie a mathematical model."""

    SBO_0000009: "SBO"
    """kinetic constant: Synonym: reaction rate constant"""

    KINETIC_CONSTANT: "SBO"
    """kinetic constant: Synonym: reaction rate constant"""
    ...
    SBO_0000011: "SBO"
    """product: Substance that is produced in a reaction. In a chemical equation the Products are the elements or compounds on the right hand side of the reaction equation. A product can be produced and consumed by the same reaction, its global quantity remaining unchanged."""

    PRODUCT: "SBO"
    """product: Substance that is produced in a reaction. In a chemical equation the Products are the elements or compounds on the right hand side of the reaction equation. A product can be produced and consumed by the same reaction, its global quantity remaining unchanged."""

    SBO_0000012: "SBO"
    """mass action rate law: The Law of Mass Action, first expressed by Waage and Guldberg in 1864 (Waage, P.; Guldberg, C. M. Forhandlinger: Videnskabs-Selskabet i Christiana 1864, 35) states that the speed of a chemical reaction is proportional to the quantity of the reacting substances. More formally, the change of a product quantity is proportional to the product of reactant activities. In the case of a reaction occurring in a gas phase, the activities are equal to the partial pressures. In the case of a well-stirred aqueous medium, the activities are equal to the concentrations. In the case of discrete kinetic description, the quantity are expressed in number of molecules and the relevant volume are implicitely embedded in the kinetic constant."""

    MASS_ACTION_RATE_LAW: "SBO"
    """mass action rate law: The Law of Mass Action, first expressed by Waage and Guldberg in 1864 (Waage, P.; Guldberg, C. M. Forhandlinger: Videnskabs-Selskabet i Christiana 1864, 35) states that the speed of a chemical reaction is proportional to the quantity of the reacting substances. More formally, the change of a product quantity is proportional to the product of reactant activities. In the case of a reaction occurring in a gas phase, the activities are equal to the partial pressures. In the case of a well-stirred aqueous medium, the activities are equal to the concentrations. In the case of discrete kinetic description, the quantity are expressed in number of molecules and the relevant volume are implicitely embedded in the kinetic constant."""

    SBO_0000013: "SBO"
    """catalyst: Substance that accelerates the velocity of a chemical reaction without itself being consumed or transformed. This effect is achieved by lowering the free energy of the transition state."""

    CATALYST: "SBO"
    """catalyst: Substance that accelerates the velocity of a chemical reaction without itself being consumed or transformed. This effect is achieved by lowering the free energy of the transition state."""

    SBO_0000014: "SBO"
    """enzyme: A protein that catalyzes a chemical reaction. The word comes from en ('at' or 'in') and simo ('leaven' or 'yeast')."""

    ENZYME: "SBO"
    """enzyme: A protein that catalyzes a chemical reaction. The word comes from en ('at' or 'in') and simo ('leaven' or 'yeast')."""

    SBO_0000015: "SBO"
    """substrate: Molecule which is acted upon by an enzyme. The substrate binds with the enzyme's active site, and the enzyme catalyzes a chemical reaction involving the substrate."""

    SUBSTRATE: "SBO"
    """substrate: Molecule which is acted upon by an enzyme. The substrate binds with the enzyme's active site, and the enzyme catalyzes a chemical reaction involving the substrate."""

    SBO_0000016: "SBO"
    """unimolecular rate constant: Numerical parameter that quantifies the velocity of a chemical reaction involving only one reactant."""

    UNIMOLECULAR_RATE_CONSTANT: "SBO"
    """unimolecular rate constant: Numerical parameter that quantifies the velocity of a chemical reaction involving only one reactant."""

    SBO_0000017: "SBO"
    """bimolecular rate constant: Numerical parameter that quantifies the velocity of a chemical reaction involving two reactants."""

    BIMOLECULAR_RATE_CONSTANT: "SBO"
    """bimolecular rate constant: Numerical parameter that quantifies the velocity of a chemical reaction involving two reactants."""

    SBO_0000018: "SBO"
    """trimolecular rate constant: Numerical parameter that quantifies the velocity of a chemical reaction involving three reactants."""

    TRIMOLECULAR_RATE_CONSTANT: "SBO"
    """trimolecular rate constant: Numerical parameter that quantifies the velocity of a chemical reaction involving three reactants."""

    SBO_0000019: "SBO"
    """modifier: Substance that changes the velocity of a process without itself being consumed or transformed by the reaction."""

    MODIFIER: "SBO"
    """modifier: Substance that changes the velocity of a process without itself being consumed or transformed by the reaction."""

    SBO_0000020: "SBO"
    """inhibitor: Substance that decreases the probability of a chemical reaction without itself being consumed or transformed by the reaction."""

    INHIBITOR: "SBO"
    """inhibitor: Substance that decreases the probability of a chemical reaction without itself being consumed or transformed by the reaction."""

    SBO_0000021: "SBO"
    """potentiator: Synonym: activator"""

    POTENTIATOR: "SBO"
    """potentiator: Synonym: activator"""

    SBO_0000022: "SBO"
    """forward unimolecular rate constant: Numerical parameter that quantifies the forward velocity of a chemical reaction involving only one reactant. This parameter encompasses all the contributions to the velocity except the quantity of the reactant."""

    FORWARD_UNIMOLECULAR_RATE_CONSTANT: "SBO"
    """forward unimolecular rate constant: Numerical parameter that quantifies the forward velocity of a chemical reaction involving only one reactant. This parameter encompasses all the contributions to the velocity except the quantity of the reactant."""

    SBO_0000023: "SBO"
    """forward bimolecular rate constant: Numerical parameter that quantifies the forward velocity of a chemical reaction involving two reactants. This parameter encompasses all the contributions to the velocity except the quantity of the reactants."""

    FORWARD_BIMOLECULAR_RATE_CONSTANT: "SBO"
    """forward bimolecular rate constant: Numerical parameter that quantifies the forward velocity of a chemical reaction involving two reactants. This parameter encompasses all the contributions to the velocity except the quantity of the reactants."""

    SBO_0000024: "SBO"
    """forward trimolecular rate constant: Numerical parameter that quantifies the forward velocity of a chemical reaction involving three reactants. This parameter encompasses all the contributions to the velocity except the quantity of the reactants."""

    FORWARD_TRIMOLECULAR_RATE_CONSTANT: "SBO"
    """forward trimolecular rate constant: Numerical parameter that quantifies the forward velocity of a chemical reaction involving three reactants. This parameter encompasses all the contributions to the velocity except the quantity of the reactants."""

    SBO_0000025: "SBO"
    """catalytic rate constant: Synonym: turnover number"""

    CATALYTIC_RATE_CONSTANT: "SBO"
    """catalytic rate constant: Synonym: turnover number"""
    ...
    SBO_0000027: "SBO"
    """Michaelis constant: Synonym: Michaelis-Menten constant"""

    MICHAELIS_CONSTANT: "SBO"
    """Michaelis constant: Synonym: Michaelis-Menten constant"""

    SBO_0000028: "SBO"
    """enzymatic rate law for irreversible non-modulated non-interacting unireactant enzymes: Kinetics of enzymes that react only with one substance, their substrate. The enzymes do not catalyse the reactions in both directions."""

    ENZYMATIC_RATE_LAW_FOR_IRREVERSIBLE_NON_MODULATED_NON_INTERACTING_UNIREACTANT_ENZYMES: "SBO"
    """enzymatic rate law for irreversible non-modulated non-interacting unireactant enzymes: Kinetics of enzymes that react only with one substance, their substrate. The enzymes do not catalyse the reactions in both directions."""

    SBO_0000029: "SBO"
    """Henri-Michaelis-Menten rate law: First general rate equation for reactions involving enzymes, it was presented in 'Victor Henri. Lois Générales de l'Action des Diastases. Paris, Hermann, 1903.'. The reaction is assumed to be made of a reversible of the binding of the substrate to the enzyme, followed by the breakdown of the complex generating the product. Ten years after Henri, Michaelis and Menten presented a variant of his equation, based on the hypothesis that the dissociation rate of the substrate was much larger than the rate of the product generation. Leonor Michaelis, Maud Menten (1913). Die Kinetik der Invertinwirkung, Biochem. Z. 49:333-369."""

    HENRI_MICHAELIS_MENTEN_RATE_LAW: "SBO"
    """Henri-Michaelis-Menten rate law: First general rate equation for reactions involving enzymes, it was presented in 'Victor Henri. Lois Générales de l'Action des Diastases. Paris, Hermann, 1903.'. The reaction is assumed to be made of a reversible of the binding of the substrate to the enzyme, followed by the breakdown of the complex generating the product. Ten years after Henri, Michaelis and Menten presented a variant of his equation, based on the hypothesis that the dissociation rate of the substrate was much larger than the rate of the product generation. Leonor Michaelis, Maud Menten (1913). Die Kinetik der Invertinwirkung, Biochem. Z. 49:333-369."""

    SBO_0000030: "SBO"
    """Van Slyke-Cullen rate law: Rate-law presented in 'Donald D. Van Slyke and Glenn E. Cullen. The mode of action of urease and of enzymes in general. J. Biol. Chem., Oct 1914; 19: 141-180'. It assumes that the enzymatic reaction occurs as two irreversible steps.E+S -> ES -> E+P. Although of the same form than the Henri-Michaelis-Menten equation, it is semantically different since K now represents the ratio between the production rate and the association rate of the enzyme and the substrate."""

    VAN_SLYKE_CULLEN_RATE_LAW: "SBO"
    """Van Slyke-Cullen rate law: Rate-law presented in 'Donald D. Van Slyke and Glenn E. Cullen. The mode of action of urease and of enzymes in general. J. Biol. Chem., Oct 1914; 19: 141-180'. It assumes that the enzymatic reaction occurs as two irreversible steps.E+S -> ES -> E+P. Although of the same form than the Henri-Michaelis-Menten equation, it is semantically different since K now represents the ratio between the production rate and the association rate of the enzyme and the substrate."""

    SBO_0000031: "SBO"
    """Briggs-Haldane rate law: The Briggs-Haldane rate law is a general rate equation that does not require the restriction of equilibrium of Henri-Michaelis-Menten or irreversible reactions of Van Slyke, but instead make the hypothesis that the complex enzyme-substrate is in quasi-steady-state. Although of the same form than the Henri-Michaelis-Menten equation, it is semantically different since Km now represents a pseudo-equilibrium constant, and is equal to the ratio between the rate of consumption of the complex (sum of dissociation of substrate and generation of product) and the association rate of the enzyme and the substrate."""

    BRIGGS_HALDANE_RATE_LAW: "SBO"
    """Briggs-Haldane rate law: The Briggs-Haldane rate law is a general rate equation that does not require the restriction of equilibrium of Henri-Michaelis-Menten or irreversible reactions of Van Slyke, but instead make the hypothesis that the complex enzyme-substrate is in quasi-steady-state. Although of the same form than the Henri-Michaelis-Menten equation, it is semantically different since Km now represents a pseudo-equilibrium constant, and is equal to the ratio between the rate of consumption of the complex (sum of dissociation of substrate and generation of product) and the association rate of the enzyme and the substrate."""

    SBO_0000032: "SBO"
    """reverse unimolecular rate constant: Numerical parameter that quantifies the reverse velocity of a chemical reaction involving only one product. This parameter encompasses all the contributions to the velocity except the quantity of the product."""

    REVERSE_UNIMOLECULAR_RATE_CONSTANT: "SBO"
    """reverse unimolecular rate constant: Numerical parameter that quantifies the reverse velocity of a chemical reaction involving only one product. This parameter encompasses all the contributions to the velocity except the quantity of the product."""

    SBO_0000033: "SBO"
    """reverse bimolecular rate constant: Numerical parameter that quantifies the reverse velocity of a chemical reaction involving only one product. This parameter encompasses all the contributions to the velocity except the quantity of the product."""

    REVERSE_BIMOLECULAR_RATE_CONSTANT: "SBO"
    """reverse bimolecular rate constant: Numerical parameter that quantifies the reverse velocity of a chemical reaction involving only one product. This parameter encompasses all the contributions to the velocity except the quantity of the product."""

    SBO_0000034: "SBO"
    """reverse trimolecular rate constant: Numerical parameter that quantifies the reverse velocity of a chemical reaction involving three products. This parameter encompasses all the contributions to the velocity except the quantity of the products."""

    REVERSE_TRIMOLECULAR_RATE_CONSTANT: "SBO"
    """reverse trimolecular rate constant: Numerical parameter that quantifies the reverse velocity of a chemical reaction involving three products. This parameter encompasses all the contributions to the velocity except the quantity of the products."""

    SBO_0000035: "SBO"
    """forward unimolecular rate constant, continuous case: Numerical parameter that quantifies the forward velocity of a chemical reaction involving only one reactant. This parameter encompasses all the contributions to the velocity except the quantity of the reactant. It is to be used in a reaction modelled using a continuous framework."""

    FORWARD_UNIMOLECULAR_RATE_CONSTANT__CONTINUOUS_CASE: "SBO"
    """forward unimolecular rate constant, continuous case: Numerical parameter that quantifies the forward velocity of a chemical reaction involving only one reactant. This parameter encompasses all the contributions to the velocity except the quantity of the reactant. It is to be used in a reaction modelled using a continuous framework."""
    ...
    FORWARD_BIMOLECULAR_RATE_CONSTANT__CONTINUOUS_CASE: "SBO"
    """forward bimolecular rate constant, continuous case: Numerical parameter that quantifies the forward velocity of a chemical reaction involving two reactants. This parameter encompasses all the contributions to the velocity except the quantity of the reactants. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000037: "SBO"
    """forward trimolecular rate constant, continuous case: Numerical parameter that quantifies the forward velocity of a chemical reaction involving three reactants. This parameter encompasses all the contributions to the velocity except the quantity of the reactants. It is to be used in a reaction modelled using a continuous framework."""

    FORWARD_TRIMOLECULAR_RATE_CONSTANT__CONTINUOUS_CASE: "SBO"
    """forward trimolecular rate constant, continuous case: Numerical parameter that quantifies the forward velocity of a chemical reaction involving three reactants. This parameter encompasses all the contributions to the velocity except the quantity of the reactants. It is to be used in a reaction modelled using a continuous framework."""
    ...
    REVERSE_UNIMOLECULAR_RATE_CONSTANT__CONTINUOUS_CASE: "SBO"
    """reverse unimolecular rate constant, continuous case: Numerical parameter that quantifies the reverse velocity of a chemical reaction involving only one product. This parameter encompasses all the contributions to the velocity except the quantity of the product. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000039: "SBO"
    """reverse bimolecular rate constant, continuous case: Numerical parameter that quantifies the reverse velocity of a chemical reaction involving only one product. This parameter encompasses all the contributions to the velocity except the quantity of the product. It is to be used in a reaction modelled using a continuous framework."""

    REVERSE_BIMOLECULAR_RATE_CONSTANT__CONTINUOUS_CASE: "SBO"
    """reverse bimolecular rate constant, continuous case: Numerical parameter that quantifies the reverse velocity of a chemical reaction involving only one product. This parameter encompasses all the contributions to the velocity except the quantity of the product. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000040: "SBO"
    """reverse trimolecular rate constant, continuous case: Numerical parameter that quantifies the reverse velocity of a chemical reaction involving three products. This parameter encompasses all the contributions to the velocity except the quantity of the products. It is to be used in a reaction modelled using a continuous framework."""

    REVERSE_TRIMOLECULAR_RATE_CONSTANT__CONTINUOUS_CASE: "SBO"
    """reverse trimolecular rate constant, continuous case: Numerical parameter that quantifies the reverse velocity of a chemical reaction involving three products. This parameter encompasses all the contributions to the velocity except the quantity of the products. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000041: "SBO"
    """mass action rate law for irreversible reactions: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products."""

    MASS_ACTION_RATE_LAW_FOR_IRREVERSIBLE_REACTIONS: "SBO"
    """mass action rate law for irreversible reactions: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products."""

    SBO_0000042: "SBO"
    """mass action rate law for reversible reactions: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products."""

    MASS_ACTION_RATE_LAW_FOR_REVERSIBLE_REACTIONS: "SBO"
    """mass action rate law for reversible reactions: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products."""

    SBO_0000043: "SBO"
    """mass action rate law for zeroth order irreversible reactions: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is constant."""

    MASS_ACTION_RATE_LAW_FOR_ZEROTH_ORDER_IRREVERSIBLE_REACTIONS: "SBO"
    """mass action rate law for zeroth order irreversible reactions: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is constant."""
    ...
    MASS_ACTION_RATE_LAW_FOR_FIRST_ORDER_IRREVERSIBLE_REACTIONS: "SBO"
    """mass action rate law for first order irreversible reactions: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_IRREVERSIBLE_REACTIONS: "SBO"
    """mass action rate law for second order irreversible reactions: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to two reactant quantity."""

    SBO_0000046: "SBO"
    """zeroth order rate constant: Numerical parameter that quantifies the velocity of a chemical reaction independant of the reactant quantities. This parameter encompasses all the contributions to the velocity."""

    ZEROTH_ORDER_RATE_CONSTANT: "SBO"
    """zeroth order rate constant: Numerical parameter that quantifies the velocity of a chemical reaction independant of the reactant quantities. This parameter encompasses all the contributions to the velocity."""

    SBO_0000047: "SBO"
    """mass action rate law for zeroth order irreversible reactions, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is constant. It is to be used in a reaction modelled using a continuous framework."""
    ...
    SBO_0000048: "SBO"
    """forward zeroth order rate constant, continuous case: Numerical parameter that quantifies the forward velocity of a chemical reaction independant of the reactant quantities. This parameter encompasses all the contributions to the velocity. It is to be used in a reaction modelled using a continuous framework."""

    FORWARD_ZEROTH_ORDER_RATE_CONSTANT__CONTINUOUS_CASE: "SBO"
    """forward zeroth order rate constant, continuous case: Numerical parameter that quantifies the forward velocity of a chemical reaction independant of the reactant quantities. This parameter encompasses all the contributions to the velocity. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_IRREVERSIBLE_REACTIONS__ONE_REACTANT: "SBO"
    """mass action rate law for second order irreversible reactions, one reactant: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products, and the change of a product quantity is proportional to the square of one reactant quantity."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_IRREVERSIBLE_REACTIONS__ONE_REACTANT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for second order irreversible reactions, one reactant, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the square of one reactant quantity. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_IRREVERSIBLE_REACTIONS__TWO_REACTANTS: "SBO"
    """mass action rate law for second order irreversible reactions, two reactants: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of two reactants."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_IRREVERSIBLE_REACTIONS__TWO_REACTANTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for second order irreversible reactions, two reactants, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the product of two reactant quantities. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000055: "SBO"
    """mass action rate law for third order irreversible reactions: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to three reactant quantities."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_IRREVERSIBLE_REACTIONS: "SBO"
    """mass action rate law for third order irreversible reactions: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to three reactant quantities."""
    ...
    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_IRREVERSIBLE_REACTIONS__ONE_REACTANT: "SBO"
    """mass action rate law for third order irreversible reactions, one reactant: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the cube of one reactant quantity."""

    SBO_0000057: "SBO"
    """mass action rate law for third order irreversible reactions, one reactant, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products, and the change of a product quantity is proportional to the cube of one reactant quantity. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_IRREVERSIBLE_REACTIONS__ONE_REACTANT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order irreversible reactions, one reactant, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products, and the change of a product quantity is proportional to the cube of one reactant quantity. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000058: "SBO"
    """mass action rate law for third order irreversible reactions, two reactants: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant and the square of the quantity of the other reactant."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_IRREVERSIBLE_REACTIONS__TWO_REACTANTS: "SBO"
    """mass action rate law for third order irreversible reactions, two reactants: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant and the square of the quantity of the other reactant."""

    SBO_0000059: "SBO"
    """mass action rate law for third order irreversible reactions, two reactants, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant and the square of the quantity of the other reactant. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_IRREVERSIBLE_REACTIONS__TWO_REACTANTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order irreversible reactions, two reactants, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant and the square of the quantity of the other reactant. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000060: "SBO"
    """mass action rate law for third order irreversible reactions, three reactants: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of three reactants."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_IRREVERSIBLE_REACTIONS__THREE_REACTANTS: "SBO"
    """mass action rate law for third order irreversible reactions, three reactants: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of three reactants."""

    SBO_0000061: "SBO"
    """mass action rate law for third order irreversible reactions, three reactants, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products, and the change of a product quantity is proportional to the product of three reactant quantities. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_IRREVERSIBLE_REACTIONS__THREE_REACTANTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order irreversible reactions, three reactants, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products, and the change of a product quantity is proportional to the product of three reactant quantities. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000062: "SBO"
    """continuous framework: Modelling approach where the quantities of participants are considered continuous, and represented by real values. The associated simulation methods make use of differential equations."""

    CONTINUOUS_FRAMEWORK: "SBO"
    """continuous framework: Modelling approach where the quantities of participants are considered continuous, and represented by real values. The associated simulation methods make use of differential equations."""

    SBO_0000063: "SBO"
    """discrete framework: Modelling approach where the quantities of participants are considered discrete, and represented by integer values. The associated simulation methods can be deterministic or stochastic."""

    DISCRETE_FRAMEWORK: "SBO"
    """discrete framework: Modelling approach where the quantities of participants are considered discrete, and represented by integer values. The associated simulation methods can be deterministic or stochastic."""

    SBO_0000064: "SBO"
    """mathematical expression: Formal representation of a calculus linking parameters and variables of a model."""

    MATHEMATICAL_EXPRESSION: "SBO"
    """mathematical expression: Formal representation of a calculus linking parameters and variables of a model."""

    SBO_0000065: "SBO"
    """forward zeroth order rate constant, discrete case: Numerical parameter that quantifies the forward velocity of a chemical reaction independant of the reactant quantities. This parameter encompasses all the contributions to the velocity. It is to be used in a reaction modelled using a discrete framework."""

    FORWARD_ZEROTH_ORDER_RATE_CONSTANT__DISCRETE_CASE: "SBO"
    """forward zeroth order rate constant, discrete case: Numerical parameter that quantifies the forward velocity of a chemical reaction independant of the reactant quantities. This parameter encompasses all the contributions to the velocity. It is to be used in a reaction modelled using a discrete framework."""

    SBO_0000066: "SBO"
    """forward unimolecular rate constant, discrete case: Numerical parameter that quantifies the forward velocity of a chemical reaction involving only one reactant. This parameter encompasses all the contributions to the velocity except the quantity of the reactant. It is to be used in a reaction modelled using a discrete framework."""

    FORWARD_UNIMOLECULAR_RATE_CONSTANT__DISCRETE_CASE: "SBO"
    """forward unimolecular rate constant, discrete case: Numerical parameter that quantifies the forward velocity of a chemical reaction involving only one reactant. This parameter encompasses all the contributions to the velocity except the quantity of the reactant. It is to be used in a reaction modelled using a discrete framework."""

    SBO_0000067: "SBO"
    """forward bimolecular rate constant, discrete case: Numerical parameter that quantifies the forward velocity of a chemical reaction involving two reactants. This parameter encompasses all the contributions to the velocity except the quantity of the reactants. It is to be used in a reaction modelled using a discrete framework."""

    FORWARD_BIMOLECULAR_RATE_CONSTANT__DISCRETE_CASE: "SBO"
    """forward bimolecular rate constant, discrete case: Numerical parameter that quantifies the forward velocity of a chemical reaction involving two reactants. This parameter encompasses all the contributions to the velocity except the quantity of the reactants. It is to be used in a reaction modelled using a discrete framework."""

    SBO_0000068: "SBO"
    """forward trimolecular rate constant, discrete case: Numerical parameter that quantifies the forward velocity of a chemical reaction involving three reactants. This parameter encompasses all the contributions to the velocity except the quantity of the reactants. It is to be used in a reaction modelled using a discrete framework."""

    FORWARD_TRIMOLECULAR_RATE_CONSTANT__DISCRETE_CASE: "SBO"
    """forward trimolecular rate constant, discrete case: Numerical parameter that quantifies the forward velocity of a chemical reaction involving three reactants. This parameter encompasses all the contributions to the velocity except the quantity of the reactants. It is to be used in a reaction modelled using a discrete framework."""

    SBO_0000069: "SBO"
    """mass action rate law for zeroth order reversible reactions: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is constant."""

    MASS_ACTION_RATE_LAW_FOR_ZEROTH_ORDER_REVERSIBLE_REACTIONS: "SBO"
    """mass action rate law for zeroth order reversible reactions: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is constant."""

    SBO_0000070: "SBO"
    """mass action rate law for zeroth order forward, first order reverse, reversible reactions, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is constant. The rate of the reverse process is proportional to the quantity of one product. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_ZEROTH_ORDER_FORWARD__FIRST_ORDER_REVERSE__REVERSIBLE_REACTIONS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for zeroth order forward, first order reverse, reversible reactions, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is constant. The rate of the reverse process is proportional to the quantity of one product. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000071: "SBO"
    """mass action rate law for zeroth order forward, second order reverse, reversible reactions, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is constant. The rate of the reverse process is proportional totwo product quantities."""

    MASS_ACTION_RATE_LAW_FOR_ZEROTH_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for zeroth order forward, second order reverse, reversible reactions, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is constant. The rate of the reverse process is proportional totwo product quantities."""
    ...
    MASS_ACTION_RATE_LAW_FOR_ZEROTH_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_PRODUCT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for zeroth order forward, second order reverse, reversible reactions, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is constant. The rate of the reverse process is proportional to the square of one product quantity. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_ZEROTH_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for zeroth order forward, second order reverse, reversible reactions, two products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is constant. The rate of the reverse process is proportional to the product of two product quantities. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000074: "SBO"
    """mass action rate law for zeroth order forward, third order reverse, reversible reactions, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is constant. The rate of the reverse process is proportional to three product quantities."""

    MASS_ACTION_RATE_LAW_FOR_ZEROTH_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for zeroth order forward, third order reverse, reversible reactions, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is constant. The rate of the reverse process is proportional to three product quantities."""

    SBO_0000075: "SBO"
    """mass action rate law for zeroth order forward, third order reverse, reversible reactions, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is constant. The rate of the reverse process is proportional to the cube of one product quantity. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_ZEROTH_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_PRODUCT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for zeroth order forward, third order reverse, reversible reactions, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is constant. The rate of the reverse process is proportional to the cube of one product quantity. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000076: "SBO"
    """mass action rate law for zeroth order forward, third order reverse, reversible reactions, two products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is constant. The rate of the reverse process is proportional to the quantity of one product and the square of the quantity of the other product. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_ZEROTH_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for zeroth order forward, third order reverse, reversible reactions, two products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is constant. The rate of the reverse process is proportional to the quantity of one product and the square of the quantity of the other product. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000077: "SBO"
    """mass action rate law for zeroth order forward, third order reverse, reversible reactions, three products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is constant. The rate of the reverse process is proportional to the product of three product quantities. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_ZEROTH_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__THREE_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for zeroth order forward, third order reverse, reversible reactions, three products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is constant. The rate of the reverse process is proportional to the product of three product quantities. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_FIRST_ORDER_REVERSIBLE_REACTIONS: "SBO"
    """mass action rate law for first order reversible reactions: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant."""
    ...
    MASS_ACTION_RATE_LAW_FOR_FIRST_ORDER_FORWARD__ZEROTH_ORDER_REVERSE__REVERSIBLE_REACTIONS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for first order forward, zeroth order reverse, reversible reactions, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant. The rate of the reverse process is constant. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_FIRST_ORDER_FORWARD__FIRST_ORDER_REVERSE__REVERSIBLE_REACTIONS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for first order forward, first order reverse, reversible reactions, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant. The rate of the reverse process is proportional to the quantity of one product. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_FIRST_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS: "SBO"
    """mass action rate law for first order forward, second order reverse, reversible reactions: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant. The rate of the reverse process is proportional to two product quantities."""
    ...
    MASS_ACTION_RATE_LAW_FOR_FIRST_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_PRODUCT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for first order forward, second order reverse, reversible reactions, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant. The rate of the reverse process is proportional to the square of one product quantity. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_FIRST_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for first order forward, second order reverse, reversible reactions, two products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant. The rate of the reverse process is proportional to the product of two product quantities. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_FIRST_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS: "SBO"
    """mass action rate law for first order forward, third order reverse, reversible reactions: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant. The rate of the reverse process is proportional to three product quantities."""
    ...
    MASS_ACTION_RATE_LAW_FOR_FIRST_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_PRODUCT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for first order forward, third order reverse, reversible reactions, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant. The rate of the reverse process is proportional to the cube of one product quantity. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_FIRST_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for first order forward, third order reverse, reversible reactions, two products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant. The rate of the reverse process is proportional to the quantity of one product and the square of the quantity of the other product. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_FIRST_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__THREE_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for first order forward, third order reverse, reversible reactions, three products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant. The rate of the reverse process is proportional to the product of three product quantities. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_REVERSIBLE_REACTIONS: "SBO"
    """mass action rate law for second order reversible reactions: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to two reactant quantities."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__ZEROTH_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_REACTANT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for second order forward, zeroth order reverse, reversible reactions, one reactant, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the square of one reactant quantity. The rate of the reverse process is constant. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__FIRST_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_REACTANT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for second order forward, first order reverse, reversible reactions, one reactant, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the square of one reactant quantity. The rate of the reverse process is proportional to the quantity of one product. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_REACTANT: "SBO"
    """mass action rate law for second order forward, second order reverse, reversible reactions, one reactant: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the square of one reactant quantity. The rate of the reverse process is proportional to the quantity of two products."""

    SBO_0000093: "SBO"
    """mass action rate law for second order forward, second order reverse, reversible reactions, one reactant, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the square of one reactant quantity. The rate of the reverse process is proportional to the square of one product quantity. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_REACTANT__ONE_PRODUCT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for second order forward, second order reverse, reversible reactions, one reactant, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the square of one reactant quantity. The rate of the reverse process is proportional to the square of one product quantity. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for second order forward, second order reverse, reversible reactions, two products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the square of one reactant quantity. The rate of the reverse process is proportional to the product of two product quantities. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_REACTANT: "SBO"
    """mass action rate law for second order forward, third order reverse, reversible reactions, one reactant: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the square of one reactant quantity. The rate of the reverse process is proportional to the quantity of three products."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_REACTANT__ONE_PRODUCT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for second order forward, third order reverse, reversible reactions, one reactant, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the square of one reactant quantity. The rate of the reverse process is proportional to the cube of one product quantity. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_REACTANT__TWO_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for second order forward, third order reverse, reversible reactions, one reactant, two products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the square of one reactant quantity. The rate of the reverse process is proportional to the quantity of one product and the square of the quantity of the other product. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_REACTANT__THREE_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for second order forward, third order reverse, reversible reactions, one reactant, three products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the square of one reactant quantity. The rate of the reverse process is proportional to the product of three product quantities. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__REVERSIBLE_REACTIONS__TWO_REACTANTS: "SBO"
    """mass action rate law for second order forward, reversible reactions, two reactants: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of two reactant quantities."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__ZEROTH_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_REACTANTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for second order forward, zeroth order reverse, reversible reactions, two reactants, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of two reactant quantities. The rate of the reverse process is constant. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__FIRST_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_REACTANTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for second order forward, first order reverse, reversible reactions, two reactants, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of two reactant quantities. The rate of the reverse process is proportional to the quantity of one product. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_REACTANTS: "SBO"
    """mass action rate law for second order forward, second order reverse, reversible reactions, two reactants: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of two reactant quantities. The rate of the reverse process is proportional to the quantity of two products."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_REACTANTS__ONE_PRODUCT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for second order forward, second order reverse, reversible reactions, two reactants, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of two reactant quantities. The rate of the reverse process is proportional to the square of one product quantity. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_REACTANTS__TWO_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for second order forward, second order reverse, reversible reactions, two reactants, two products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of two reactant quantities. The rate of the reverse process is proportional to the product of two product quantities. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_REACTANTS: "SBO"
    """mass action rate law for second order forward, third order reverse, reversible reactions, two reactants: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of two reactant quantities. The rate of the reverse process is proportional to the quantity of three products."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_REACTANTS__ONE_PRODUCT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for second order forward, third order reverse, reversible reactions, two reactants, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of two reactant quantities. The rate of the reverse process is proportional to the cube of one product quantity. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_REACTANTS__TWO_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for second order forward, third order reverse, reversible reactions, two reactants, two products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of two reactant quantities. The rate of the reverse process is proportional to the quantity of one product and the square of the quantity of the other product. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_REACTANTS__THREE_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for second order forward, third order reverse, reversible reactions, two reactants, three products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of two reactant quantities. The rate of the reverse process is proportional to the product of three product quantities. It is to be used in a reaction modelled using a continuous framework."""
    ...
    SBO_0000111: "SBO"
    """mass action rate law for third order forward, zeroth order reverse, reversible reactions, two reactants, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant and the square of quantity of the other reactant. The rate of the reverse process is constant. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__ZEROTH_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_REACTANTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, zeroth order reverse, reversible reactions, two reactants, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant and the square of quantity of the other reactant. The rate of the reverse process is constant. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000112: "SBO"
    """mass action rate law for third order forward, first order reverse, reversible reactions, two reactants, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant and the square of quantity of the other reactant. The rate of the reverse process is proportional to the quantity of one product. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__FIRST_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_REACTANTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, first order reverse, reversible reactions, two reactants, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant and the square of quantity of the other reactant. The rate of the reverse process is proportional to the quantity of one product. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000113: "SBO"
    """mass action rate law for third order forward, second order reverse, reversible reactions, two reactants: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant and the square of quantity of the other reactant. The rate of the reverse process is proportional to the quantity of two products."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_REACTANTS: "SBO"
    """mass action rate law for third order forward, second order reverse, reversible reactions, two reactants: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant and the square of quantity of the other reactant. The rate of the reverse process is proportional to the quantity of two products."""

    SBO_0000114: "SBO"
    """mass action rate law for third order forward, second order reverse, reversible reactions, two reactants, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant and the square of quantity of the other reactant. The rate of the reverse process is proportional to the square of one product quantity. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_REACTANTS__ONE_PRODUCT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, second order reverse, reversible reactions, two reactants, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant and the square of quantity of the other reactant. The rate of the reverse process is proportional to the square of one product quantity. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_REACTANTS__TWO_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, second order reverse, reversible reactions, two reactants, two products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant and the square of quantity of the other reactant. The rate of the reverse process is proportional to the product of two product quantities. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000116: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, two reactants: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant and the square of quantity of the other reactant. The rate of the reverse process is proportional to the quantity of three products."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_REACTANTS: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, two reactants: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant and the square of quantity of the other reactant. The rate of the reverse process is proportional to the quantity of three products."""
    ...
    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_REACTANTS__ONE_PRODUCT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, two reactants, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant and the square of quantity of the other reactant. The rate of the reverse process is proportional to the cube of one product quantity. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000118: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, two reactants, two products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant and the square of quantity of the other reactant. The rate of the reverse process is proportional to the quantity of one product and the square of the quantity of the other product. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_REACTANTS__TWO_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, two reactants, two products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant and the square of quantity of the other reactant. The rate of the reverse process is proportional to the quantity of one product and the square of the quantity of the other product. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000119: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, two reactants, three products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant and the square of quantity of the other reactant. The rate of the reverse process is proportional to the product of three product quantities. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__TWO_REACTANTS__THREE_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, two reactants, three products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the quantity of one reactant and the square of quantity of the other reactant. The rate of the reverse process is proportional to the product of three product quantities. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000120: "SBO"
    """mass action rate law for third order forward, reversible reactions, three reactants: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of three reactant quantities."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__REVERSIBLE_REACTIONS__THREE_REACTANTS: "SBO"
    """mass action rate law for third order forward, reversible reactions, three reactants: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of three reactant quantities."""

    SBO_0000121: "SBO"
    """mass action rate law for third order forward, zeroth order reverse, reversible reactions, three reactants, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of three reactant quantities. The rate of the reverse process is constant. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__ZEROTH_ORDER_REVERSE__REVERSIBLE_REACTIONS__THREE_REACTANTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, zeroth order reverse, reversible reactions, three reactants, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of three reactant quantities. The rate of the reverse process is constant. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000122: "SBO"
    """mass action rate law for third order forward, first order reverse, reversible reactions, three reactants, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of three reactant quantities. The rate of the reverse process is proportional to the quantity of one product. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__FIRST_ORDER_REVERSE__REVERSIBLE_REACTIONS__THREE_REACTANTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, first order reverse, reversible reactions, three reactants, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of three reactant quantities. The rate of the reverse process is proportional to the quantity of one product. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__THREE_REACTANTS: "SBO"
    """mass action rate law for third order forward, second order reverse, reversible reactions, three reactants: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of three reactant quantities. The rate of the reverse process is proportional to the quantity of two products."""
    ...
    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__THREE_REACTANTS__ONE_PRODUCT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, second order reverse, reversible reactions, three reactants, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of three reactant quantities. The rate of the reverse process is proportional to the square of one product quantity. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__THREE_REACTANTS__TWO_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, second order reverse, reversible reactions, three reactants, two products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of three reactant quantities. The rate of the reverse process is proportional to the product of two product quantities. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000126: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, three reactants: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of three reactant quantities. The rate of the reverse process is proportional to the quantity of three products."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__THREE_REACTANTS: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, three reactants: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of three reactant quantities. The rate of the reverse process is proportional to the quantity of three products."""

    SBO_0000127: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, three reactants, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of three reactant quantities. The rate of the reverse process is proportional to the cube of one product quantity. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__THREE_REACTANTS__ONE_PRODUCT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, three reactants, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of three reactant quantities. The rate of the reverse process is proportional to the cube of one product quantity. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000128: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, three reactants, two products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of three reactant quantities. The rate of the reverse process is proportional to the quantity of one product and the square of the quantity of the other product. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__THREE_REACTANTS__TWO_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, three reactants, two products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of three reactant quantities. The rate of the reverse process is proportional to the quantity of one product and the square of the quantity of the other product. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000129: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, three reactants, three products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of three reactant quantities. The rate of the reverse process is proportional to the product of three product quantities. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__THREE_REACTANTS__THREE_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, three reactants, three products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the product of three reactant quantities. The rate of the reverse process is proportional to the product of three product quantities. It is to be used in a reaction modelled using a continuous framework."""
    ...
    SBO_0000131: "SBO"
    """mass action rate law for third order forward, zeroth order reverse, reversible reactions, one reactant, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the cube of one reactant quantity. The rate of the reverse process is constant. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__ZEROTH_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_REACTANT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, zeroth order reverse, reversible reactions, one reactant, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the cube of one reactant quantity. The rate of the reverse process is constant. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000132: "SBO"
    """mass action rate law for third order forward, first order reverse, reversible reactions, one reactant, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the cube of one reactant quantity. The rate of the reverse process is proportional to the quantity of one product. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__FIRST_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_REACTANT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, first order reverse, reversible reactions, one reactant, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the cube of one reactant quantity. The rate of the reverse process is proportional to the quantity of one product. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000133: "SBO"
    """mass action rate law for third order forward, second order reverse, reversible reactions, one reactant: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the cube of one reactant quantity. The rate of the reverse process is proportional to the quantity of two products."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_REACTANT: "SBO"
    """mass action rate law for third order forward, second order reverse, reversible reactions, one reactant: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the cube of one reactant quantity. The rate of the reverse process is proportional to the quantity of two products."""

    SBO_0000134: "SBO"
    """mass action rate law for third order forward, second order reverse, reversible reactions, one reactant, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the cube of one reactant quantity. The rate of the reverse process is proportional to the square of one product quantity. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_REACTANT__ONE_PRODUCT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, second order reverse, reversible reactions, one reactant, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the cube of one reactant quantity. The rate of the reverse process is proportional to the square of one product quantity. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__SECOND_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_REACTANT__TWO_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, second order reverse, reversible reactions, one reactant, two products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the cube of one reactant quantity. The rate of the reverse process is proportional to the product of two product quantities. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000136: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, one reactant: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the cube of one reactant quantity. The rate of the reverse process is proportional to the quantity of three products."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_REACTANT: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, one reactant: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the cube of one reactant quantity. The rate of the reverse process is proportional to the quantity of three products."""

    SBO_0000137: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, one reactant, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the cube of one reactant quantity. The rate of the reverse process is proportional to the cube of one product quantity. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_REACTANT__ONE_PRODUCT__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, one reactant, one product, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the cube of one reactant quantity. The rate of the reverse process is proportional to the cube of one product quantity. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000138: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, one reactant, two products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the cube of one reactant quantity. The rate of the reverse process is proportional to the quantity of one product and the square of the quantity of the other product. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_REACTANT__TWO_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, one reactant, two products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the cube of one reactant quantity. The rate of the reverse process is proportional to the quantity of one product and the square of the quantity of the other product. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000139: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, one reactant, three products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the cube of one reactant quantity. The rate of the reverse process is proportional to the product of three product quantities. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_FORWARD__THIRD_ORDER_REVERSE__REVERSIBLE_REACTIONS__ONE_REACTANT__THREE_PRODUCTS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for third order forward, third order reverse, reversible reactions, one reactant, three products, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products. The rate of the forward process is proportional to the cube of one reactant quantity. The rate of the reverse process is proportional to the product of three product quantities. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000140: "SBO"
    """mass action rate law for zeroth order irreversible reactions, discrete scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is constant. It is to be used in a reaction modelled using a discrete framework."""

    MASS_ACTION_RATE_LAW_FOR_ZEROTH_ORDER_IRREVERSIBLE_REACTIONS__DISCRETE_SCHEME: "SBO"
    """mass action rate law for zeroth order irreversible reactions, discrete scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is constant. It is to be used in a reaction modelled using a discrete framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_FIRST_ORDER_IRREVERSIBLE_REACTIONS__DISCRETE_SCHEME: "SBO"
    """mass action rate law for first order irreversible reactions, discrete scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant. It is to be used in a reaction modelled using a discrete framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_IRREVERSIBLE_REACTIONS__ONE_REACTANT__DISCRETE_SCHEME: "SBO"
    """mass action rate law for second order irreversible reactions, one reactant, discrete scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the square of one reactant quantity. It is to be used in a reaction modelled using a discrete framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_IRREVERSIBLE_REACTIONS__TWO_REACTANTS__DISCRETE_SCHEME: "SBO"
    """mass action rate law for second order irreversible reactions, two reactants, discrete scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of two reactants. It is to be used in a reaction modelled using a discrete framework."""

    SBO_0000144: "SBO"
    """mass action rate law for third order irreversible reactions, one reactant, discrete scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the cube of one reactant quantity. It is to be used in a reaction modelled using a discrete framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_IRREVERSIBLE_REACTIONS__ONE_REACTANT__DISCRETE_SCHEME: "SBO"
    """mass action rate law for third order irreversible reactions, one reactant, discrete scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the cube of one reactant quantity. It is to be used in a reaction modelled using a discrete framework."""

    SBO_0000145: "SBO"
    """mass action rate law for third order irreversible reactions, two reactants, discrete scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant and the square of the quantity of the other reactant. It is to be used in a reaction modelled using a discrete framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_IRREVERSIBLE_REACTIONS__TWO_REACTANTS__DISCRETE_SCHEME: "SBO"
    """mass action rate law for third order irreversible reactions, two reactants, discrete scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant and the square of the quantity of the other reactant. It is to be used in a reaction modelled using a discrete framework."""

    SBO_0000146: "SBO"
    """mass action rate law for third order irreversible reactions, three reactants, discrete scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of three reactants. It is to be used in a reaction modelled using a discrete framework."""

    MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_IRREVERSIBLE_REACTIONS__THREE_REACTANTS__DISCRETE_SCHEME: "SBO"
    """mass action rate law for third order irreversible reactions, three reactants, discrete scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of three reactants. It is to be used in a reaction modelled using a discrete framework."""

    SBO_0000147: "SBO"
    """thermodynamic temperature: Temperature is the physical property of a system which underlies the common notions of 'hot' and 'cold'; the material with the higher temperature is said to be hotter. Temperature is a quantity related to the average kinetic energy of the particles in a substance. The 10th Conference Generale des Poids et Mesures decided to define the thermodynamic temperature scale by choosing the triple point of water as the fundamental fixed point, and assigning to it the temperature 273,16 degrees Kelvin, exactly (0.01 degree Celsius)."""

    THERMODYNAMIC_TEMPERATURE: "SBO"
    """thermodynamic temperature: Temperature is the physical property of a system which underlies the common notions of 'hot' and 'cold'; the material with the higher temperature is said to be hotter. Temperature is a quantity related to the average kinetic energy of the particles in a substance. The 10th Conference Generale des Poids et Mesures decided to define the thermodynamic temperature scale by choosing the triple point of water as the fundamental fixed point, and assigning to it the temperature 273,16 degrees Kelvin, exactly (0.01 degree Celsius)."""

    SBO_0000148: "SBO"
    """temperature difference: Quantity resulting from the difference between two thermodynamic temperatures. A difference or interval of temperature may be expressed in Kelvins or in degrees Celsius."""

    TEMPERATURE_DIFFERENCE: "SBO"
    """temperature difference: Quantity resulting from the difference between two thermodynamic temperatures. A difference or interval of temperature may be expressed in Kelvins or in degrees Celsius."""

    SBO_0000149: "SBO"
    """number of substrates: Number of molecules which are acted upon by an enzyme."""

    NUMBER_OF_SUBSTRATES: "SBO"
    """number of substrates: Number of molecules which are acted upon by an enzyme."""

    SBO_0000150: "SBO"
    """enzymatic rate law for irreversible non-modulated non-interacting reactant enzymes: Kinetics of enzymes that react with one or several substances, their substrates, that bind independently. The enzymes do not catalyse the reactions in both directions."""

    ENZYMATIC_RATE_LAW_FOR_IRREVERSIBLE_NON_MODULATED_NON_INTERACTING_REACTANT_ENZYMES: "SBO"
    """enzymatic rate law for irreversible non-modulated non-interacting reactant enzymes: Kinetics of enzymes that react with one or several substances, their substrates, that bind independently. The enzymes do not catalyse the reactions in both directions."""

    SBO_0000151: "SBO"
    """enzymatic rate law for irreversible non-modulated non-interacting bireactant enzymes: Kinetics of enzymes that react with two substances, their substrates, that bind independently. The enzymes do not catalyse the reactions in both directions."""

    ENZYMATIC_RATE_LAW_FOR_IRREVERSIBLE_NON_MODULATED_NON_INTERACTING_BIREACTANT_ENZYMES: "SBO"
    """enzymatic rate law for irreversible non-modulated non-interacting bireactant enzymes: Kinetics of enzymes that react with two substances, their substrates, that bind independently. The enzymes do not catalyse the reactions in both directions."""

    SBO_0000152: "SBO"
    """enzymatic rate law for irreversible non-modulated non-interacting trireactant enzymes: Kinetics of enzymes that react with three substances, their substrates, that bind independently. The enzymes do not catalyse the reactions in both directions."""

    ENZYMATIC_RATE_LAW_FOR_IRREVERSIBLE_NON_MODULATED_NON_INTERACTING_TRIREACTANT_ENZYMES: "SBO"
    """enzymatic rate law for irreversible non-modulated non-interacting trireactant enzymes: Kinetics of enzymes that react with three substances, their substrates, that bind independently. The enzymes do not catalyse the reactions in both directions."""

    SBO_0000153: "SBO"
    """forward rate constant: Numerical parameter that quantifies the forward velocity of a chemical reaction. This parameter encompasses all the contributions to the velocity except the quantity of the reactants."""

    FORWARD_RATE_CONSTANT: "SBO"
    """forward rate constant: Numerical parameter that quantifies the forward velocity of a chemical reaction. This parameter encompasses all the contributions to the velocity except the quantity of the reactants."""

    SBO_0000154: "SBO"
    """forward rate constant, continuous case: Numerical parameter that quantifies the forward velocity of a chemical reaction. This parameter encompasses all the contributions to the velocity except the quantity of the reactants. It is to be used in a reaction modelled using a continuous framework."""

    FORWARD_RATE_CONSTANT__CONTINUOUS_CASE: "SBO"
    """forward rate constant, continuous case: Numerical parameter that quantifies the forward velocity of a chemical reaction. This parameter encompasses all the contributions to the velocity except the quantity of the reactants. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000155: "SBO"
    """forward rate constant, discrete case: Numerical parameter that quantifies the forward velocity of a chemical reaction. This parameter encompasses all the contributions to the velocity except the quantity of the reactants. It is to be used in a reaction modelled using a discrete framework."""

    FORWARD_RATE_CONSTANT__DISCRETE_CASE: "SBO"
    """forward rate constant, discrete case: Numerical parameter that quantifies the forward velocity of a chemical reaction. This parameter encompasses all the contributions to the velocity except the quantity of the reactants. It is to be used in a reaction modelled using a discrete framework."""

    SBO_0000156: "SBO"
    """reverse rate constant: Numerical parameter that quantifies the forward velocity of a chemical reaction. This parameter encompasses all the contributions to the velocity except the quantity of the reactants."""

    REVERSE_RATE_CONSTANT: "SBO"
    """reverse rate constant: Numerical parameter that quantifies the forward velocity of a chemical reaction. This parameter encompasses all the contributions to the velocity except the quantity of the reactants."""

    SBO_0000157: "SBO"
    """number of reactants: Number of different substances consumed by a chemical reaction."""

    NUMBER_OF_REACTANTS: "SBO"
    """number of reactants: Number of different substances consumed by a chemical reaction."""

    SBO_0000158: "SBO"
    """order of a reaction with respect to a reactant: The order of a reaction with respect to a certain reactant is defined as the power to which its concentration term in the rate equation is raised."""

    ORDER_OF_A_REACTION_WITH_RESPECT_TO_A_REACTANT: "SBO"
    """order of a reaction with respect to a reactant: The order of a reaction with respect to a certain reactant is defined as the power to which its concentration term in the rate equation is raised."""

    SBO_0000159: "SBO"
    """non-integral order rate constant: Numerical parameter that quantifies the velocity of a chemical reaction where reactants have non-integral orders. This parameter encompasses all the contributions to the velocity except the quantity of the reactants."""

    NON_INTEGRAL_ORDER_RATE_CONSTANT: "SBO"
    """non-integral order rate constant: Numerical parameter that quantifies the velocity of a chemical reaction where reactants have non-integral orders. This parameter encompasses all the contributions to the velocity except the quantity of the reactants."""

    SBO_0000160: "SBO"
    """forward non-integral order rate constant: Numerical parameter that quantifies the forward velocity of a chemical reaction where reactants have non-integral orders. This parameter encompasses all the contributions to the velocity except the quantity of the reactants."""

    FORWARD_NON_INTEGRAL_ORDER_RATE_CONSTANT: "SBO"
    """forward non-integral order rate constant: Numerical parameter that quantifies the forward velocity of a chemical reaction where reactants have non-integral orders. This parameter encompasses all the contributions to the velocity except the quantity of the reactants."""

    SBO_0000161: "SBO"
    """reverse non-integral order rate constant: Numerical parameter that quantifies the reverse velocity of a chemical reaction where products have non-integral orders. This parameter encompasses all the contributions to the velocity except the quantity of the products."""

    REVERSE_NON_INTEGRAL_ORDER_RATE_CONSTANT: "SBO"
    """reverse non-integral order rate constant: Numerical parameter that quantifies the reverse velocity of a chemical reaction where products have non-integral orders. This parameter encompasses all the contributions to the velocity except the quantity of the products."""

    SBO_0000162: "SBO"
    """forward zeroth order rate constant: Numerical parameter that quantifies the forward velocity of a chemical reaction independant of the reactant quantities. This parameter encompasses all the contributions to the velocity."""

    FORWARD_ZEROTH_ORDER_RATE_CONSTANT: "SBO"
    """forward zeroth order rate constant: Numerical parameter that quantifies the forward velocity of a chemical reaction independant of the reactant quantities. This parameter encompasses all the contributions to the velocity."""

    SBO_0000163: "SBO"
    """mass action rate law for irreversible reactions, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_IRREVERSIBLE_REACTIONS__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for irreversible reactions, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. It is to be used in a reaction modelled using a continuous framework."""
    ...
    SECOND_ORDER_IRREVERSIBLE_MASS_ACTION_KINETICS__CONTINUOUS_SCHEME: "SBO"
    """second order irreversible mass action kinetics, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to two reactant quantity. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000165: "SBO"
    """third order irreversible mass action kinetics, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to three reactant quantities. It is to be used in a reaction modelled using a continuous framework."""

    THIRD_ORDER_IRREVERSIBLE_MASS_ACTION_KINETICS__CONTINUOUS_SCHEME: "SBO"
    """third order irreversible mass action kinetics, continuous scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to three reactant quantities. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000166: "SBO"
    """mass action rate law for irreversible reactions, discrete scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. It is to be used in a reaction modelled using a discrete framework."""

    MASS_ACTION_RATE_LAW_FOR_IRREVERSIBLE_REACTIONS__DISCRETE_SCHEME: "SBO"
    """mass action rate law for irreversible reactions, discrete scheme: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. It is to be used in a reaction modelled using a discrete framework."""

    SBO_0000167: "SBO"
    """biochemical or transport reaction: An event involving one or more physical entities that modifies the structure, location or free energy of at least one of the participants."""

    BIOCHEMICAL_OR_TRANSPORT_REACTION: "SBO"
    """biochemical or transport reaction: An event involving one or more physical entities that modifies the structure, location or free energy of at least one of the participants."""

    SBO_0000168: "SBO"
    """control: Synonym: regulation"""

    CONTROL: "SBO"
    """control: Synonym: regulation"""

    SBO_0000169: "SBO"
    """inhibition: Negative modulation of the execution of a process."""

    INHIBITION: "SBO"
    """inhibition: Negative modulation of the execution of a process."""

    SBO_0000170: "SBO"
    """stimulation: Positive modulation of the execution of a process."""

    STIMULATION: "SBO"
    """stimulation: Positive modulation of the execution of a process."""

    SBO_0000171: "SBO"
    """necessary stimulation: Synonym: trigger"""

    NECESSARY_STIMULATION: "SBO"
    """necessary stimulation: Synonym: trigger"""

    SBO_0000172: "SBO"
    """catalysis: Modification of the velocity of a reaction by lowering the energy of the transition state."""

    CATALYSIS: "SBO"
    """catalysis: Modification of the velocity of a reaction by lowering the energy of the transition state."""

    SBO_0000173: "SBO"
    """and: All the preceding events or participating entities are necessary to perform the control."""

    AND: "SBO"
    """and: All the preceding events or participating entities are necessary to perform the control."""

    SBO_0000174: "SBO"
    """or: Any of the preceding events or participating entities are necessary to perform the control."""

    OR: "SBO"
    """or: Any of the preceding events or participating entities are necessary to perform the control."""

    SBO_0000175: "SBO"
    """xor: Synonym: exclusive or"""

    XOR: "SBO"
    """xor: Synonym: exclusive or"""

    SBO_0000176: "SBO"
    """biochemical reaction: An event involving one or more chemical entities that modifies the electrochemical structure of at least one of the participants."""

    BIOCHEMICAL_REACTION: "SBO"
    """biochemical reaction: An event involving one or more chemical entities that modifies the electrochemical structure of at least one of the participants."""

    SBO_0000177: "SBO"
    """non-covalent binding: Synonym: association"""

    NON_COVALENT_BINDING: "SBO"
    """non-covalent binding: Synonym: association"""

    SBO_0000178: "SBO"
    """cleavage: Rupture of a covalent bond resulting in the conversion of one physical entity into several physical entities or into a physical entity of a different topological class."""
    ...
    SBO_0000180: "SBO"
    """dissociation: Transformation of a non-covalent complex that results in the formation of several independent biochemical entities"""

    DISSOCIATION: "SBO"
    """dissociation: Transformation of a non-covalent complex that results in the formation of several independent biochemical entities"""

    SBO_0000181: "SBO"
    """conformational transition: Biochemical reaction that does not result in the modification of covalent bonds of reactants, but rather modifies the conformation of some reactants, that is the relative position of their atoms in space."""

    CONFORMATIONAL_TRANSITION: "SBO"
    """conformational transition: Biochemical reaction that does not result in the modification of covalent bonds of reactants, but rather modifies the conformation of some reactants, that is the relative position of their atoms in space."""
    ...
    SBO_0000185: "SBO"
    """translocation reaction: Movement of a physical entity without modification of the structure of the entity."""

    TRANSLOCATION_REACTION: "SBO"
    """translocation reaction: Movement of a physical entity without modification of the structure of the entity."""

    SBO_0000186: "SBO"
    """maximal velocity: Synonym: Vmax"""

    MAXIMAL_VELOCITY: "SBO"
    """maximal velocity: Synonym: Vmax"""

    SBO_0000187: "SBO"
    """Henri-Michaelis-Menten equation, Vmax form: Version of Henri-Michaelis-Menten equation where kp*[E]t is replaced by the maximal velocity, Vmax, reached when all the enzyme is active."""

    HENRI_MICHAELIS_MENTEN_EQUATION__VMAX_FORM: "SBO"
    """Henri-Michaelis-Menten equation, Vmax form: Version of Henri-Michaelis-Menten equation where kp*[E]t is replaced by the maximal velocity, Vmax, reached when all the enzyme is active."""

    SBO_0000188: "SBO"
    """number of biochemical items: A number of objects of the same type, identical or different, involved in a biochemical event."""

    NUMBER_OF_BIOCHEMICAL_ITEMS: "SBO"
    """number of biochemical items: A number of objects of the same type, identical or different, involved in a biochemical event."""

    SBO_0000189: "SBO"
    """number of binding sites: Number of regions on a reactant to which specific other reactants, in this context collectively called ligands, form a chemical bond."""

    NUMBER_OF_BINDING_SITES: "SBO"
    """number of binding sites: Number of regions on a reactant to which specific other reactants, in this context collectively called ligands, form a chemical bond."""

    SBO_0000190: "SBO"
    """Hill coefficient: Empirical parameter created by Archibald Vivian Hill to describe the cooperative binding of oxygen on hemoglobine (Hill (1910). The possible effects of the aggregation of the molecules of haemoglobin on its dissociation curves. J Physiol 40: iv-vii)."""

    HILL_COEFFICIENT: "SBO"
    """Hill coefficient: Empirical parameter created by Archibald Vivian Hill to describe the cooperative binding of oxygen on hemoglobine (Hill (1910). The possible effects of the aggregation of the molecules of haemoglobin on its dissociation curves. J Physiol 40: iv-vii)."""

    SBO_0000191: "SBO"
    """Hill constant: Empirical constant created by Archibald Vivian Hill to describe the cooperative binding of oxygen on hemoglobine (Hill (1910). The possible effects of the aggregation of the molecules of haemoglobin on its dissociation curves. J Physiol 40: iv-vii). Different from a microscopic dissociation constant, it has the dimension of concentration to the power of the Hill coefficient."""

    HILL_CONSTANT: "SBO"
    """Hill constant: Empirical constant created by Archibald Vivian Hill to describe the cooperative binding of oxygen on hemoglobine (Hill (1910). The possible effects of the aggregation of the molecules of haemoglobin on its dissociation curves. J Physiol 40: iv-vii). Different from a microscopic dissociation constant, it has the dimension of concentration to the power of the Hill coefficient."""

    SBO_0000192: "SBO"
    """Hill-type rate law, generalised form: Empirical equation created by Archibald Vivian Hill to describe the cooperative binding of oxygen on hemoglobine (Hill (1910). The possible effects of the aggregation of the molecules of haemoglobin on its dissociation curves. J Physiol 40: iv-vii)."""

    HILL_TYPE_RATE_LAW__GENERALISED_FORM: "SBO"
    """Hill-type rate law, generalised form: Empirical equation created by Archibald Vivian Hill to describe the cooperative binding of oxygen on hemoglobine (Hill (1910). The possible effects of the aggregation of the molecules of haemoglobin on its dissociation curves. J Physiol 40: iv-vii)."""

    SBO_0000193: "SBO"
    """equilibrium or steady-state constant: Constant with the dimension of a powered concentration. It is determined at half-saturation, half-activity etc."""

    EQUILIBRIUM_OR_STEADY_STATE_CONSTANT: "SBO"
    """equilibrium or steady-state constant: Constant with the dimension of a powered concentration. It is determined at half-saturation, half-activity etc."""

    SBO_0000194: "SBO"
    """pseudo-dissociation constant: Dissociation constant equivalent to an intrinsic microscopic dissociation constant, but obtained from an averaging process, for instance by extracting the root of a Hill constant."""

    PSEUDO_DISSOCIATION_CONSTANT: "SBO"
    """pseudo-dissociation constant: Dissociation constant equivalent to an intrinsic microscopic dissociation constant, but obtained from an averaging process, for instance by extracting the root of a Hill constant."""

    SBO_0000195: "SBO"
    """Hill-type rate law, microscopic form: Hill equation rewritten by creating a pseudo-microscopic constant, equal to the Hill constant powered to the opposite of the Hill coefficient."""

    HILL_TYPE_RATE_LAW__MICROSCOPIC_FORM: "SBO"
    """Hill-type rate law, microscopic form: Hill equation rewritten by creating a pseudo-microscopic constant, equal to the Hill constant powered to the opposite of the Hill coefficient."""

    SBO_0000196: "SBO"
    """concentration of an entity pool: Synonym: [X]"""

    CONCENTRATION_OF_AN_ENTITY_POOL: "SBO"
    """concentration of an entity pool: Synonym: [X]"""

    SBO_0000197: "SBO"
    """specific concentration of an entity: Concentration of an object divided by the value of another parameter having the dimension of a concentration."""

    SPECIFIC_CONCENTRATION_OF_AN_ENTITY: "SBO"
    """specific concentration of an entity: Concentration of an object divided by the value of another parameter having the dimension of a concentration."""

    SBO_0000198: "SBO"
    """Hill-type rate law, reduced form: Hill equation rewritten by replacing the concentration of reactant with its reduced form, that is the concentration divide by a pseudo-microscopic constant, equal to the Hill constant powered to the opposite of the Hill coefficient."""

    HILL_TYPE_RATE_LAW__REDUCED_FORM: "SBO"
    """Hill-type rate law, reduced form: Hill equation rewritten by replacing the concentration of reactant with its reduced form, that is the concentration divide by a pseudo-microscopic constant, equal to the Hill constant powered to the opposite of the Hill coefficient."""

    SBO_0000199: "SBO"
    """normalised enzymatic rate law for unireactant enzymes: Kinetics of enzymes that react only with one substance, their substrate. The total enzyme concentration is considered to be equal to 1, therefore the maximal velocity equals the catalytic constant."""

    NORMALISED_ENZYMATIC_RATE_LAW_FOR_UNIREACTANT_ENZYMES: "SBO"
    """normalised enzymatic rate law for unireactant enzymes: Kinetics of enzymes that react only with one substance, their substrate. The total enzyme concentration is considered to be equal to 1, therefore the maximal velocity equals the catalytic constant."""

    SBO_0000200: "SBO"
    """redox reaction: Chemical process in which atoms have their oxidation number (oxidation state) changed."""

    REDOX_REACTION: "SBO"
    """redox reaction: Chemical process in which atoms have their oxidation number (oxidation state) changed."""

    SBO_0000201: "SBO"
    """oxidation: Chemical process during which a molecular entity loses electrons."""

    OXIDATION: "SBO"
    """oxidation: Chemical process during which a molecular entity loses electrons."""

    SBO_0000202: "SBO"
    """reduction: Chemical process in which a molecular entity gain electrons."""

    REDUCTION: "SBO"
    """reduction: Chemical process in which a molecular entity gain electrons."""

    SBO_0000203: "SBO"
    """duplication: Reaction in which a reactant gives birth to two products identical to itself."""

    DUPLICATION: "SBO"
    """duplication: Reaction in which a reactant gives birth to two products identical to itself."""

    SBO_0000204: "SBO"
    """DNA replication: Process in which a DNA duplex is transformed into two identical DNA duplexes."""

    DNA_REPLICATION: "SBO"
    """DNA replication: Process in which a DNA duplex is transformed into two identical DNA duplexes."""

    SBO_0000205: "SBO"
    """composite biochemical process: Process that involves the participation of chemical or biological entities and is composed of several elementary steps or reactions."""

    COMPOSITE_BIOCHEMICAL_PROCESS: "SBO"
    """composite biochemical process: Process that involves the participation of chemical or biological entities and is composed of several elementary steps or reactions."""

    SBO_0000206: "SBO"
    """competitive inhibitor: Substance that decreases the probability of a chemical reaction, without itself being consumed or transformed by the reaction, by stericaly hindering the interaction between reactants."""

    COMPETITIVE_INHIBITOR: "SBO"
    """competitive inhibitor: Substance that decreases the probability of a chemical reaction, without itself being consumed or transformed by the reaction, by stericaly hindering the interaction between reactants."""

    SBO_0000207: "SBO"
    """non-competitive inhibitor: Substance that decreases the probability of a chemical reaction, without itself being consumed or transformed by the reaction, and without sterically hindering the interaction between reactants."""

    NON_COMPETITIVE_INHIBITOR: "SBO"
    """non-competitive inhibitor: Substance that decreases the probability of a chemical reaction, without itself being consumed or transformed by the reaction, and without sterically hindering the interaction between reactants."""

    SBO_0000208: "SBO"
    """acid-base reaction: Chemical reaction where a proton is given by a compound, the acid, to another one, the base (Brønsted-Lowry definition). An alternative, more general, definition is a reaction where a compound, the base, gives a pair of electrons to another, the acid (Lewis definition)."""

    ACID_BASE_REACTION: "SBO"
    """acid-base reaction: Chemical reaction where a proton is given by a compound, the acid, to another one, the base (Brønsted-Lowry definition). An alternative, more general, definition is a reaction where a compound, the base, gives a pair of electrons to another, the acid (Lewis definition)."""

    SBO_0000209: "SBO"
    """ionisation: Ionization is the physical process of converting an atom or molecule into an ion by changing the difference between the number of protons and electrons."""

    IONISATION: "SBO"
    """ionisation: Ionization is the physical process of converting an atom or molecule into an ion by changing the difference between the number of protons and electrons."""

    SBO_0000210: "SBO"
    """addition of a chemical group: Covalent reaction that results in the addition of a chemical group on a molecule."""

    ADDITION_OF_A_CHEMICAL_GROUP: "SBO"
    """addition of a chemical group: Covalent reaction that results in the addition of a chemical group on a molecule."""

    SBO_0000211: "SBO"
    """removal of a chemical group: Covalent reaction that results in the removal of a chemical group from a molecule."""

    REMOVAL_OF_A_CHEMICAL_GROUP: "SBO"
    """removal of a chemical group: Covalent reaction that results in the removal of a chemical group from a molecule."""

    SBO_0000212: "SBO"
    """protonation: Addition of a proton (H+) to a chemical entity."""

    PROTONATION: "SBO"
    """protonation: Addition of a proton (H+) to a chemical entity."""

    SBO_0000213: "SBO"
    """deprotonation: Removal of a proton (hydrogen ion H+) from a chemical entity."""

    DEPROTONATION: "SBO"
    """deprotonation: Removal of a proton (hydrogen ion H+) from a chemical entity."""

    SBO_0000214: "SBO"
    """methylation: Addition of a methyl group (-CH3) to a chemical entity."""

    METHYLATION: "SBO"
    """methylation: Addition of a methyl group (-CH3) to a chemical entity."""

    SBO_0000215: "SBO"
    """acetylation: Addition of an acetyl group (-COCH3) to a chemical entity."""

    ACETYLATION: "SBO"
    """acetylation: Addition of an acetyl group (-COCH3) to a chemical entity."""

    SBO_0000216: "SBO"
    """phosphorylation: Addition of a phosphate group (-H2PO4) to a chemical entity."""

    PHOSPHORYLATION: "SBO"
    """phosphorylation: Addition of a phosphate group (-H2PO4) to a chemical entity."""

    SBO_0000217: "SBO"
    """glycosylation: Addition of a saccharide group to a chemical entity."""

    GLYCOSYLATION: "SBO"
    """glycosylation: Addition of a saccharide group to a chemical entity."""

    SBO_0000218: "SBO"
    """palmitoylation: Addition of a palmitoyl group (CH3-[CH2]14-CO-) to a chemical entity."""

    PALMITOYLATION: "SBO"
    """palmitoylation: Addition of a palmitoyl group (CH3-[CH2]14-CO-) to a chemical entity."""

    SBO_0000219: "SBO"
    """myristoylation: Addition of a myristoyl (CH3-[CH2]12-CO-) to a chemical entity."""

    MYRISTOYLATION: "SBO"
    """myristoylation: Addition of a myristoyl (CH3-[CH2]12-CO-) to a chemical entity."""

    SBO_0000220: "SBO"
    """sulfation: Synonym: sulphation"""

    SULFATION: "SBO"
    """sulfation: Synonym: sulphation"""

    SBO_0000221: "SBO"
    """prenylation: Synonym: isoprenylation"""

    PRENYLATION: "SBO"
    """prenylation: Synonym: isoprenylation"""

    SBO_0000222: "SBO"
    """farnesylation: Addition of a farnesyl group (CH2-CH=C(CH3)-CH2-CH2-CH=C(CH3)-CH2-CH2-CH=C(CH3)2) to a chemical entity."""

    FARNESYLATION: "SBO"
    """farnesylation: Addition of a farnesyl group (CH2-CH=C(CH3)-CH2-CH2-CH=C(CH3)-CH2-CH2-CH=C(CH3)2) to a chemical entity."""

    SBO_0000223: "SBO"
    """geranylgeranylation: Addition of a geranylgeranyl group (CH2-CH=C(CH3)-CH2-CH2-CH=C(CH3)-CH2-CH2-CH=C(CH3)-CH2-CH2-CH=C(CH3)2) to a chemical entity."""

    GERANYLGERANYLATION: "SBO"
    """geranylgeranylation: Addition of a geranylgeranyl group (CH2-CH=C(CH3)-CH2-CH2-CH=C(CH3)-CH2-CH2-CH=C(CH3)-CH2-CH2-CH=C(CH3)2) to a chemical entity."""
    ...
    SBO_0000226: "SBO"
    """density of an entity pool: A quantitative measure of an amount or property of an entity expressed in terms of another dimension, such as unit length, area or volume."""

    DENSITY_OF_AN_ENTITY_POOL: "SBO"
    """density of an entity pool: A quantitative measure of an amount or property of an entity expressed in terms of another dimension, such as unit length, area or volume."""

    SBO_0000227: "SBO"
    """mass density of an entity: The mass of an entity expressed with reference to another dimension, such as unit length, area or volume."""

    MASS_DENSITY_OF_AN_ENTITY: "SBO"
    """mass density of an entity: The mass of an entity expressed with reference to another dimension, such as unit length, area or volume."""

    SBO_0000228: "SBO"
    """volume density of an entity: Mass of an entity per unit volume."""

    VOLUME_DENSITY_OF_AN_ENTITY: "SBO"
    """volume density of an entity: Mass of an entity per unit volume."""

    SBO_0000229: "SBO"
    """area density of an entity: The mass of an entity per unit of surface area."""

    AREA_DENSITY_OF_AN_ENTITY: "SBO"
    """area density of an entity: The mass of an entity per unit of surface area."""

    SBO_0000230: "SBO"
    """linear density of an entity: Mass of an entity per unit length."""

    LINEAR_DENSITY_OF_AN_ENTITY: "SBO"
    """linear density of an entity: Mass of an entity per unit length."""

    SBO_0000231: "SBO"
    """occurring entity representation: Representation of an entity that manifests, unfolds or develops through time, such as a discrete event, or a mutual or reciprocal action or influence that happens between participating physical entities, and/or other occurring entities."""

    OCCURRING_ENTITY_REPRESENTATION: "SBO"
    """occurring entity representation: Representation of an entity that manifests, unfolds or develops through time, such as a discrete event, or a mutual or reciprocal action or influence that happens between participating physical entities, and/or other occurring entities."""

    SBO_0000232: "SBO"
    """obsolete event: A phenomenon that takes place and which may be observable, or may be determined to have occurred as the result of an action or process."""

    OBSOLETE_EVENT: "SBO"
    """obsolete event: A phenomenon that takes place and which may be observable, or may be determined to have occurred as the result of an action or process."""

    SBO_0000233: "SBO"
    """hydroxylation: Addition of an hydroxyl group (-OH) to a chemical entity."""

    HYDROXYLATION: "SBO"
    """hydroxylation: Addition of an hydroxyl group (-OH) to a chemical entity."""

    SBO_0000234: "SBO"
    """logical framework: Modelling approach, pioneered by Rene Thomas and Stuart Kaufman, where the evolution of a system is described by the transitions between discrete activity states of 'genes' that control each other."""

    LOGICAL_FRAMEWORK: "SBO"
    """logical framework: Modelling approach, pioneered by Rene Thomas and Stuart Kaufman, where the evolution of a system is described by the transitions between discrete activity states of 'genes' that control each other."""

    SBO_0000235: "SBO"
    """participant: Entity that affects or is affected by an event."""

    PARTICIPANT: "SBO"
    """participant: Entity that affects or is affected by an event."""

    SBO_0000236: "SBO"
    """physical entity representation: Synonym: new synonym"""

    PHYSICAL_ENTITY_REPRESENTATION: "SBO"
    """physical entity representation: Synonym: new synonym"""

    SBO_0000237: "SBO"
    """logical combination: Combining the influence of several entities or events in a unique influence."""

    LOGICAL_COMBINATION: "SBO"
    """logical combination: Combining the influence of several entities or events in a unique influence."""

    SBO_0000238: "SBO"
    """not: The preceding event or participating entity cannot participate to the control."""

    NOT: "SBO"
    """not: The preceding event or participating entity cannot participate to the control."""

    SBO_0000239: "SBO"
    """allosteric control: Regulation of the influence of a reaction participant by binding an effector to a binding site of the participant different of the site of the participant conveying the influence."""

    ALLOSTERIC_CONTROL: "SBO"
    """allosteric control: Regulation of the influence of a reaction participant by binding an effector to a binding site of the participant different of the site of the participant conveying the influence."""

    SBO_0000240: "SBO"
    """material entity: A real thing that is defined by its physico-chemical structure."""

    MATERIAL_ENTITY: "SBO"
    """material entity: A real thing that is defined by its physico-chemical structure."""

    SBO_0000241: "SBO"
    """functional entity: A real thing, defined by its properties or the actions it performs, rather than it physico-chemical structure."""

    FUNCTIONAL_ENTITY: "SBO"
    """functional entity: A real thing, defined by its properties or the actions it performs, rather than it physico-chemical structure."""

    SBO_0000242: "SBO"
    """channel: A component that allows another component to pass through itself, possibly connecting different compartments."""

    CHANNEL: "SBO"
    """channel: A component that allows another component to pass through itself, possibly connecting different compartments."""

    SBO_0000243: "SBO"
    """gene: A locatable region of genomic sequence, corresponding to a unit of inheritance, which is associated with regulatory regions, transcribed regions and/or other functional sequence regions. Sequence Ontology SO:0000704"""

    GENE: "SBO"
    """gene: A locatable region of genomic sequence, corresponding to a unit of inheritance, which is associated with regulatory regions, transcribed regions and/or other functional sequence regions. Sequence Ontology SO:0000704"""

    SBO_0000244: "SBO"
    """receptor: Participating entity that binds to a specific physical entity and initiates the response to that physical entity.The original concept of the receptor was introduced independently at the end of the 19th century by John Newport Langley (1852-1925) and Paul Ehrlich (1854-1915). Langley JN.On the reaction of cells and of nerve-endings to certain poisons, chiefly as regards the reaction of striated muscle to nicotine and to curari. J Physiol. 1905 Dec 30;33(4-5):374-413."""

    RECEPTOR: "SBO"
    """receptor: Participating entity that binds to a specific physical entity and initiates the response to that physical entity.The original concept of the receptor was introduced independently at the end of the 19th century by John Newport Langley (1852-1925) and Paul Ehrlich (1854-1915). Langley JN.On the reaction of cells and of nerve-endings to certain poisons, chiefly as regards the reaction of striated muscle to nicotine and to curari. J Physiol. 1905 Dec 30;33(4-5):374-413."""

    SBO_0000245: "SBO"
    """macromolecule: Molecular entity mainly built-up by the repetition of pseudo-identical units. CHEBI:33839"""

    MACROMOLECULE: "SBO"
    """macromolecule: Molecular entity mainly built-up by the repetition of pseudo-identical units. CHEBI:33839"""

    SBO_0000246: "SBO"
    """information macromolecule: Macromolecule whose sequence is encoded in the genome of living organisms."""

    INFORMATION_MACROMOLECULE: "SBO"
    """information macromolecule: Macromolecule whose sequence is encoded in the genome of living organisms."""
    ...
    SBO_0000248: "SBO"
    """chemical macromolecule: Macromolecule whose sequence is not directly encoded in the genome."""

    CHEMICAL_MACROMOLECULE: "SBO"
    """chemical macromolecule: Macromolecule whose sequence is not directly encoded in the genome."""

    SBO_0000249: "SBO"
    """polysaccharide: Macromolecule consisting of a large number of monosaccharide residues linked by glycosidic bonds. CHEBI:18154"""

    POLYSACCHARIDE: "SBO"
    """polysaccharide: Macromolecule consisting of a large number of monosaccharide residues linked by glycosidic bonds. CHEBI:18154"""

    SBO_0000250: "SBO"
    """ribonucleic acid: Synonym: RNA"""

    RIBONUCLEIC_ACID: "SBO"
    """ribonucleic acid: Synonym: RNA"""

    SBO_0000251: "SBO"
    """deoxyribonucleic acid: Synonym: DNA"""

    DEOXYRIBONUCLEIC_ACID: "SBO"
    """deoxyribonucleic acid: Synonym: DNA"""

    SBO_0000252: "SBO"
    """polypeptide chain: Naturally occurring macromolecule formed by the repetition of amino-acid residues linked by peptidic bonds. A polypeptide chain is synthesized by the ribosome. CHEBI:16541"""

    POLYPEPTIDE_CHAIN: "SBO"
    """polypeptide chain: Naturally occurring macromolecule formed by the repetition of amino-acid residues linked by peptidic bonds. A polypeptide chain is synthesized by the ribosome. CHEBI:16541"""

    SBO_0000253: "SBO"
    """non-covalent complex: Entity composed of several independant components that are not linked by covalent bonds."""

    NON_COVALENT_COMPLEX: "SBO"
    """non-covalent complex: Entity composed of several independant components that are not linked by covalent bonds."""

    SBO_0000254: "SBO"
    """electrical resistance: Measure of the degree to which an object opposes the passage of an electric current. The SI unit of electrical resistance is the ohm."""

    ELECTRICAL_RESISTANCE: "SBO"
    """electrical resistance: Measure of the degree to which an object opposes the passage of an electric current. The SI unit of electrical resistance is the ohm."""

    SBO_0000255: "SBO"
    """physical characteristic: Parameter characterising a physical system or the environment, and independent of life's influence."""

    PHYSICAL_CHARACTERISTIC: "SBO"
    """physical characteristic: Parameter characterising a physical system or the environment, and independent of life's influence."""

    SBO_0000256: "SBO"
    """biochemical parameter: Parameter that depends on the biochemical properties of a system."""

    BIOCHEMICAL_PARAMETER: "SBO"
    """biochemical parameter: Parameter that depends on the biochemical properties of a system."""
    ...
    SBO_0000258: "SBO"
    """capacitance: Measure of the amount of electric charge stored (or separated) for a given electric potential. The unit of capacitance id the Farad."""

    CAPACITANCE: "SBO"
    """capacitance: Measure of the amount of electric charge stored (or separated) for a given electric potential. The unit of capacitance id the Farad."""

    SBO_0000259: "SBO"
    """voltage: Synonym: electrical potential difference"""

    VOLTAGE: "SBO"
    """voltage: Synonym: electrical potential difference"""

    SBO_0000260: "SBO"
    """enzymatic rate law for simple competitive inhibition of irreversible unireactant enzymes by one inhibitor: Synonym: simple intersecting linear competitive inhibition of unireactant enzymes"""

    ENZYMATIC_RATE_LAW_FOR_SIMPLE_COMPETITIVE_INHIBITION_OF_IRREVERSIBLE_UNIREACTANT_ENZYMES_BY_ONE_INHIBITOR: "SBO"
    """enzymatic rate law for simple competitive inhibition of irreversible unireactant enzymes by one inhibitor: Synonym: simple intersecting linear competitive inhibition of unireactant enzymes"""

    SBO_0000261: "SBO"
    """inhibitory constant: Synonym: Ki"""

    INHIBITORY_CONSTANT: "SBO"
    """inhibitory constant: Synonym: Ki"""

    SBO_0000262: "SBO"
    """enzymatic rate law for simple uncompetitive inhibition of irreversible unireactant enzymes: Synonym: simple linear uncompetitive inhibition"""

    ENZYMATIC_RATE_LAW_FOR_SIMPLE_UNCOMPETITIVE_INHIBITION_OF_IRREVERSIBLE_UNIREACTANT_ENZYMES: "SBO"
    """enzymatic rate law for simple uncompetitive inhibition of irreversible unireactant enzymes: Synonym: simple linear uncompetitive inhibition"""

    SBO_0000263: "SBO"
    """relative equilibrium constant: Ratio of an equilibrium constant in a given condition by the same equilibrium constant is not fullfilled."""

    RELATIVE_EQUILIBRIUM_CONSTANT: "SBO"
    """relative equilibrium constant: Ratio of an equilibrium constant in a given condition by the same equilibrium constant is not fullfilled."""

    SBO_0000264: "SBO"
    """relative inhibition constant: Ratio of the dissociation constant of an inhibitor from the complex enzyme-substrate on the dissociation constant of an inhibitor from the free enzyme."""

    RELATIVE_INHIBITION_CONSTANT: "SBO"
    """relative inhibition constant: Ratio of the dissociation constant of an inhibitor from the complex enzyme-substrate on the dissociation constant of an inhibitor from the free enzyme."""
    ...
    ENZYMATIC_RATE_LAW_FOR_SIMPLE_MIXED_TYPE_INHIBITION_OF_IRREVERSIBLE_UNIREACTANT_ENZYMES: "SBO"
    """enzymatic rate law for simple mixed-type inhibition of irreversible unireactant enzymes: Synonym: simple intersecting linear mixed-type competitive inhibition"""

    SBO_0000266: "SBO"
    """enzymatic rate law for simple irreversible non-competitive inhibition of unireactant enzymes: Inhibition of a unireactant enzyme by one inhibitor that can bind to the complex enzyme-substrate and the free enzyme with the same equilibrium constant, and totally prevent the catalysis."""

    ENZYMATIC_RATE_LAW_FOR_SIMPLE_IRREVERSIBLE_NON_COMPETITIVE_INHIBITION_OF_UNIREACTANT_ENZYMES: "SBO"
    """enzymatic rate law for simple irreversible non-competitive inhibition of unireactant enzymes: Inhibition of a unireactant enzyme by one inhibitor that can bind to the complex enzyme-substrate and the free enzyme with the same equilibrium constant, and totally prevent the catalysis."""

    SBO_0000267: "SBO"
    """enzymatic rate law for competitive inhibition of irreversible unireactant enzymes by one inhibitor: Synonym: multiple competitive inhibition by one inhibitor of unireactant enzymes"""

    ENZYMATIC_RATE_LAW_FOR_COMPETITIVE_INHIBITION_OF_IRREVERSIBLE_UNIREACTANT_ENZYMES_BY_ONE_INHIBITOR: "SBO"
    """enzymatic rate law for competitive inhibition of irreversible unireactant enzymes by one inhibitor: Synonym: multiple competitive inhibition by one inhibitor of unireactant enzymes"""

    SBO_0000268: "SBO"
    """enzymatic rate law: Enzyme kinetics is the study of the rates of chemical reactions that are catalysed by enzymes, how this rate is controlled, and how drugs and poisons can inhibit its activity."""

    ENZYMATIC_RATE_LAW: "SBO"
    """enzymatic rate law: Enzyme kinetics is the study of the rates of chemical reactions that are catalysed by enzymes, how this rate is controlled, and how drugs and poisons can inhibit its activity."""

    SBO_0000269: "SBO"
    """enzymatic rate law for unireactant enzymes: Kinetics of enzymes that catalyse the transformation of only one substrate."""

    ENZYMATIC_RATE_LAW_FOR_UNIREACTANT_ENZYMES: "SBO"
    """enzymatic rate law for unireactant enzymes: Kinetics of enzymes that catalyse the transformation of only one substrate."""

    SBO_0000270: "SBO"
    """enzymatic rate law for competitive inhibition of irreversible unireactant enzymes by exclusive inhibitors: Inhibition of a unireactant enzyme by inhibitors that bind to the free enzyme on the same binding site than the substrate. The enzymes do not catalyse the reactions in both directions."""

    ENZYMATIC_RATE_LAW_FOR_COMPETITIVE_INHIBITION_OF_IRREVERSIBLE_UNIREACTANT_ENZYMES_BY_EXCLUSIVE_INHIBITORS: "SBO"
    """enzymatic rate law for competitive inhibition of irreversible unireactant enzymes by exclusive inhibitors: Inhibition of a unireactant enzyme by inhibitors that bind to the free enzyme on the same binding site than the substrate. The enzymes do not catalyse the reactions in both directions."""

    SBO_0000271: "SBO"
    """enzymatic rate law for competitive inhibition of irreversible unireactant enzymes by two exclusive inhibitors: Inhibition of a unireactant enzyme by two inhibitors that bind to the free enzyme on the same binding site than the substrate. The enzymes do not catalyse the reactions in both directions."""

    ENZYMATIC_RATE_LAW_FOR_COMPETITIVE_INHIBITION_OF_IRREVERSIBLE_UNIREACTANT_ENZYMES_BY_TWO_EXCLUSIVE_INHIBITORS: "SBO"
    """enzymatic rate law for competitive inhibition of irreversible unireactant enzymes by two exclusive inhibitors: Inhibition of a unireactant enzyme by two inhibitors that bind to the free enzyme on the same binding site than the substrate. The enzymes do not catalyse the reactions in both directions."""

    SBO_0000272: "SBO"
    """number of inhibitors: Number of entities that inhibit a reaction."""

    NUMBER_OF_INHIBITORS: "SBO"
    """number of inhibitors: Number of entities that inhibit a reaction."""

    SBO_0000273: "SBO"
    """enzymatic rate law for competitive inhibition of irreversible unireactant enzymes by non-exclusive non-cooperative inhibitors: Inhibition of a unireactant enzyme by inhibitors that bind independently to the free enzyme and preclude the binding of the substrate. The enzymes do not catalyse the reactions in both directions."""

    ENZYMATIC_RATE_LAW_FOR_COMPETITIVE_INHIBITION_OF_IRREVERSIBLE_UNIREACTANT_ENZYMES_BY_NON_EXCLUSIVE_NON_COOPERATIVE_INHIBITORS: "SBO"
    """enzymatic rate law for competitive inhibition of irreversible unireactant enzymes by non-exclusive non-cooperative inhibitors: Inhibition of a unireactant enzyme by inhibitors that bind independently to the free enzyme and preclude the binding of the substrate. The enzymes do not catalyse the reactions in both directions."""
    ...
    ENZYMATIC_RATE_LAW_FOR_SIMPLE_COMPETITIVE_INHIBITION_OF_IRREVERSIBLE_UNIREACTANT_ENZYMES_BY_TWO_NON_EXCLUSIVE__NON_COOPERATIVE_INHIBITORS: "SBO"
    """enzymatic rate law for simple competitive inhibition of irreversible unireactant enzymes by two non-exclusive, non-cooperative inhibitors: Inhibition of a unireactant enzyme by two inhibitors that can bind independently once to the free enzyme and preclude the binding of the substrate. The enzymes do not catalyse the reactions in both directions."""

    SBO_0000275: "SBO"
    """enzymatic rate law for mixed-type inhibition of irreversible enzymes by mutually exclusive inhibitors: Inhibition of a unireactant enzyme by inhibitors that can bind to the complex enzyme-substrate and the free enzyme, possibly with different equilibrium constants, and totally prevent the catalysis. The enzymes do not catalyse the reactions in both directions."""

    ENZYMATIC_RATE_LAW_FOR_MIXED_TYPE_INHIBITION_OF_IRREVERSIBLE_ENZYMES_BY_MUTUALLY_EXCLUSIVE_INHIBITORS: "SBO"
    """enzymatic rate law for mixed-type inhibition of irreversible enzymes by mutually exclusive inhibitors: Inhibition of a unireactant enzyme by inhibitors that can bind to the complex enzyme-substrate and the free enzyme, possibly with different equilibrium constants, and totally prevent the catalysis. The enzymes do not catalyse the reactions in both directions."""
    ...
    ENZYMATIC_RATE_LAW_FOR_MIXED_TYPE_INHIBITION_OF_IRREVERSIBLE_UNIREACTANT_ENZYMES_BY_TWO_INHIBITORS: "SBO"
    """enzymatic rate law for mixed-type inhibition of irreversible unireactant enzymes by two inhibitors: Inhibition of unireactant enzymes by two inhibitors that can bind to the complex enzyme-substrate and the free enzyme, possibly with different equilibrium constant, and totally prevent the catalysis. The enzymes do not catalyse the reactions in both directions."""
    ...
    ENZYMATIC_RATE_LAW_FOR_NON_COMPETITIVE_INHIBITION_OF_IRREVERSIBLE_UNIREACTANT_ENZYMES_BY_TWO_EXCLUSIVELY_BINDING_INHIBITORS: "SBO"
    """enzymatic rate law for non-competitive inhibition of irreversible unireactant enzymes by two exclusively binding inhibitors: Inhibition of unireactant enzymes by two inhibitors that can bind to the complex enzyme-substrate and the free enzyme with the same equilibrium constant and totally prevent the catalysis."""

    SBO_0000278: "SBO"
    """messenger RNA: Synonym: mRNA"""

    MESSENGER_RNA: "SBO"
    """messenger RNA: Synonym: mRNA"""

    SBO_0000279: "SBO"
    """pressure: Pressure (symbol: p) is the force per unit area applied on a surface in a direction perpendicular to that surface. The unit of pressure is the Pascal (Pa), that is equal to 1 Newton per square meter."""

    PRESSURE: "SBO"
    """pressure: Pressure (symbol: p) is the force per unit area applied on a surface in a direction perpendicular to that surface. The unit of pressure is the Pascal (Pa), that is equal to 1 Newton per square meter."""

    SBO_0000280: "SBO"
    """ligand: In biochemistry, a ligand is an effector, a physical entity that binds to a site on a receptor's surface by intermolecular forces."""

    LIGAND: "SBO"
    """ligand: In biochemistry, a ligand is an effector, a physical entity that binds to a site on a receptor's surface by intermolecular forces."""

    SBO_0000281: "SBO"
    """equilibrium constant: Synonym: Keq"""

    EQUILIBRIUM_CONSTANT: "SBO"
    """equilibrium constant: Synonym: Keq"""

    SBO_0000282: "SBO"
    """dissociation constant: Synonym: Kd"""

    DISSOCIATION_CONSTANT: "SBO"
    """dissociation constant: Synonym: Kd"""

    SBO_0000283: "SBO"
    """acid dissociation constant: Synonym: Ka"""

    ACID_DISSOCIATION_CONSTANT: "SBO"
    """acid dissociation constant: Synonym: Ka"""

    SBO_0000284: "SBO"
    """transporter: Participating entity that facilitates the movement of another physical entity from a defined subset of the physical environment (for instance a cellular compartment) to another."""

    TRANSPORTER: "SBO"
    """transporter: Participating entity that facilitates the movement of another physical entity from a defined subset of the physical environment (for instance a cellular compartment) to another."""

    SBO_0000285: "SBO"
    """material entity of unspecified nature: Material entity whose nature is unknown or irrelevant."""

    MATERIAL_ENTITY_OF_UNSPECIFIED_NATURE: "SBO"
    """material entity of unspecified nature: Material entity whose nature is unknown or irrelevant."""

    SBO_0000286: "SBO"
    """multimer: Non-covalent association of identical, or pseudo-identical, entities. By pseudo-identical entities, we mean biochemical elements that differ chemically, although remaining globally identical in structure and/or function. Examples are homologous subunits in an hetero-oligomeric receptor."""

    MULTIMER: "SBO"
    """multimer: Non-covalent association of identical, or pseudo-identical, entities. By pseudo-identical entities, we mean biochemical elements that differ chemically, although remaining globally identical in structure and/or function. Examples are homologous subunits in an hetero-oligomeric receptor."""

    SBO_0000287: "SBO"
    """EC50: Concentration of an active compound at which 50% of its maximal effect is observed. The EC50 is not a pure characteristic of the compound but depends on the conditions or the measurement."""

    EC50: "SBO"
    """EC50: Concentration of an active compound at which 50% of its maximal effect is observed. The EC50 is not a pure characteristic of the compound but depends on the conditions or the measurement."""

    SBO_0000288: "SBO"
    """IC50: Also called half maximal inhibitory concentration, it represents the concentration of an inhibitor substance that is required to suppress 50% of an effect."""

    IC50: "SBO"
    """IC50: Also called half maximal inhibitory concentration, it represents the concentration of an inhibitor substance that is required to suppress 50% of an effect."""

    SBO_0000289: "SBO"
    """functional compartment: Logical or physical subset of the event space that contains pools, that is sets of participants considered identical when it comes to the event they are involved into. A compartment can have any number of dimensions, including 0, and be of any size including null."""

    FUNCTIONAL_COMPARTMENT: "SBO"
    """functional compartment: Logical or physical subset of the event space that contains pools, that is sets of participants considered identical when it comes to the event they are involved into. A compartment can have any number of dimensions, including 0, and be of any size including null."""

    SBO_0000290: "SBO"
    """physical compartment: Specific location of space, that can be bounded or not. A physical compartment can have 1, 2 or 3 dimensions."""

    PHYSICAL_COMPARTMENT: "SBO"
    """physical compartment: Specific location of space, that can be bounded or not. A physical compartment can have 1, 2 or 3 dimensions."""

    SBO_0000291: "SBO"
    """empty set: Entity defined by the absence of any actual object. An empty set is often used to represent the source of a creation process or the result of a degradation process."""

    EMPTY_SET: "SBO"
    """empty set: Entity defined by the absence of any actual object. An empty set is often used to represent the source of a creation process or the result of a degradation process."""

    SBO_0000292: "SBO"
    """spatial continuous framework: Modelling approach where the quantities of participants are considered continuous, and represented by real values. The associated simulation methods make use of differential equations. The models take into account the distribution of the entities and describe the spatial fluxes."""

    SPATIAL_CONTINUOUS_FRAMEWORK: "SBO"
    """spatial continuous framework: Modelling approach where the quantities of participants are considered continuous, and represented by real values. The associated simulation methods make use of differential equations. The models take into account the distribution of the entities and describe the spatial fluxes."""
    ...
    NON_SPATIAL_CONTINUOUS_FRAMEWORK: "SBO"
    """non-spatial continuous framework: Modelling approach where the quantities of participants are considered continuous, and represented by real values. The associated simulation methods make use of differential equations. The models do not take into account the distribution of the entities and describe only the temporal fluxes."""
    ...
    SPATIAL_DISCRETE_FRAMEWORK: "SBO"
    """spatial discrete framework: Modelling approach where the quantities of participants are considered discrete, and represented by integer values. The associated simulation methods can be deterministic or stochastic. The models take into account the distribution of the entities and describe the spatial fluxes."""
    ...
    NON_SPATIAL_DISCRETE_FRAMEWORK: "SBO"
    """non-spatial discrete framework: Modelling approach where the quantities of participants are considered discrete, and represented by integer values. The associated simulation methods can be deterministic or stochastic.The models do not take into account the distribution of the entities and describe only the temporal fluxes."""

    SBO_0000296: "SBO"
    """macromolecular complex: Non-covalent complex of one or more macromolecules and zero or more simple chemicals."""

    MACROMOLECULAR_COMPLEX: "SBO"
    """macromolecular complex: Non-covalent complex of one or more macromolecules and zero or more simple chemicals."""

    SBO_0000297: "SBO"
    """protein complex: Macromolecular complex containing one or more polypeptide chains possibly associated with simple chemicals. CHEBI:36080"""

    PROTEIN_COMPLEX: "SBO"
    """protein complex: Macromolecular complex containing one or more polypeptide chains possibly associated with simple chemicals. CHEBI:36080"""

    SBO_0000298: "SBO"
    """synthetic chemical compound: Chemical entity that is engineered by a human-designed process ex-vivo rather than a produced by a living entity."""

    SYNTHETIC_CHEMICAL_COMPOUND: "SBO"
    """synthetic chemical compound: Chemical entity that is engineered by a human-designed process ex-vivo rather than a produced by a living entity."""

    SBO_0000299: "SBO"
    """metabolite: Substance produced by metabolism or by a metabolic process."""

    METABOLITE: "SBO"
    """metabolite: Substance produced by metabolism or by a metabolic process."""

    SBO_0000300: "SBO"
    """total concentration of enzyme: Synonym: Et"""

    TOTAL_CONCENTRATION_OF_ENZYME: "SBO"
    """total concentration of enzyme: Synonym: Et"""

    SBO_0000301: "SBO"
    """total catalytic efficiency: Constant representing the actual efficiency of an enzyme at a given concentration, taking into account its microscopic catalytic activity and the rates of substrate binding and dissociation. NB. The symbol Vmax and the names maximum rate and maximum velocity are in widespread use although under normal circumstances there is no finite substrate concentration at which v = V and hence no maximum in the mathematical sense (Eur. J. Biochem. 128:281-291)."""

    TOTAL_CATALYTIC_EFFICIENCY: "SBO"
    """total catalytic efficiency: Constant representing the actual efficiency of an enzyme at a given concentration, taking into account its microscopic catalytic activity and the rates of substrate binding and dissociation. NB. The symbol Vmax and the names maximum rate and maximum velocity are in widespread use although under normal circumstances there is no finite substrate concentration at which v = V and hence no maximum in the mathematical sense (Eur. J. Biochem. 128:281-291)."""

    SBO_0000302: "SBO"
    """catalytic efficiency: Constant representing the actual efficiency of an enzyme, taking into account its microscopic catalytic activity and the rates of substrate binding and dissociation."""

    CATALYTIC_EFFICIENCY: "SBO"
    """catalytic efficiency: Constant representing the actual efficiency of an enzyme, taking into account its microscopic catalytic activity and the rates of substrate binding and dissociation."""

    SBO_0000303: "SBO"
    """biochemical potential: Synonym: chemical potential"""

    BIOCHEMICAL_POTENTIAL: "SBO"
    """biochemical potential: Synonym: chemical potential"""

    SBO_0000304: "SBO"
    """pH: Synonym: potential of hydrogen"""

    PH: "SBO"
    """pH: Synonym: potential of hydrogen"""

    SBO_0000305: "SBO"
    """pOH: Negative logarithm (base 10) of the activity of hydroxyde in a solution. In a diluted solution, this activity is equal to the concentration of ions HO-."""

    POH: "SBO"
    """pOH: Negative logarithm (base 10) of the activity of hydroxyde in a solution. In a diluted solution, this activity is equal to the concentration of ions HO-."""

    SBO_0000306: "SBO"
    """pK: Synonym: dissociation potential"""

    PK: "SBO"
    """pK: Synonym: dissociation potential"""

    SBO_0000307: "SBO"
    """pKa: Synonym: potential of acid"""

    PKA: "SBO"
    """pKa: Synonym: potential of acid"""

    SBO_0000308: "SBO"
    """equilibrium or steady-state characteristic: Quantitative parameter that characterises a biochemical equilibrium."""

    EQUILIBRIUM_OR_STEADY_STATE_CHARACTERISTIC: "SBO"
    """equilibrium or steady-state characteristic: Quantitative parameter that characterises a biochemical equilibrium."""

    SBO_0000309: "SBO"
    """dissociation characteristic: Quantitative parameter that characterises a dissociation."""

    DISSOCIATION_CHARACTERISTIC: "SBO"
    """dissociation characteristic: Quantitative parameter that characterises a dissociation."""

    SBO_0000310: "SBO"
    """acid dissociation characteristic: Quantitative parameter that characterises an acid-base reaction."""

    ACID_DISSOCIATION_CHARACTERISTIC: "SBO"
    """acid dissociation characteristic: Quantitative parameter that characterises an acid-base reaction."""

    SBO_0000311: "SBO"
    """heterogeneous nuclear RNA: Synonym: Precursor mRNA"""

    HETEROGENEOUS_NUCLEAR_RNA: "SBO"
    """heterogeneous nuclear RNA: Synonym: Precursor mRNA"""

    SBO_0000312: "SBO"
    """mature messenger RNA: Completely processed single strand of messenger ribonucleic acid (mRNA), synthesized from a DNA template in the nucleus of a cell by transcription and containing copies of only the exons of a gene."""

    MATURE_MESSENGER_RNA: "SBO"
    """mature messenger RNA: Completely processed single strand of messenger ribonucleic acid (mRNA), synthesized from a DNA template in the nucleus of a cell by transcription and containing copies of only the exons of a gene."""

    SBO_0000313: "SBO"
    """transfer RNA: Synonym: tRNA"""

    TRANSFER_RNA: "SBO"
    """transfer RNA: Synonym: tRNA"""

    SBO_0000314: "SBO"
    """ribosomal RNA: Synonym: rRNA"""

    RIBOSOMAL_RNA: "SBO"
    """ribosomal RNA: Synonym: rRNA"""

    SBO_0000315: "SBO"
    """ribozyme: Synonym: ribonucleic acid enzyme"""

    RIBOZYME: "SBO"
    """ribozyme: Synonym: ribonucleic acid enzyme"""

    SBO_0000316: "SBO"
    """microRNA: Synonym: miRNA"""

    MICRORNA: "SBO"
    """microRNA: Synonym: miRNA"""

    SBO_0000317: "SBO"
    """small interfering RNA: Synonym: siRNA"""

    SMALL_INTERFERING_RNA: "SBO"
    """small interfering RNA: Synonym: siRNA"""

    SBO_0000318: "SBO"
    """small nuclear RNA: Synonym: snRNA"""

    SMALL_NUCLEAR_RNA: "SBO"
    """small nuclear RNA: Synonym: snRNA"""

    SBO_0000319: "SBO"
    """small nucleolar RNA: Synonym: snoRNA"""

    SMALL_NUCLEOLAR_RNA: "SBO"
    """small nucleolar RNA: Synonym: snoRNA"""

    SBO_0000320: "SBO"
    """product catalytic rate constant: Synonym: kcatp"""

    PRODUCT_CATALYTIC_RATE_CONSTANT: "SBO"
    """product catalytic rate constant: Synonym: kcatp"""

    SBO_0000321: "SBO"
    """substrate catalytic rate constant: Synonym: reverse catalytic rate constant"""

    SUBSTRATE_CATALYTIC_RATE_CONSTANT: "SBO"
    """substrate catalytic rate constant: Synonym: reverse catalytic rate constant"""

    SBO_0000322: "SBO"
    """Michaelis constant for substrate: Synonym: Kms"""

    MICHAELIS_CONSTANT_FOR_SUBSTRATE: "SBO"
    """Michaelis constant for substrate: Synonym: Kms"""

    SBO_0000323: "SBO"
    """Michaelis constant for product: Synonym: Kmp"""

    MICHAELIS_CONSTANT_FOR_PRODUCT: "SBO"
    """Michaelis constant for product: Synonym: Kmp"""

    SBO_0000324: "SBO"
    """forward maximal velocity: Synonym: Vmaxf"""

    FORWARD_MAXIMAL_VELOCITY: "SBO"
    """forward maximal velocity: Synonym: Vmaxf"""

    SBO_0000325: "SBO"
    """reverse maximal velocity: Synonym: Vmaxr"""

    REVERSE_MAXIMAL_VELOCITY: "SBO"
    """reverse maximal velocity: Synonym: Vmaxr"""

    SBO_0000326: "SBO"
    """enzymatic rate law for non-modulated unireactant enzymes: Kinetics of enzymes that react only with one substance, their substrate, and are not modulated by other compounds."""

    ENZYMATIC_RATE_LAW_FOR_NON_MODULATED_UNIREACTANT_ENZYMES: "SBO"
    """enzymatic rate law for non-modulated unireactant enzymes: Kinetics of enzymes that react only with one substance, their substrate, and are not modulated by other compounds."""

    SBO_0000327: "SBO"
    """non-macromolecular ion: Chemical entity having a net electric charge."""

    NON_MACROMOLECULAR_ION: "SBO"
    """non-macromolecular ion: Chemical entity having a net electric charge."""

    SBO_0000328: "SBO"
    """non-macromolecular radical: chemical entity possessing an unpaired electron."""

    NON_MACROMOLECULAR_RADICAL: "SBO"
    """non-macromolecular radical: chemical entity possessing an unpaired electron."""

    SBO_0000329: "SBO"
    """transcription start site: Synonym: TSS"""

    TRANSCRIPTION_START_SITE: "SBO"
    """transcription start site: Synonym: TSS"""

    SBO_0000330: "SBO"
    """dephosphorylation: Removal of a phosphate group (-H2PO4) from a chemical entity."""

    DEPHOSPHORYLATION: "SBO"
    """dephosphorylation: Removal of a phosphate group (-H2PO4) from a chemical entity."""

    SBO_0000331: "SBO"
    """half-life: Time interval over which a quantified entity is reduced to half its original value."""

    HALF_LIFE: "SBO"
    """half-life: Time interval over which a quantified entity is reduced to half its original value."""

    SBO_0000332: "SBO"
    """half-life of an exponential decay: Time taken by a quantity decreasing according to a mono-exponential decay to be divided by two. Sometimes called t1/2."""

    HALF_LIFE_OF_AN_EXPONENTIAL_DECAY: "SBO"
    """half-life of an exponential decay: Time taken by a quantity decreasing according to a mono-exponential decay to be divided by two. Sometimes called t1/2."""

    SBO_0000333: "SBO"
    """monoexponential decay rate law: Monotonic decrease of a quantity proportionally to its value."""

    MONOEXPONENTIAL_DECAY_RATE_LAW: "SBO"
    """monoexponential decay rate law: Monotonic decrease of a quantity proportionally to its value."""

    SBO_0000334: "SBO"
    """non-coding RNA: RNA molecule that is not translated into a protein. Sequence Ontology SO:0000655"""

    NON_CODING_RNA: "SBO"
    """non-coding RNA: RNA molecule that is not translated into a protein. Sequence Ontology SO:0000655"""

    SBO_0000335: "SBO"
    """gene coding region: Portion of DNA or RNA that is transcribed into another RNA, such as a messenger RNA or a non-coding RNA (for instance a transfert RNA or a ribosomal RNA)."""

    GENE_CODING_REGION: "SBO"
    """gene coding region: Portion of DNA or RNA that is transcribed into another RNA, such as a messenger RNA or a non-coding RNA (for instance a transfert RNA or a ribosomal RNA)."""

    SBO_0000336: "SBO"
    """interactor: Entity participating in a physical or functional interaction."""

    INTERACTOR: "SBO"
    """interactor: Entity participating in a physical or functional interaction."""

    SBO_0000337: "SBO"
    """association constant: Synonym: Ka"""

    ASSOCIATION_CONSTANT: "SBO"
    """association constant: Synonym: Ka"""

    SBO_0000338: "SBO"
    """dissociation rate constant: Synonym: kd"""

    DISSOCIATION_RATE_CONSTANT: "SBO"
    """dissociation rate constant: Synonym: kd"""

    SBO_0000339: "SBO"
    """bimolecular association rate constant: Rate with which two components associate into a complex."""

    BIMOLECULAR_ASSOCIATION_RATE_CONSTANT: "SBO"
    """bimolecular association rate constant: Rate with which two components associate into a complex."""

    SBO_0000340: "SBO"
    """trimolecular association rate constant: Rate with which three components associate into a complex."""

    TRIMOLECULAR_ASSOCIATION_RATE_CONSTANT: "SBO"
    """trimolecular association rate constant: Rate with which three components associate into a complex."""

    SBO_0000341: "SBO"
    """association rate constant: Rate with which components associate into a complex."""

    ASSOCIATION_RATE_CONSTANT: "SBO"
    """association rate constant: Rate with which components associate into a complex."""

    SBO_0000342: "SBO"
    """molecular or genetic interaction: Mutual or reciprocal action or influence between molecular entities."""

    MOLECULAR_OR_GENETIC_INTERACTION: "SBO"
    """molecular or genetic interaction: Mutual or reciprocal action or influence between molecular entities."""
    ...
    GENETIC_INTERACTION: "SBO"
    """genetic interaction: A phenomenon whereby an observed phenotype, qualitative or quantative, is not explainable by the simple additive effects of the individual gene pertubations alone. Genetic interaction between perturbed genes is usually expected to generate a 'defective' phenotype. The level of defectiveness is often used to sub-classify this phenomenon."""

    SBO_0000344: "SBO"
    """molecular interaction: Relationship between molecular entities, based on contacts, direct or indirect."""

    MOLECULAR_INTERACTION: "SBO"
    """molecular interaction: Relationship between molecular entities, based on contacts, direct or indirect."""

    SBO_0000345: "SBO"
    """time: Fundmental quantity of the measuring system used to sequence events, to compare the durations of events and the intervals between them, and to quantify the motions or the transformation of entities. The SI base unit for time is the SI second. The second is the duration of 9,192,631,770 periods of the radiation corresponding to the transition between the two hyperfine levels of the ground state of the caesium 133 atom."""

    TIME: "SBO"
    """time: Fundmental quantity of the measuring system used to sequence events, to compare the durations of events and the intervals between them, and to quantify the motions or the transformation of entities. The SI base unit for time is the SI second. The second is the duration of 9,192,631,770 periods of the radiation corresponding to the transition between the two hyperfine levels of the ground state of the caesium 133 atom."""

    SBO_0000346: "SBO"
    """temporal measure: Fundamental quantity of the measuring system used to sequence events, to compare the durations of events and the intervals between them, and to quantify the motions or the transformation of entities. The SI base unit for time is the SI second. The second is the duration of 9,192,631,770 periods of the radiation corresponding to the transition between the two hyperfine levels of the ground state of the caesium 133 atom."""

    TEMPORAL_MEASURE: "SBO"
    """temporal measure: Fundamental quantity of the measuring system used to sequence events, to compare the durations of events and the intervals between them, and to quantify the motions or the transformation of entities. The SI base unit for time is the SI second. The second is the duration of 9,192,631,770 periods of the radiation corresponding to the transition between the two hyperfine levels of the ground state of the caesium 133 atom."""

    SBO_0000347: "SBO"
    """duration: Amount of time during which an event persists."""

    DURATION: "SBO"
    """duration: Amount of time during which an event persists."""

    SBO_0000348: "SBO"
    """exponential time constant: Synonym: mean lifetime"""

    EXPONENTIAL_TIME_CONSTANT: "SBO"
    """exponential time constant: Synonym: mean lifetime"""

    SBO_0000349: "SBO"
    """inactivation rate constant: Synonym: kinact"""

    INACTIVATION_RATE_CONSTANT: "SBO"
    """inactivation rate constant: Synonym: kinact"""

    SBO_0000350: "SBO"
    """forward reaction velocity: The speed of an enzymatic reaction at a defined concentration of substrate(s) and enzyme."""

    FORWARD_REACTION_VELOCITY: "SBO"
    """forward reaction velocity: The speed of an enzymatic reaction at a defined concentration of substrate(s) and enzyme."""

    SBO_0000352: "SBO"
    """reverse zeroth order rate constant: Numerical parameter that quantifies the reverse velocity of a chemical reaction independant of the reactant quantities. This parameter encompasses all the contributions to the velocity. It is to be used in a reaction modelled using a continuous framework."""

    REVERSE_ZEROTH_ORDER_RATE_CONSTANT: "SBO"
    """reverse zeroth order rate constant: Numerical parameter that quantifies the reverse velocity of a chemical reaction independant of the reactant quantities. This parameter encompasses all the contributions to the velocity. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000353: "SBO"
    """reverse reaction velocity: The speed of an enzymatic reaction at a defined concentration of substrate(s) and enzyme."""

    REVERSE_REACTION_VELOCITY: "SBO"
    """reverse reaction velocity: The speed of an enzymatic reaction at a defined concentration of substrate(s) and enzyme."""

    SBO_0000354: "SBO"
    """informational molecule segment: Fragment of a macromolecule that carries genetic information."""

    INFORMATIONAL_MOLECULE_SEGMENT: "SBO"
    """informational molecule segment: Fragment of a macromolecule that carries genetic information."""

    SBO_0000355: "SBO"
    """conservation law: Mathematical expression stating that a quantity is conserved in a system, whatever happens within the boundaries of that system."""

    CONSERVATION_LAW: "SBO"
    """conservation law: Mathematical expression stating that a quantity is conserved in a system, whatever happens within the boundaries of that system."""

    SBO_0000356: "SBO"
    """decay constant: Kinetic constant characterising a mono-exponential decay. It is the inverse of the mean lifetime of the continuant being decayed. Its unit is 'per time'."""

    DECAY_CONSTANT: "SBO"
    """decay constant: Kinetic constant characterising a mono-exponential decay. It is the inverse of the mean lifetime of the continuant being decayed. Its unit is 'per time'."""

    SBO_0000357: "SBO"
    """biological effect of a perturbation: Biochemical networks can be affected by external influences. Those influences can be well-defined physical perturbations, such as a light pulse, or a change in temperature but also more complex of not well defined phenomena, for instance a biological process, an experimental setup, or a mutation."""

    BIOLOGICAL_EFFECT_OF_A_PERTURBATION: "SBO"
    """biological effect of a perturbation: Biochemical networks can be affected by external influences. Those influences can be well-defined physical perturbations, such as a light pulse, or a change in temperature but also more complex of not well defined phenomena, for instance a biological process, an experimental setup, or a mutation."""

    SBO_0000358: "SBO"
    """phenotype: A biochemical network can generate phenotypes or affects biological processes. Such processes can take place at different levels and are independent of the biochemical network itself."""

    PHENOTYPE: "SBO"
    """phenotype: A biochemical network can generate phenotypes or affects biological processes. Such processes can take place at different levels and are independent of the biochemical network itself."""

    SBO_0000359: "SBO"
    """mass conservation law: A chemical moiety that exists under different forms but is not created nor destroyed in a biochemical system. In any given system such a conserved moiety is characterized by a finite number of particles that exist in the system and is invariant."""

    MASS_CONSERVATION_LAW: "SBO"
    """mass conservation law: A chemical moiety that exists under different forms but is not created nor destroyed in a biochemical system. In any given system such a conserved moiety is characterized by a finite number of particles that exist in the system and is invariant."""

    SBO_0000360: "SBO"
    """quantity of an entity pool: The enumeration of co-localised, identical biochemical entities of a specific state, which constitute a pool. The form of enumeration may be purely numerical, or may be given in relation to another dimension such as length or volume."""

    QUANTITY_OF_AN_ENTITY_POOL: "SBO"
    """quantity of an entity pool: The enumeration of co-localised, identical biochemical entities of a specific state, which constitute a pool. The form of enumeration may be purely numerical, or may be given in relation to another dimension such as length or volume."""

    SBO_0000361: "SBO"
    """amount of an entity pool: A numerical measure of the quantity, or of some property, of the entities that constitute the entity pool."""

    AMOUNT_OF_AN_ENTITY_POOL: "SBO"
    """amount of an entity pool: A numerical measure of the quantity, or of some property, of the entities that constitute the entity pool."""

    SBO_0000362: "SBO"
    """concentration conservation law: If all forms of a moiety exist in a single compartment and the size of that compartment is fixed then the Mass Conservation is also a Concentration Conservation."""

    CONCENTRATION_CONSERVATION_LAW: "SBO"
    """concentration conservation law: If all forms of a moiety exist in a single compartment and the size of that compartment is fixed then the Mass Conservation is also a Concentration Conservation."""

    SBO_0000363: "SBO"
    """activation constant: Synonym: Kx"""

    ACTIVATION_CONSTANT: "SBO"
    """activation constant: Synonym: Kx"""

    SBO_0000364: "SBO"
    """multimer cardinality: Number of monomers composing a multimeric entity."""

    MULTIMER_CARDINALITY: "SBO"
    """multimer cardinality: Number of monomers composing a multimeric entity."""

    SBO_0000365: "SBO"
    """forward non-integral order rate constant, continuous case: Numerical parameter that quantifies the forward velocity of a chemical reaction where reactants have non-integral orders. This parameter encompasses all the contributions to the velocity except the quantity of the reactants.It is to be used in a reaction modelled using a continuous framework."""

    FORWARD_NON_INTEGRAL_ORDER_RATE_CONSTANT__CONTINUOUS_CASE: "SBO"
    """forward non-integral order rate constant, continuous case: Numerical parameter that quantifies the forward velocity of a chemical reaction where reactants have non-integral orders. This parameter encompasses all the contributions to the velocity except the quantity of the reactants.It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000366: "SBO"
    """forward non-integral order rate constant, discrete case: Numerical parameter that quantifies the forward velocity of a chemical reaction where reactants have non-integral orders. This parameter encompasses all the contributions to the velocity except the quantity of the reactants. It is to be used in a reaction modelled using a discrete framework."""

    FORWARD_NON_INTEGRAL_ORDER_RATE_CONSTANT__DISCRETE_CASE: "SBO"
    """forward non-integral order rate constant, discrete case: Numerical parameter that quantifies the forward velocity of a chemical reaction where reactants have non-integral orders. This parameter encompasses all the contributions to the velocity except the quantity of the reactants. It is to be used in a reaction modelled using a discrete framework."""

    SBO_0000367: "SBO"
    """reverse non-integral order rate constant, discrete case: Numerical parameter that quantifies the reverse velocity of a chemical reaction where products have non-integral orders. This parameter encompasses all the contributions to the velocity except the quantity of the products. It is to be used in a reaction modelled using a discrete framework."""

    REVERSE_NON_INTEGRAL_ORDER_RATE_CONSTANT__DISCRETE_CASE: "SBO"
    """reverse non-integral order rate constant, discrete case: Numerical parameter that quantifies the reverse velocity of a chemical reaction where products have non-integral orders. This parameter encompasses all the contributions to the velocity except the quantity of the products. It is to be used in a reaction modelled using a discrete framework."""

    SBO_0000368: "SBO"
    """reverse non-integral order rate constant, continuous case: Numerical parameter that quantifies the reverse velocity of a chemical reaction where products have non-integral orders. This parameter encompasses all the contributions to the velocity except the quantity of the products. It is to be used in a reaction modelled using a continuous framework."""

    REVERSE_NON_INTEGRAL_ORDER_RATE_CONSTANT__CONTINUOUS_CASE: "SBO"
    """reverse non-integral order rate constant, continuous case: Numerical parameter that quantifies the reverse velocity of a chemical reaction where products have non-integral orders. This parameter encompasses all the contributions to the velocity except the quantity of the products. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000369: "SBO"
    """gene regulatory region: Region of a gene that is involved in the modulation of the expression of the gene."""

    GENE_REGULATORY_REGION: "SBO"
    """gene regulatory region: Region of a gene that is involved in the modulation of the expression of the gene."""

    SBO_0000370: "SBO"
    """Michaelis constant in non-equilibrium situation: Michaelis constant derived or experimentally measured under non-equilibrium conditions."""

    MICHAELIS_CONSTANT_IN_NON_EQUILIBRIUM_SITUATION: "SBO"
    """Michaelis constant in non-equilibrium situation: Michaelis constant derived or experimentally measured under non-equilibrium conditions."""

    SBO_0000371: "SBO"
    """Michaelis constant in quasi-steady state situation: Michaelis constant derived using a steady-state assumption for enzyme-substrate and enzyme-product intermediates. For example see Briggs-Haldane equation (SBO:0000031)."""

    MICHAELIS_CONSTANT_IN_QUASI_STEADY_STATE_SITUATION: "SBO"
    """Michaelis constant in quasi-steady state situation: Michaelis constant derived using a steady-state assumption for enzyme-substrate and enzyme-product intermediates. For example see Briggs-Haldane equation (SBO:0000031)."""

    SBO_0000372: "SBO"
    """Michaelis constant in irreversible situation: Michaelis constant derived assuming enzyme-substrate and enzyme-product intermediates are formed in consecutive irreversible reactions. The constant K is the ratio of the forward rate constants. For example see Van Slyke-Cullen equation (SBO:0000030)."""

    MICHAELIS_CONSTANT_IN_IRREVERSIBLE_SITUATION: "SBO"
    """Michaelis constant in irreversible situation: Michaelis constant derived assuming enzyme-substrate and enzyme-product intermediates are formed in consecutive irreversible reactions. The constant K is the ratio of the forward rate constants. For example see Van Slyke-Cullen equation (SBO:0000030)."""
    ...
    MICHAELIS_CONSTANT_IN_FAST_EQUILIBRIUM_SITUATION: "SBO"
    """Michaelis constant in fast equilibrium situation: Michaelis constant as determined in a reaction where the formation of the enzyme-substrate complex occurs at a much faster rate than subsequent steps, and so are assumed to be in a quasi-equilibrium situation. K is equivalent to an equilibrium constant. For example see Henri-Michaelis-Menten equation (SBO:0000029)."""

    SBO_0000374: "SBO"
    """relationship: connectedness between entities and/or interactions representing their relatedness or influence."""

    RELATIONSHIP: "SBO"
    """relationship: connectedness between entities and/or interactions representing their relatedness or influence."""

    SBO_0000375: "SBO"
    """process: A sequential series of actions, motions, or occurrences, such as chemical reactions, that affect one or more entities in a phenomenologically characteristic manner."""

    PROCESS: "SBO"
    """process: A sequential series of actions, motions, or occurrences, such as chemical reactions, that affect one or more entities in a phenomenologically characteristic manner."""

    SBO_0000376: "SBO"
    """hydrolysis: Decomposition of a compound by reaction with water, where the hydroxyl and H groups are incorporated into different products"""

    HYDROLYSIS: "SBO"
    """hydrolysis: Decomposition of a compound by reaction with water, where the hydroxyl and H groups are incorporated into different products"""

    SBO_0000377: "SBO"
    """isomerisation: A reaction in which the principal reactant and principal product are isomers of each other"""

    ISOMERISATION: "SBO"
    """isomerisation: A reaction in which the principal reactant and principal product are isomers of each other"""

    SBO_0000378: "SBO"
    """enzymatic rate law for inhibition of irreversible unireactant enzymes by competing substrates: Inhibition of a unireactant enzyme by competing substrates (Sa) that bind to the free enzyme on the same binding site. The enzyme does not catalyse the reactions in both directions."""

    ENZYMATIC_RATE_LAW_FOR_INHIBITION_OF_IRREVERSIBLE_UNIREACTANT_ENZYMES_BY_COMPETING_SUBSTRATES: "SBO"
    """enzymatic rate law for inhibition of irreversible unireactant enzymes by competing substrates: Inhibition of a unireactant enzyme by competing substrates (Sa) that bind to the free enzyme on the same binding site. The enzyme does not catalyse the reactions in both directions."""
    ...
    ENZYMATIC_RATE_LAW_FOR_SIMPLE_COMPETITIVE_INHIBITION_OF_IRREVERSIBLE_UNIREACTANT_ENZYMES_BY_TWO_NON_EXCLUSIVE_INHIBITORS: "SBO"
    """enzymatic rate law for simple competitive inhibition of irreversible unireactant enzymes by two non-exclusive inhibitors: Inhibition of a unireactant enzyme by two inhibitors that can bind once to the free enzyme and preclude the binding of the substrate. Binding of one inhibitor may affect binding of the other, or not. The enzymes do not catalyse the reactions in both directions."""

    SBO_0000380: "SBO"
    """biochemical coefficient: number used as a multiplicative or exponential factor for quantities, expressions or functions"""

    BIOCHEMICAL_COEFFICIENT: "SBO"
    """biochemical coefficient: number used as a multiplicative or exponential factor for quantities, expressions or functions"""

    SBO_0000381: "SBO"
    """biochemical proportionality coefficient: A multiplicative factor for quantities, expressions or functions"""

    BIOCHEMICAL_PROPORTIONALITY_COEFFICIENT: "SBO"
    """biochemical proportionality coefficient: A multiplicative factor for quantities, expressions or functions"""

    SBO_0000382: "SBO"
    """biochemical exponential coefficient: number used as an exponential factor for quantities, expressions or functions"""

    BIOCHEMICAL_EXPONENTIAL_COEFFICIENT: "SBO"
    """biochemical exponential coefficient: number used as an exponential factor for quantities, expressions or functions"""

    SBO_0000383: "SBO"
    """biochemical cooperative inhibition coefficient: The coefficient used to quantify the effect on inhibition constants of multiple inhibitors binding non-exclusively to the enzyme."""

    BIOCHEMICAL_COOPERATIVE_INHIBITION_COEFFICIENT: "SBO"
    """biochemical cooperative inhibition coefficient: The coefficient used to quantify the effect on inhibition constants of multiple inhibitors binding non-exclusively to the enzyme."""

    SBO_0000384: "SBO"
    """biochemical inhibitory proportionality coefficient: Coefficient that quantifies the effect on inhibition constants of either binding of multiple substrates or inhibitors."""

    BIOCHEMICAL_INHIBITORY_PROPORTIONALITY_COEFFICIENT: "SBO"
    """biochemical inhibitory proportionality coefficient: Coefficient that quantifies the effect on inhibition constants of either binding of multiple substrates or inhibitors."""

    SBO_0000385: "SBO"
    """biochemical cooperative inhibitor substrate coefficient: The coefficient that describes the proportional change of Ks or Ki when inhibitor or substrate is bound, respectively, to the enzyme."""

    BIOCHEMICAL_COOPERATIVE_INHIBITOR_SUBSTRATE_COEFFICIENT: "SBO"
    """biochemical cooperative inhibitor substrate coefficient: The coefficient that describes the proportional change of Ks or Ki when inhibitor or substrate is bound, respectively, to the enzyme."""

    SBO_0000386: "SBO"
    """enzymatic rate law for inhibition of irreversible unireactant enzymes by single competing substrate: Inhibition of a unireactant enzyme by a competing substrate (Sa) that binds to the free enzyme on the same binding site. The enzyme does not catalyse the reactions in both directions."""

    ENZYMATIC_RATE_LAW_FOR_INHIBITION_OF_IRREVERSIBLE_UNIREACTANT_ENZYMES_BY_SINGLE_COMPETING_SUBSTRATE: "SBO"
    """enzymatic rate law for inhibition of irreversible unireactant enzymes by single competing substrate: Inhibition of a unireactant enzyme by a competing substrate (Sa) that binds to the free enzyme on the same binding site. The enzyme does not catalyse the reactions in both directions."""

    SBO_0000387: "SBO"
    """enzymatic rate law for competitive inhibition of irreversible unireactant enzyme by product: Inhibition of a unireactant enzyme by a competing product (P) that binds to the free enzyme on the same binding site. The enzyme does not catalyse the reactions in both directions."""

    ENZYMATIC_RATE_LAW_FOR_COMPETITIVE_INHIBITION_OF_IRREVERSIBLE_UNIREACTANT_ENZYME_BY_PRODUCT: "SBO"
    """enzymatic rate law for competitive inhibition of irreversible unireactant enzyme by product: Inhibition of a unireactant enzyme by a competing product (P) that binds to the free enzyme on the same binding site. The enzyme does not catalyse the reactions in both directions."""

    SBO_0000388: "SBO"
    """enzymatic rate law for inhibition of irreversible unireactant enzymes by single competing substrate with product inhibition: Inhibition of a unireactant enzyme by a competing substrate (Sa) that binds to the free enzyme on the same binding site, and competitive inhibition by a product (P) and an alternative product (Pa). The enzyme does not catalyse the reactions in both directions."""

    ENZYMATIC_RATE_LAW_FOR_INHIBITION_OF_IRREVERSIBLE_UNIREACTANT_ENZYMES_BY_SINGLE_COMPETING_SUBSTRATE_WITH_PRODUCT_INHIBITION: "SBO"
    """enzymatic rate law for inhibition of irreversible unireactant enzymes by single competing substrate with product inhibition: Inhibition of a unireactant enzyme by a competing substrate (Sa) that binds to the free enzyme on the same binding site, and competitive inhibition by a product (P) and an alternative product (Pa). The enzyme does not catalyse the reactions in both directions."""

    SBO_0000389: "SBO"
    """switch value: A parameter value taken by a switch, which has a discrete set of values which can be alternated or switched between."""

    SWITCH_VALUE: "SBO"
    """switch value: A parameter value taken by a switch, which has a discrete set of values which can be alternated or switched between."""

    SBO_0000390: "SBO"
    """boolean switch: Synonym: binary switch"""

    BOOLEAN_SWITCH: "SBO"
    """boolean switch: Synonym: binary switch"""

    SBO_0000391: "SBO"
    """steady state expression: A mathematical expression that describes a steady state situation"""

    STEADY_STATE_EXPRESSION: "SBO"
    """steady state expression: A mathematical expression that describes a steady state situation"""

    SBO_0000392: "SBO"
    """equivalence: Term to signify those material or conceptual entities that are identical in some respect within a frame of reference"""

    EQUIVALENCE: "SBO"
    """equivalence: Term to signify those material or conceptual entities that are identical in some respect within a frame of reference"""

    SBO_0000393: "SBO"
    """production: Generation of a material or conceptual entity."""

    PRODUCTION: "SBO"
    """production: Generation of a material or conceptual entity."""

    SBO_0000394: "SBO"
    """consumption: Decrease in amount of a material or conceptual entity."""

    CONSUMPTION: "SBO"
    """consumption: Decrease in amount of a material or conceptual entity."""

    SBO_0000395: "SBO"
    """encapsulating process: An aggregation of interactions and entities into a single process."""

    ENCAPSULATING_PROCESS: "SBO"
    """encapsulating process: An aggregation of interactions and entities into a single process."""

    SBO_0000396: "SBO"
    """uncertain process: An equivocal or conjectural process, whose existence is assumed but not proven."""

    UNCERTAIN_PROCESS: "SBO"
    """uncertain process: An equivocal or conjectural process, whose existence is assumed but not proven."""

    SBO_0000397: "SBO"
    """omitted process: One or more processes that are not represented in certain representations or interpretations of a model."""

    OMITTED_PROCESS: "SBO"
    """omitted process: One or more processes that are not represented in certain representations or interpretations of a model."""

    SBO_0000398: "SBO"
    """logical relationship: Relationship between entities (material or conceptual) and logical operators, or between logical operators themselves."""

    LOGICAL_RELATIONSHIP: "SBO"
    """logical relationship: Relationship between entities (material or conceptual) and logical operators, or between logical operators themselves."""

    SBO_0000399: "SBO"
    """decarboxylation: A process in which a carboxyl group (COOH) is removed from a molecule as carbon dioxide."""

    DECARBOXYLATION: "SBO"
    """decarboxylation: A process in which a carboxyl group (COOH) is removed from a molecule as carbon dioxide."""

    SBO_0000400: "SBO"
    """decarbonylation: Removal of a carbonyl group (-C-O-) from a molecule, usually as carbon monoxide"""

    DECARBONYLATION: "SBO"
    """decarbonylation: Removal of a carbonyl group (-C-O-) from a molecule, usually as carbon monoxide"""

    SBO_0000401: "SBO"
    """deamination: Removal of an amine group from a molecule, often under the addition of water"""

    DEAMINATION: "SBO"
    """deamination: Removal of an amine group from a molecule, often under the addition of water"""

    SBO_0000402: "SBO"
    """transfer of a chemical group: Covalent reaction that results in the transfer of a chemical group from one molecule to another."""

    TRANSFER_OF_A_CHEMICAL_GROUP: "SBO"
    """transfer of a chemical group: Covalent reaction that results in the transfer of a chemical group from one molecule to another."""

    SBO_0000403: "SBO"
    """transamination: The transfer of an amino group between two molecules. Commonly in biology this is restricted to reactions between an amino acid and an alpha-keto carbonic acid, whereby the reacting amino acid is converted into an alpha-keto acid, and the alpha-keto acid reactant into an amino acid."""

    TRANSAMINATION: "SBO"
    """transamination: The transfer of an amino group between two molecules. Commonly in biology this is restricted to reactions between an amino acid and an alpha-keto carbonic acid, whereby the reacting amino acid is converted into an alpha-keto acid, and the alpha-keto acid reactant into an amino acid."""

    SBO_0000404: "SBO"
    """unit of genetic information: Functional entity associated with or derived from a unit of inheritance."""

    UNIT_OF_GENETIC_INFORMATION: "SBO"
    """unit of genetic information: Functional entity associated with or derived from a unit of inheritance."""

    SBO_0000405: "SBO"
    """perturbing agent: A material entity that is responsible for a perturbing effect"""

    PERTURBING_AGENT: "SBO"
    """perturbing agent: A material entity that is responsible for a perturbing effect"""

    SBO_0000406: "SBO"
    """observable: An entity that can be measured quantitatively"""

    OBSERVABLE: "SBO"
    """observable: An entity that can be measured quantitatively"""

    SBO_0000407: "SBO"
    """absolute inhibition: Control that precludes the execution of a process."""

    ABSOLUTE_INHIBITION: "SBO"
    """absolute inhibition: Control that precludes the execution of a process."""

    SBO_0000408: "SBO"
    """biological activity: Effect of a biological entity on biological structures or processes."""

    BIOLOGICAL_ACTIVITY: "SBO"
    """biological activity: Effect of a biological entity on biological structures or processes."""

    SBO_0000409: "SBO"
    """interaction outcome: Entity that results from the interaction between other entities."""

    INTERACTION_OUTCOME: "SBO"
    """interaction outcome: Entity that results from the interaction between other entities."""

    SBO_0000410: "SBO"
    """implicit compartment: A compartment whose existence is inferred due to the presence of known material entities which must be bounded, allowing the creation of material entity pools."""

    IMPLICIT_COMPARTMENT: "SBO"
    """implicit compartment: A compartment whose existence is inferred due to the presence of known material entities which must be bounded, allowing the creation of material entity pools."""

    SBO_0000411: "SBO"
    """absolute stimulation: Control that always triggers the controlled process."""

    ABSOLUTE_STIMULATION: "SBO"
    """absolute stimulation: Control that always triggers the controlled process."""

    SBO_0000412: "SBO"
    """biological activity: The potential action that a biological entity has on other entities. Example are enzymatic activity, binding activity etc."""

    SBO_0000413: "SBO"
    """positional relationship: The connectedness between entities as related by their position"""

    POSITIONAL_RELATIONSHIP: "SBO"
    """positional relationship: The connectedness between entities as related by their position"""

    SBO_0000414: "SBO"
    """cis: Positional relationship between entities on the same strand (e.g. in DNA), or on the same side."""

    CIS: "SBO"
    """cis: Positional relationship between entities on the same strand (e.g. in DNA), or on the same side."""

    SBO_0000415: "SBO"
    """trans: Positional relationship between entities on different sides, or strands"""

    TRANS: "SBO"
    """trans: Positional relationship between entities on different sides, or strands"""

    SBO_0000416: "SBO"
    """true: One of the two values possible from a boolean switch, which equates to '1', 'on' or 'input'."""

    TRUE: "SBO"
    """true: One of the two values possible from a boolean switch, which equates to '1', 'on' or 'input'."""

    SBO_0000417: "SBO"
    """false: One of the two values possible from a boolean switch, which equates to '0', 'off' or 'no input'."""

    FALSE: "SBO"
    """false: One of the two values possible from a boolean switch, which equates to '0', 'off' or 'no input'."""

    SBO_0000418: "SBO"
    """multimer of complexes: Non-covalent association between several independant complexes"""

    MULTIMER_OF_COMPLEXES: "SBO"
    """multimer of complexes: Non-covalent association between several independant complexes"""

    SBO_0000419: "SBO"
    """multimer of informational molecule segment: Non-covalent association between portions of macromolecules that carry genetic information"""

    MULTIMER_OF_INFORMATIONAL_MOLECULE_SEGMENT: "SBO"
    """multimer of informational molecule segment: Non-covalent association between portions of macromolecules that carry genetic information"""

    SBO_0000420: "SBO"
    """multimer of macromolecules: Non-covalent association between several macromolecules"""

    MULTIMER_OF_MACROMOLECULES: "SBO"
    """multimer of macromolecules: Non-covalent association between several macromolecules"""

    SBO_0000421: "SBO"
    """multimer of simple chemicals: Non-covalent association between several simple chemicals"""

    MULTIMER_OF_SIMPLE_CHEMICALS: "SBO"
    """multimer of simple chemicals: Non-covalent association between several simple chemicals"""

    SBO_0000422: "SBO"
    """isoinhibition constant: Inhibitory constant for the binding of a given ligand with an isomeric form of an enzyme."""

    ISOINHIBITION_CONSTANT: "SBO"
    """isoinhibition constant: Inhibitory constant for the binding of a given ligand with an isomeric form of an enzyme."""

    SBO_0000423: "SBO"
    """pseudo-dissociation constant for product: In reversible reactions this is the concentration of product that is required to achieve half activation or inhibition in Hill-type kinetics, in the absence of the substrate."""

    PSEUDO_DISSOCIATION_CONSTANT_FOR_PRODUCT: "SBO"
    """pseudo-dissociation constant for product: In reversible reactions this is the concentration of product that is required to achieve half activation or inhibition in Hill-type kinetics, in the absence of the substrate."""

    SBO_0000424: "SBO"
    """pseudo-dissociation constant for substrate: In reversible reactions this is the concentration of substrate that is required to achieve half activation or inhibition in Hill-type kinetics, in the absence of the product."""

    PSEUDO_DISSOCIATION_CONSTANT_FOR_SUBSTRATE: "SBO"
    """pseudo-dissociation constant for substrate: In reversible reactions this is the concentration of substrate that is required to achieve half activation or inhibition in Hill-type kinetics, in the absence of the product."""

    SBO_0000425: "SBO"
    """reversible Hill-type enzymatic rate law: Reversible Hill-type kinetics represents the situation where a single substrate and product bind cooperatively and reversibly to the enzyme. Co-operativity is seen if the Hill coefficient (h) is greater than 1, indicating that the binding of one substrate (or product) molecule facilitates the binding of the next. The opposite effect is evident with a coefficient less than 1."""

    REVERSIBLE_HILL_TYPE_ENZYMATIC_RATE_LAW: "SBO"
    """reversible Hill-type enzymatic rate law: Reversible Hill-type kinetics represents the situation where a single substrate and product bind cooperatively and reversibly to the enzyme. Co-operativity is seen if the Hill coefficient (h) is greater than 1, indicating that the binding of one substrate (or product) molecule facilitates the binding of the next. The opposite effect is evident with a coefficient less than 1."""

    SBO_0000426: "SBO"
    """modulated reversible Hill-type rate law: Reversible Hill-type kinetics in the presence of at least one modifier whose binding is affected by the presence of the substrate or product."""

    MODULATED_REVERSIBLE_HILL_TYPE_RATE_LAW: "SBO"
    """modulated reversible Hill-type rate law: Reversible Hill-type kinetics in the presence of at least one modifier whose binding is affected by the presence of the substrate or product."""

    SBO_0000427: "SBO"
    """modulated reversible Hill-type rate law with one modifier: The modifier can be either an activator or inhibitor depending on the value of alpha (activator for values larger than 1, inhibitor for values smaller than 1; no effect if exactly 1). This reflects the effect of the presence of substrate and product on the binding of the modifier. The equation, derived by Hofmeyr and Cornish-Bowden (Comput. Appl. Biosci. 13, 377 - 385 (1997)"""

    MODULATED_REVERSIBLE_HILL_TYPE_RATE_LAW_WITH_ONE_MODIFIER: "SBO"
    """modulated reversible Hill-type rate law with one modifier: The modifier can be either an activator or inhibitor depending on the value of alpha (activator for values larger than 1, inhibitor for values smaller than 1; no effect if exactly 1). This reflects the effect of the presence of substrate and product on the binding of the modifier. The equation, derived by Hofmeyr and Cornish-Bowden (Comput. Appl. Biosci. 13, 377 - 385 (1997)"""

    SBO_0000428: "SBO"
    """modulated reversible Hill-type rate law with two modifiers: The modifiers can be either activators or inhibitors depending on the values of and alpha (activators for values larger than 1, inhibitors for values smaller than 1; no effect if exactly 1). The assumption is that the binding of one modifier affects the binding of the second. Modifiers are assumed to bind at different sites. The synergetic effects of the two modifiers depend on the parameter alpha (if unity then they are independent; if zero they compete for the same binding site). and reflect the effect of the presence of substrate and product on the binding of modifier A or modifier B. alphaA and alphaB factors account for the effect of substrate and product binding on the binding of modifier A and modifier B respectively. alphaAB accounts for the interaction of the modifiers on each others binding. (if < 1 Ma is inhibitor, if > 1 activator) alpha_2 : factor accounting for the effect of S and P on the binding of Mb (if < 1 Mb is inhibitor, if > 1 activator) alpha_3 : factor accounting for interaction of Ma to Mb binding to the enzyme (and v. v.)."""

    MODULATED_REVERSIBLE_HILL_TYPE_RATE_LAW_WITH_TWO_MODIFIERS: "SBO"
    """modulated reversible Hill-type rate law with two modifiers: The modifiers can be either activators or inhibitors depending on the values of and alpha (activators for values larger than 1, inhibitors for values smaller than 1; no effect if exactly 1). The assumption is that the binding of one modifier affects the binding of the second. Modifiers are assumed to bind at different sites. The synergetic effects of the two modifiers depend on the parameter alpha (if unity then they are independent; if zero they compete for the same binding site). and reflect the effect of the presence of substrate and product on the binding of modifier A or modifier B. alphaA and alphaB factors account for the effect of substrate and product binding on the binding of modifier A and modifier B respectively. alphaAB accounts for the interaction of the modifiers on each others binding. (if < 1 Ma is inhibitor, if > 1 activator) alpha_2 : factor accounting for the effect of S and P on the binding of Mb (if < 1 Mb is inhibitor, if > 1 activator) alpha_3 : factor accounting for interaction of Ma to Mb binding to the enzyme (and v. v.)."""

    SBO_0000429: "SBO"
    """enzymatic rate law for multireactant enzymes: Kinetics of enzyme-catalysed reactions with 2 or more substrates or products"""

    ENZYMATIC_RATE_LAW_FOR_MULTIREACTANT_ENZYMES: "SBO"
    """enzymatic rate law for multireactant enzymes: Kinetics of enzyme-catalysed reactions with 2 or more substrates or products"""

    SBO_0000430: "SBO"
    """enzymatic rate law for modulated unireactant enzymes: Kinetics of enzymes that react with one substance, and whose activity may be positively or negatively modulated."""

    ENZYMATIC_RATE_LAW_FOR_MODULATED_UNIREACTANT_ENZYMES: "SBO"
    """enzymatic rate law for modulated unireactant enzymes: Kinetics of enzymes that react with one substance, and whose activity may be positively or negatively modulated."""

    SBO_0000431: "SBO"
    """unmodulated reversible Hill-type rate law: Reversible equivalent of Hill kinetics, where substrate and product bind co-operatively to the enzyme. A Hill coefficient (h) of greater than 1 indicates positive co-operativity between substrate and product, while h values below 1 indicate negative co-operativity."""

    UNMODULATED_REVERSIBLE_HILL_TYPE_RATE_LAW: "SBO"
    """unmodulated reversible Hill-type rate law: Reversible equivalent of Hill kinetics, where substrate and product bind co-operatively to the enzyme. A Hill coefficient (h) of greater than 1 indicates positive co-operativity between substrate and product, while h values below 1 indicate negative co-operativity."""

    SBO_0000432: "SBO"
    """irreversible Michaelis Menten rate law for two substrates: Enzymatic rate law for an irreversible reaction involving two substrates and one product."""

    IRREVERSIBLE_MICHAELIS_MENTEN_RATE_LAW_FOR_TWO_SUBSTRATES: "SBO"
    """irreversible Michaelis Menten rate law for two substrates: Enzymatic rate law for an irreversible reaction involving two substrates and one product."""

    SBO_0000433: "SBO"
    """Ordered Bi-Bi mechanism rate law: Enzymatic rate law for a reaction involving two substrates and two products. The products P and then Q are released strictly in order, while the substrates are bound strictly in the order A and then B."""

    ORDERED_BI_BI_MECHANISM_RATE_LAW: "SBO"
    """Ordered Bi-Bi mechanism rate law: Enzymatic rate law for a reaction involving two substrates and two products. The products P and then Q are released strictly in order, while the substrates are bound strictly in the order A and then B."""

    SBO_0000434: "SBO"
    """Ordered Bi-Uni mechanism rate law: Enzymatic rate for a reaction involving two substrates and one product. The substrates A and then B are bound strictly in order."""

    ORDERED_BI_UNI_MECHANISM_RATE_LAW: "SBO"
    """Ordered Bi-Uni mechanism rate law: Enzymatic rate for a reaction involving two substrates and one product. The substrates A and then B are bound strictly in order."""

    SBO_0000435: "SBO"
    """Ordered Uni-Bi mechanism rate law: Enzymatic rate law for a reaction with one substrate and two products. The products P and then Q are released in the strict order P and then Q."""

    ORDERED_UNI_BI_MECHANISM_RATE_LAW: "SBO"
    """Ordered Uni-Bi mechanism rate law: Enzymatic rate law for a reaction with one substrate and two products. The products P and then Q are released in the strict order P and then Q."""

    SBO_0000436: "SBO"
    """Ping Pong Bi-Bi mechanism rate law: Enzymatic rate law for a reaction involving two substrates and two products. The first product (P) is released after the first substrate (A) has been bound. The second product (Q) is released after the second substrate (B) has been bound."""

    PING_PONG_BI_BI_MECHANISM_RATE_LAW: "SBO"
    """Ping Pong Bi-Bi mechanism rate law: Enzymatic rate law for a reaction involving two substrates and two products. The first product (P) is released after the first substrate (A) has been bound. The second product (Q) is released after the second substrate (B) has been bound."""

    SBO_0000437: "SBO"
    """reversible Iso Uni-Uni: Enzyme catalysed reaction involving one substrate and one product. Unlike the reversible uni-uni mechanism (SBO:0000326), the mechanism assumes an enzyme intermediate. Therefore, the free enzyme generated after the release of product from enzyme-product complex is not the same form as that which bind the substrate to form enzyme-substrate complex. Some permeases are thought to follow this mechanism, such that isomerization in the membrane may be accomplished through re-orientation in the membrane."""

    REVERSIBLE_ISO_UNI_UNI: "SBO"
    """reversible Iso Uni-Uni: Enzyme catalysed reaction involving one substrate and one product. Unlike the reversible uni-uni mechanism (SBO:0000326), the mechanism assumes an enzyme intermediate. Therefore, the free enzyme generated after the release of product from enzyme-product complex is not the same form as that which bind the substrate to form enzyme-substrate complex. Some permeases are thought to follow this mechanism, such that isomerization in the membrane may be accomplished through re-orientation in the membrane."""

    SBO_0000438: "SBO"
    """reversible Uni-Uni: Synonym: Uni-Uni Reversible Simple Michaelis-Menten"""

    REVERSIBLE_UNI_UNI: "SBO"
    """reversible Uni-Uni: Synonym: Uni-Uni Reversible Simple Michaelis-Menten"""

    SBO_0000439: "SBO"
    """Uni-Uni Reversible using Haldane relationship: Synonym: Uni-Uni"""

    UNI_UNI_REVERSIBLE_USING_HALDANE_RELATIONSHIP: "SBO"
    """Uni-Uni Reversible using Haldane relationship: Synonym: Uni-Uni"""

    SBO_0000440: "SBO"
    """enzymatic rate law for irreversible allosteric inhibition: Enzymatic rate law which follows from the allosteric concerted model (symmetry model or MWC model).This states that enzyme subunits can assume one of two conformational states (relaxed or tense), and that the state of one subunit is shared or enforced on the others. The binding of a ligand to a site other than that bound by the substrate (active site) can shift the conformation from one state to the other. L represents the equilibrium constant between active and inactive states of the enzyme, and n represents the number of binding sites for the substrate and inhibitor."""

    ENZYMATIC_RATE_LAW_FOR_IRREVERSIBLE_ALLOSTERIC_INHIBITION: "SBO"
    """enzymatic rate law for irreversible allosteric inhibition: Enzymatic rate law which follows from the allosteric concerted model (symmetry model or MWC model).This states that enzyme subunits can assume one of two conformational states (relaxed or tense), and that the state of one subunit is shared or enforced on the others. The binding of a ligand to a site other than that bound by the substrate (active site) can shift the conformation from one state to the other. L represents the equilibrium constant between active and inactive states of the enzyme, and n represents the number of binding sites for the substrate and inhibitor."""
    ...
    ENZYMATIC_RATE_LAW_FOR_MIXED_TYPE_INHIBITION_OF_REVERSIBLE_ENZYMES_BY_MUTUALLY_EXCLUSIVE_INHIBITORS: "SBO"
    """enzymatic rate law for mixed-type inhibition of reversible enzymes by mutually exclusive inhibitors: Reversible inhibition of a unireactant enzyme by inhibitors that can bind to the enzyme-substrate complex and to the free enzyme with the same equilibrium constant. The inhibitor is noncompetitive with the substrate."""

    SBO_0000442: "SBO"
    """enzymatic rate law for simple reversible non-competitive inhibition of unireactant enzymes: Reversible inhibition of a unireactant enzyme by one inhibitor that can bind to the enzyme-substrate complex and to the free enzyme with the same equilibrium constant. The inhibitor is noncompetitive with the substrate."""

    ENZYMATIC_RATE_LAW_FOR_SIMPLE_REVERSIBLE_NON_COMPETITIVE_INHIBITION_OF_UNIREACTANT_ENZYMES: "SBO"
    """enzymatic rate law for simple reversible non-competitive inhibition of unireactant enzymes: Reversible inhibition of a unireactant enzyme by one inhibitor that can bind to the enzyme-substrate complex and to the free enzyme with the same equilibrium constant. The inhibitor is noncompetitive with the substrate."""

    SBO_0000443: "SBO"
    """enzymatic rate law for reversible essential activation: Synonym: specific activation"""

    ENZYMATIC_RATE_LAW_FOR_REVERSIBLE_ESSENTIAL_ACTIVATION: "SBO"
    """enzymatic rate law for reversible essential activation: Synonym: specific activation"""

    SBO_0000444: "SBO"
    """enzymatic rate law for reversible mixed activation: Enzymatic rate law where the activator enhances the rate of reaction through specific and catalytic effects, which increase the apparent limiting rate and decrease apparent Michaelis constant. The activator can bind reversibly both the free enzyme and enzyme-substrate complex, while the substrate can bind only to enzyme-activator complex. Catalytic activity is seen only when enzyme, substrate and activator are complexed."""

    ENZYMATIC_RATE_LAW_FOR_REVERSIBLE_MIXED_ACTIVATION: "SBO"
    """enzymatic rate law for reversible mixed activation: Enzymatic rate law where the activator enhances the rate of reaction through specific and catalytic effects, which increase the apparent limiting rate and decrease apparent Michaelis constant. The activator can bind reversibly both the free enzyme and enzyme-substrate complex, while the substrate can bind only to enzyme-activator complex. Catalytic activity is seen only when enzyme, substrate and activator are complexed."""

    SBO_0000445: "SBO"
    """enzymatic rate law for irreversible substrate activation: This enzymatic rate law is available only for irreversible reactions, with one substrate and one product. There is a second binding site for the enzyme which, when occupied, activates the enzyme. Substrate binding at either site can occur at random."""

    ENZYMATIC_RATE_LAW_FOR_IRREVERSIBLE_SUBSTRATE_ACTIVATION: "SBO"
    """enzymatic rate law for irreversible substrate activation: This enzymatic rate law is available only for irreversible reactions, with one substrate and one product. There is a second binding site for the enzyme which, when occupied, activates the enzyme. Substrate binding at either site can occur at random."""

    SBO_0000446: "SBO"
    """enzymatic rate law for irrreversible mixed activation: Enzymatic rate law where the activator enhances the rate of reaction through specific and catalytic effects, which increase the apparent limiting rate and decrease apparent Michaelis constant. The activator can bind irreversibly both free enzyme and enzyme-substrate complex, while the substrate can bind only to enzyme-activator complex. Catalytic activity is seen only when enzyme, substrate and activator are complexed."""

    ENZYMATIC_RATE_LAW_FOR_IRRREVERSIBLE_MIXED_ACTIVATION: "SBO"
    """enzymatic rate law for irrreversible mixed activation: Enzymatic rate law where the activator enhances the rate of reaction through specific and catalytic effects, which increase the apparent limiting rate and decrease apparent Michaelis constant. The activator can bind irreversibly both free enzyme and enzyme-substrate complex, while the substrate can bind only to enzyme-activator complex. Catalytic activity is seen only when enzyme, substrate and activator are complexed."""

    SBO_0000447: "SBO"
    """enzymatic rate law for reversible catalytic activation with one activator: Enzymatic rate law where an activator enhances the rate of reaction by increasing the apparent limiting rate; The reversible binding of the activator to the enzyme-substrate complex is required for enzyme catalytic activity (to generate the product)."""

    ENZYMATIC_RATE_LAW_FOR_REVERSIBLE_CATALYTIC_ACTIVATION_WITH_ONE_ACTIVATOR: "SBO"
    """enzymatic rate law for reversible catalytic activation with one activator: Enzymatic rate law where an activator enhances the rate of reaction by increasing the apparent limiting rate; The reversible binding of the activator to the enzyme-substrate complex is required for enzyme catalytic activity (to generate the product)."""
    ...
    ENZYMATIC_RATE_LAW_FOR_REVERSIBLE_SPECIFIC_ACTIVATION: "SBO"
    """enzymatic rate law for reversible specific activation: Enzymatic rate law for one substrate, one product and one modifier which acts as an activator. The activator enhances the rate of reaction by decreasing the apparent Michaelis constant. The activator reversibly binds to the enzyme before the enzyme can bind the substrate."""

    SBO_0000449: "SBO"
    """enzymatic rate law for irreversible catalytic activation with one activator: Enzymatic rate law where an activator enhances the rate of reaction by increasing the apparent limiting rate; The activator binding to the enzyme-substrate complex (irreversibly) is required for enzyme catalytic activity (to generate the product)."""

    ENZYMATIC_RATE_LAW_FOR_IRREVERSIBLE_CATALYTIC_ACTIVATION_WITH_ONE_ACTIVATOR: "SBO"
    """enzymatic rate law for irreversible catalytic activation with one activator: Enzymatic rate law where an activator enhances the rate of reaction by increasing the apparent limiting rate; The activator binding to the enzyme-substrate complex (irreversibly) is required for enzyme catalytic activity (to generate the product)."""
    ...
    ENZYMATIC_RATE_LAW_FOR_REVERSIBLE_COMPETITIVE_INHIBITION_BY_ONE_INHIBITOR: "SBO"
    """enzymatic rate law for reversible competitive inhibition by one inhibitor: This enzymatic rate law involves one substrate, one product and one modifier. The modifier acts as a competitive inhibitor with the substrate at the enzyme binding site; The modifier (inhibitor) reversibly bound to the enzyme blocks access to the substrate. The inhibitor has the effect of increasing the apparent Km."""
    ...
    ENZYMATIC_RATE_LAW_FOR_REVERSIBLE_EMPIRICAL_ALLOSTERIC_INHIBITION_BY_ONE_INHIBITOR: "SBO"
    """enzymatic rate law for reversible empirical allosteric inhibition by one inhibitor: Enzymatic rate law where the reversible binding of one ligand decreases the affinity for substrate at other active sites. The ligand does not bind the same site as the substrate on the enzyme. This is an empirical equation, where n represents the Hill coefficient."""

    SBO_0000454: "SBO"
    """enzymatic rate law for reversible substrate inhibition: Enzymatic rate law where the substrate for an enzyme also acts as a reversible inhibitor. This may entail a second (non-active) binding site for the enzyme. The inhibition constant is then the dissociation constant for the substrate from this second site."""

    ENZYMATIC_RATE_LAW_FOR_REVERSIBLE_SUBSTRATE_INHIBITION: "SBO"
    """enzymatic rate law for reversible substrate inhibition: Enzymatic rate law where the substrate for an enzyme also acts as a reversible inhibitor. This may entail a second (non-active) binding site for the enzyme. The inhibition constant is then the dissociation constant for the substrate from this second site."""

    SBO_0000455: "SBO"
    """enzymatic rate law for irreversible substrate inhibition: Enzymatic rate law where the substrate for an enzyme also acts as an irreversible inhibitor. This may entail a second (non-active) binding site for the enzyme. The inhibition constant is then the dissociation constant for the substrate from this second site."""

    ENZYMATIC_RATE_LAW_FOR_IRREVERSIBLE_SUBSTRATE_INHIBITION: "SBO"
    """enzymatic rate law for irreversible substrate inhibition: Enzymatic rate law where the substrate for an enzyme also acts as an irreversible inhibitor. This may entail a second (non-active) binding site for the enzyme. The inhibition constant is then the dissociation constant for the substrate from this second site."""

    SBO_0000456: "SBO"
    """enzymatic rate law for reversible unireactant enzyme with a single hyperbolic modulator: Enzymatic rate law where the modifier can act as an activator or inhibitor, depending upon the values of the kinetic constants. The modifier can bind reversibly to all forms of the enzyme and all enzyme-substrate complexes are reactive. 'a' represents the ratio of dissociation constant of the elementary step Enzyme-Substrate complex + Modifier = Enzyme-Substrate-Modifier complex over that of Enzyme + Modifier = Enzyme-Modifier complex. 'b' represents ratio of the rate constant of elementary step Enzyme-Substrate-Modifier complex -> Enzyme-Modifier complex + Product over that of Enzyme-Substrate complex -> Enzyme + Product."""

    ENZYMATIC_RATE_LAW_FOR_REVERSIBLE_UNIREACTANT_ENZYME_WITH_A_SINGLE_HYPERBOLIC_MODULATOR: "SBO"
    """enzymatic rate law for reversible unireactant enzyme with a single hyperbolic modulator: Enzymatic rate law where the modifier can act as an activator or inhibitor, depending upon the values of the kinetic constants. The modifier can bind reversibly to all forms of the enzyme and all enzyme-substrate complexes are reactive. 'a' represents the ratio of dissociation constant of the elementary step Enzyme-Substrate complex + Modifier = Enzyme-Substrate-Modifier complex over that of Enzyme + Modifier = Enzyme-Modifier complex. 'b' represents ratio of the rate constant of elementary step Enzyme-Substrate-Modifier complex -> Enzyme-Modifier complex + Product over that of Enzyme-Substrate complex -> Enzyme + Product."""

    SBO_0000457: "SBO"
    """enzymatic rate law for irreversible unireactant enzyme with a single hyperbolic modulator: Enzymatic rate law where the modifier can act as an activator or inhibitor, depending upon the values of the kinetic constants. The modifier can bind irreversibly to all forms of the enzyme and all enzyme-substrate complexes are reactive. 'a' represents the ratio of dissociation constant of the elementary step Enzyme-Substrate complex + Modifier = Enzyme-Substrate-Modifier complex) over that of Enzyme + Modifier = Enzyme-Modifier complex. 'b' represents ratio of the rate constant of elementary step Enzyme-Substrate-Modifier complex -> Enzyme-Modifier complex + Product over that of Enzyme-Substrate complex -> Enzyme + Product."""

    ENZYMATIC_RATE_LAW_FOR_IRREVERSIBLE_UNIREACTANT_ENZYME_WITH_A_SINGLE_HYPERBOLIC_MODULATOR: "SBO"
    """enzymatic rate law for irreversible unireactant enzyme with a single hyperbolic modulator: Enzymatic rate law where the modifier can act as an activator or inhibitor, depending upon the values of the kinetic constants. The modifier can bind irreversibly to all forms of the enzyme and all enzyme-substrate complexes are reactive. 'a' represents the ratio of dissociation constant of the elementary step Enzyme-Substrate complex + Modifier = Enzyme-Substrate-Modifier complex) over that of Enzyme + Modifier = Enzyme-Modifier complex. 'b' represents ratio of the rate constant of elementary step Enzyme-Substrate-Modifier complex -> Enzyme-Modifier complex + Product over that of Enzyme-Substrate complex -> Enzyme + Product."""

    SBO_0000458: "SBO"
    """enzymatic rate law for simple uncompetitive inhibition of reversible unireactant enzymes: Reversible inhibition of a unireactant enzyme by one inhibitor, which binds to the enzyme-substrate complex. The inhibitor is uncompetitive with the substrate."""

    ENZYMATIC_RATE_LAW_FOR_SIMPLE_UNCOMPETITIVE_INHIBITION_OF_REVERSIBLE_UNIREACTANT_ENZYMES: "SBO"
    """enzymatic rate law for simple uncompetitive inhibition of reversible unireactant enzymes: Reversible inhibition of a unireactant enzyme by one inhibitor, which binds to the enzyme-substrate complex. The inhibitor is uncompetitive with the substrate."""

    SBO_0000459: "SBO"
    """stimulator: Synonym: activator"""

    STIMULATOR: "SBO"
    """stimulator: Synonym: activator"""

    SBO_0000460: "SBO"
    """enzymatic catalyst: A substance that accelerates the velocity of a chemical reaction without itself being consumed or transformed, by lowering the free energy of the transition state. The substance acting as a catalyst is an enzyme."""

    ENZYMATIC_CATALYST: "SBO"
    """enzymatic catalyst: A substance that accelerates the velocity of a chemical reaction without itself being consumed or transformed, by lowering the free energy of the transition state. The substance acting as a catalyst is an enzyme."""

    SBO_0000461: "SBO"
    """essential activator: Synonym: necessary stimulator"""

    ESSENTIAL_ACTIVATOR: "SBO"
    """essential activator: Synonym: necessary stimulator"""

    SBO_0000462: "SBO"
    """non-essential activator: An activator which is not necessary for an enzymatic reaction, but whose presence will further increase enzymatic activity."""

    NON_ESSENTIAL_ACTIVATOR: "SBO"
    """non-essential activator: An activator which is not necessary for an enzymatic reaction, but whose presence will further increase enzymatic activity."""

    SBO_0000463: "SBO"
    """standard biochemical potential: Synonym: standard chemical potential"""

    STANDARD_BIOCHEMICAL_POTENTIAL: "SBO"
    """standard biochemical potential: Synonym: standard chemical potential"""

    SBO_0000464: "SBO"
    """state variable assignment: Assignment of a state or a value to a state variable, characteristic or property, of a biological entity."""

    STATE_VARIABLE_ASSIGNMENT: "SBO"
    """state variable assignment: Assignment of a state or a value to a state variable, characteristic or property, of a biological entity."""

    SBO_0000465: "SBO"
    """spatial measure: The measurable dimensions of an object which are minimally required to define the space that an object occupies."""

    SPATIAL_MEASURE: "SBO"
    """spatial measure: The measurable dimensions of an object which are minimally required to define the space that an object occupies."""

    SBO_0000466: "SBO"
    """length: The length of an object is the longest measurable distance between its extremities."""

    LENGTH: "SBO"
    """length: The length of an object is the longest measurable distance between its extremities."""

    SBO_0000467: "SBO"
    """area: The area of an object is a quantity expressing its two-dimensional size, usually part or all of its surface."""

    AREA: "SBO"
    """area: The area of an object is a quantity expressing its two-dimensional size, usually part or all of its surface."""

    SBO_0000468: "SBO"
    """volume: A quantity representing the three-dimensional space occupied by all or part of an object."""

    VOLUME: "SBO"
    """volume: A quantity representing the three-dimensional space occupied by all or part of an object."""

    SBO_0000469: "SBO"
    """containment: Synonym: inclusion"""

    CONTAINMENT: "SBO"
    """containment: Synonym: inclusion"""

    SBO_0000470: "SBO"
    """mass fraction: For a given substance, A, its mass fraction (x A) is defined as the ratio of its mass (m A) to the total mass (m total) in which it is present, where the sum of all mass fractions is equal to 1. This provides a means to express concentration in a dimensionless size."""

    MASS_FRACTION: "SBO"
    """mass fraction: For a given substance, A, its mass fraction (x A) is defined as the ratio of its mass (m A) to the total mass (m total) in which it is present, where the sum of all mass fractions is equal to 1. This provides a means to express concentration in a dimensionless size."""

    SBO_0000471: "SBO"
    """molal concentration of an entity: Molality denotes the number of moles of solute per kilogram of solvent (not solution). The term molal solution is used as a shorthand for a 'one molal solution', i.e. a solution which contains one mole of the solute per kilogram of the solvent. The SI unit for molality is mol/kg."""

    MOLAL_CONCENTRATION_OF_AN_ENTITY: "SBO"
    """molal concentration of an entity: Molality denotes the number of moles of solute per kilogram of solvent (not solution). The term molal solution is used as a shorthand for a 'one molal solution', i.e. a solution which contains one mole of the solute per kilogram of the solvent. The SI unit for molality is mol/kg."""

    SBO_0000472: "SBO"
    """molar concentration of an entity: Molarity, or molar concentration, denotes the number of moles of a given substance per litre of solution. The unit of measure of molarity is mol/L, molar, or the capital letter M as an abbreviated form."""

    MOLAR_CONCENTRATION_OF_AN_ENTITY: "SBO"
    """molar concentration of an entity: Molarity, or molar concentration, denotes the number of moles of a given substance per litre of solution. The unit of measure of molarity is mol/L, molar, or the capital letter M as an abbreviated form."""

    SBO_0000473: "SBO"
    """denotement: Term to signify where a material or conceptual entity is represented or denoted by a symbol or by some other abbreviated form."""

    DENOTEMENT: "SBO"
    """denotement: Term to signify where a material or conceptual entity is represented or denoted by a symbol or by some other abbreviated form."""

    SBO_0000474: "SBO"
    """convenience function: Mathematical function commonly used in biological modeling, which enable simplification of more complex expressions"""

    CONVENIENCE_FUNCTION: "SBO"
    """convenience function: Mathematical function commonly used in biological modeling, which enable simplification of more complex expressions"""

    SBO_0000475: "SBO"
    """periodic forcing function: Synonym: input signal step function"""

    PERIODIC_FORCING_FUNCTION: "SBO"
    """periodic forcing function: Synonym: input signal step function"""

    SBO_0000476: "SBO"
    """period: The period is the duration of one cycle in a repeating event. [wikipedia]"""

    PERIOD: "SBO"
    """period: The period is the duration of one cycle in a repeating event. [wikipedia]"""

    SBO_0000477: "SBO"
    """phase shift: Synonym: temporal offset"""

    PHASE_SHIFT: "SBO"
    """phase shift: Synonym: temporal offset"""

    SBO_0000478: "SBO"
    """powered product of Michaelis constant: The product of the Michaelis constants, to the power of their respective stoichiometric coefficients, for either substrates or products."""

    POWERED_PRODUCT_OF_MICHAELIS_CONSTANT: "SBO"
    """powered product of Michaelis constant: The product of the Michaelis constants, to the power of their respective stoichiometric coefficients, for either substrates or products."""

    SBO_0000479: "SBO"
    """powered product of substrate Michaelis constants: The product of the substrate Michaelis constants, to the power of their respective stoichiometric coefficients."""

    POWERED_PRODUCT_OF_SUBSTRATE_MICHAELIS_CONSTANTS: "SBO"
    """powered product of substrate Michaelis constants: The product of the substrate Michaelis constants, to the power of their respective stoichiometric coefficients."""

    SBO_0000480: "SBO"
    """powered product of product Michaelis constants: The product of the product Michaelis constants, to the power of their respective stoichiometric coefficients."""

    POWERED_PRODUCT_OF_PRODUCT_MICHAELIS_CONSTANTS: "SBO"
    """powered product of product Michaelis constants: The product of the product Michaelis constants, to the power of their respective stoichiometric coefficients."""

    SBO_0000481: "SBO"
    """stoichiometric coefficient: The stoichiometric coefficient represents the degree to which a chemical species participates in a reaction. It corresponds to the number of molecules of a reactant that are consumed or produced with each occurrence of a reaction event."""

    STOICHIOMETRIC_COEFFICIENT: "SBO"
    """stoichiometric coefficient: The stoichiometric coefficient represents the degree to which a chemical species participates in a reaction. It corresponds to the number of molecules of a reactant that are consumed or produced with each occurrence of a reaction event."""

    SBO_0000482: "SBO"
    """geometric mean rate constant: The geometric mean turnover rate of an enzyme in either forward or backward direction for a reaction, measured per second."""

    GEOMETRIC_MEAN_RATE_CONSTANT: "SBO"
    """geometric mean rate constant: The geometric mean turnover rate of an enzyme in either forward or backward direction for a reaction, measured per second."""

    SBO_0000483: "SBO"
    """forward geometric mean rate constant: The geometric mean turnover rate of an enzyme in the forward direction for a reaction, measured per second."""

    FORWARD_GEOMETRIC_MEAN_RATE_CONSTANT: "SBO"
    """forward geometric mean rate constant: The geometric mean turnover rate of an enzyme in the forward direction for a reaction, measured per second."""

    SBO_0000484: "SBO"
    """reverse geometric mean rate constant: The geometric mean turnover rate of an enzyme in the reverse direction for a reaction, measured per second."""

    REVERSE_GEOMETRIC_MEAN_RATE_CONSTANT: "SBO"
    """reverse geometric mean rate constant: The geometric mean turnover rate of an enzyme in the reverse direction for a reaction, measured per second."""

    SBO_0000485: "SBO"
    """basal rate constant: The minimal velocity observed under defined conditions, which may or may not include the presence of an effector. For example in an inhibitory system, this would be the residual velocity observed under full inhibition. In non-essential activation, this would be the velocity in the absence of any activator."""

    BASAL_RATE_CONSTANT: "SBO"
    """basal rate constant: The minimal velocity observed under defined conditions, which may or may not include the presence of an effector. For example in an inhibitory system, this would be the residual velocity observed under full inhibition. In non-essential activation, this would be the velocity in the absence of any activator."""

    SBO_0000486: "SBO"
    """relative basal rate constant: The ratio of the basal activity to the maximal velocity of a reaction. The values range between 0 and 1."""

    RELATIVE_BASAL_RATE_CONSTANT: "SBO"
    """relative basal rate constant: The ratio of the basal activity to the maximal velocity of a reaction. The values range between 0 and 1."""

    SBO_0000487: "SBO"
    """relative activity function: Function which ranges from 0 to 1, to describe the relative activation or inhibition of a reaction or process, actual or conceptual."""

    RELATIVE_ACTIVITY_FUNCTION: "SBO"
    """relative activity function: Function which ranges from 0 to 1, to describe the relative activation or inhibition of a reaction or process, actual or conceptual."""

    SBO_0000488: "SBO"
    """relative activation function: Function which ranges from 0 to 1, to describe the relative activation of a reaction or process, actual or conceptual."""

    RELATIVE_ACTIVATION_FUNCTION: "SBO"
    """relative activation function: Function which ranges from 0 to 1, to describe the relative activation of a reaction or process, actual or conceptual."""

    SBO_0000489: "SBO"
    """relative inhibition function: Function which ranges from 0 to 1, to describe the relative inhibition of a reaction or process, actual or conceptual."""

    RELATIVE_INHIBITION_FUNCTION: "SBO"
    """relative inhibition function: Function which ranges from 0 to 1, to describe the relative inhibition of a reaction or process, actual or conceptual."""

    SBO_0000490: "SBO"
    """number of products: Number of molecules which are generated by an enzyme."""

    NUMBER_OF_PRODUCTS: "SBO"
    """number of products: Number of molecules which are generated by an enzyme."""

    SBO_0000491: "SBO"
    """diffusion coefficient: Synonym: diffusivity"""

    DIFFUSION_COEFFICIENT: "SBO"
    """diffusion coefficient: Synonym: diffusivity"""

    SBO_0000492: "SBO"
    """amplitude: Amplitude is the magnitude of change in the oscillating variable, with each oscillation, within an oscillating system."""

    AMPLITUDE: "SBO"
    """amplitude: Amplitude is the magnitude of change in the oscillating variable, with each oscillation, within an oscillating system."""

    SBO_0000493: "SBO"
    """functional domain: A spatial region of an entity that confers a function"""

    FUNCTIONAL_DOMAIN: "SBO"
    """functional domain: A spatial region of an entity that confers a function"""

    SBO_0000494: "SBO"
    """binding site: A specific domain of a spatio-temporal entity to which another spatio-temporal entity is able to bind, forming chemical bonds."""

    BINDING_SITE: "SBO"
    """binding site: A specific domain of a spatio-temporal entity to which another spatio-temporal entity is able to bind, forming chemical bonds."""

    SBO_0000495: "SBO"
    """catalytic site: A catalytic site is the region which confers specificity of a substrate for the binding entity, and where specific reactions take place in the conversion of the substrate to the product."""

    CATALYTIC_SITE: "SBO"
    """catalytic site: A catalytic site is the region which confers specificity of a substrate for the binding entity, and where specific reactions take place in the conversion of the substrate to the product."""

    SBO_0000496: "SBO"
    """transmembrane domain: A transmembrane domain is any three-dimensional protein structure which is thermodynamically stable in a membrane. This may be a single alpha helix, a stable complex of several transmembrane alpha helices, a transmembrane beta barrel, a beta-helix of gramicidin A, or any other structure."""

    TRANSMEMBRANE_DOMAIN: "SBO"
    """transmembrane domain: A transmembrane domain is any three-dimensional protein structure which is thermodynamically stable in a membrane. This may be a single alpha helix, a stable complex of several transmembrane alpha helices, a transmembrane beta barrel, a beta-helix of gramicidin A, or any other structure."""

    SBO_0000497: "SBO"
    """ternary switch: A parameter that has three discrete values which may be alternated between."""

    TERNARY_SWITCH: "SBO"
    """ternary switch: A parameter that has three discrete values which may be alternated between."""

    SBO_0000498: "SBO"
    """relative activity: Value which ranges from 0 to 1, to describe the relative activity of a process or reaction."""

    RELATIVE_ACTIVITY: "SBO"
    """relative activity: Value which ranges from 0 to 1, to describe the relative activity of a process or reaction."""
    ...
    SBO_0000500: "SBO"
    """genetic suppression: Genetic suppression is said to have occurred when the phenotypic effect of an initial mutation in a gene is less severe, or entirely negated, by a subsequent mutation."""

    GENETIC_SUPPRESSION: "SBO"
    """genetic suppression: Genetic suppression is said to have occurred when the phenotypic effect of an initial mutation in a gene is less severe, or entirely negated, by a subsequent mutation."""

    SBO_0000501: "SBO"
    """genetic enhancement: Genetic enhancement is said to have occurred when the phenotypic effect of an initial mutation in a gene is made increasingly severe by a subsequent mutation."""

    GENETIC_ENHANCEMENT: "SBO"
    """genetic enhancement: Genetic enhancement is said to have occurred when the phenotypic effect of an initial mutation in a gene is made increasingly severe by a subsequent mutation."""

    SBO_0000502: "SBO"
    """synthetic lethality: Synthetic lethality is said to have occurred where gene mutations, each of which map to a separate locus, fail to complement in an offspring to correct a phenotype, as would be expected."""

    SYNTHETIC_LETHALITY: "SBO"
    """synthetic lethality: Synthetic lethality is said to have occurred where gene mutations, each of which map to a separate locus, fail to complement in an offspring to correct a phenotype, as would be expected."""

    SBO_0000503: "SBO"
    """number of entity pool constituents: The numerical quantification of an entity pool. This may be expressed as, for example, the number of molecules or the number of moles of identical entities of which an specific entity pool is comprised."""

    NUMBER_OF_ENTITY_POOL_CONSTITUENTS: "SBO"
    """number of entity pool constituents: The numerical quantification of an entity pool. This may be expressed as, for example, the number of molecules or the number of moles of identical entities of which an specific entity pool is comprised."""

    SBO_0000504: "SBO"
    """mass of an entity pool: The mass that comprises an entity pool."""

    MASS_OF_AN_ENTITY_POOL: "SBO"
    """mass of an entity pool: The mass that comprises an entity pool."""

    SBO_0000505: "SBO"
    """concentration of enzyme: Amount of enzyme present per unit of volume. The participant role 'enzymatic catalyst' is defined in SBO:0000460."""

    CONCENTRATION_OF_ENZYME: "SBO"
    """concentration of enzyme: Amount of enzyme present per unit of volume. The participant role 'enzymatic catalyst' is defined in SBO:0000460."""

    SBO_0000506: "SBO"
    """mass of enzyme: Amount, expressed as a mass, of an enzyme. The participant role 'enzymatic catalyst' is defined in SBO:0000460."""

    MASS_OF_ENZYME: "SBO"
    """mass of enzyme: Amount, expressed as a mass, of an enzyme. The participant role 'enzymatic catalyst' is defined in SBO:0000460."""

    SBO_0000507: "SBO"
    """number of an enzyme: Amount, expressed as a number, of a specific enzyme comprising an entity pool. This may be expressed, for example, as the number of molecules, or the number of moles. The participant role 'enzymatic catalyst' is defined in SBO:0000460."""

    NUMBER_OF_AN_ENZYME: "SBO"
    """number of an enzyme: Amount, expressed as a number, of a specific enzyme comprising an entity pool. This may be expressed, for example, as the number of molecules, or the number of moles. The participant role 'enzymatic catalyst' is defined in SBO:0000460."""

    SBO_0000508: "SBO"
    """number of a reactant: The amount, expressed as a number, of a specific reactant comprising an entity pool. This may be expressed, for example, as the number of molecules, or the number of moles. The participant role 'reactant' is defined in SBO:0000010."""

    NUMBER_OF_A_REACTANT: "SBO"
    """number of a reactant: The amount, expressed as a number, of a specific reactant comprising an entity pool. This may be expressed, for example, as the number of molecules, or the number of moles. The participant role 'reactant' is defined in SBO:0000010."""

    SBO_0000509: "SBO"
    """concentration of reactant: The amount of a specific entity pool reactant present per unit of volume. The participant role 'reactant' is defined in SBO:0000010."""

    CONCENTRATION_OF_REACTANT: "SBO"
    """concentration of reactant: The amount of a specific entity pool reactant present per unit of volume. The participant role 'reactant' is defined in SBO:0000010."""

    SBO_0000510: "SBO"
    """mass of reactant: The amount, expressed as a mass, of a specific reactant entity pool. The participant role 'reactant' is defined in SBO:0000010."""

    MASS_OF_REACTANT: "SBO"
    """mass of reactant: The amount, expressed as a mass, of a specific reactant entity pool. The participant role 'reactant' is defined in SBO:0000010."""

    SBO_0000511: "SBO"
    """number of a product: The amount, expressed as a number, of a specific product comprising an entity pool. This may be expressed, for example, as the number of molecules, or the number of moles. The participant role 'product' is defined in SBO:0000011."""

    NUMBER_OF_A_PRODUCT: "SBO"
    """number of a product: The amount, expressed as a number, of a specific product comprising an entity pool. This may be expressed, for example, as the number of molecules, or the number of moles. The participant role 'product' is defined in SBO:0000011."""

    SBO_0000512: "SBO"
    """concentration of product: The amount of a specific entity pool product present per unit of volume. The participant role 'product' is defined in SBO:0000011."""

    CONCENTRATION_OF_PRODUCT: "SBO"
    """concentration of product: The amount of a specific entity pool product present per unit of volume. The participant role 'product' is defined in SBO:0000011."""

    SBO_0000513: "SBO"
    """mass of product: The amount, expressed as a mass, of a specific product entity pool. The participant role 'product' is defined in SBO:0000011."""

    MASS_OF_PRODUCT: "SBO"
    """mass of product: The amount, expressed as a mass, of a specific product entity pool. The participant role 'product' is defined in SBO:0000011."""

    SBO_0000514: "SBO"
    """number of a substrate: The amount, expressed as a number, of a specific substrate comprising an entity pool. This may be expressed, for example, as the number of molecules, or the number of moles. The participant role 'substrate' is defined in SBO:0000015."""

    NUMBER_OF_A_SUBSTRATE: "SBO"
    """number of a substrate: The amount, expressed as a number, of a specific substrate comprising an entity pool. This may be expressed, for example, as the number of molecules, or the number of moles. The participant role 'substrate' is defined in SBO:0000015."""

    SBO_0000515: "SBO"
    """concentration of substrate: The amount of a specific entity pool substrate present per unit of volume. The participant role 'substrate' is defined in SBO:0000015."""

    CONCENTRATION_OF_SUBSTRATE: "SBO"
    """concentration of substrate: The amount of a specific entity pool substrate present per unit of volume. The participant role 'substrate' is defined in SBO:0000015."""

    SBO_0000516: "SBO"
    """mass of substrate: The amount, expressed as a mass, of a specific substrate entity pool. The participant role 'substrate' is defined in SBO:0000015."""

    MASS_OF_SUBSTRATE: "SBO"
    """mass of substrate: The amount, expressed as a mass, of a specific substrate entity pool. The participant role 'substrate' is defined in SBO:0000015."""

    SBO_0000517: "SBO"
    """number of a modifier: The amount, expressed as a number, of a specific modifier comprising an entity pool. This may be expressed, for example, as the number of molecules, or the number of moles. The participant role 'modifier' is defined in SBO:0000019."""

    NUMBER_OF_A_MODIFIER: "SBO"
    """number of a modifier: The amount, expressed as a number, of a specific modifier comprising an entity pool. This may be expressed, for example, as the number of molecules, or the number of moles. The participant role 'modifier' is defined in SBO:0000019."""

    SBO_0000518: "SBO"
    """concentration of modifier: The amount of a specific modifier entity pool present per unit of volume. The participant role 'modifier' is defined in SBO:0000019."""

    CONCENTRATION_OF_MODIFIER: "SBO"
    """concentration of modifier: The amount of a specific modifier entity pool present per unit of volume. The participant role 'modifier' is defined in SBO:0000019."""

    SBO_0000519: "SBO"
    """mass of modifier: The amount, expressed as a mass, of a specific modifier entity pool. The participant role 'modifier' is defined in SBO:0000019."""

    MASS_OF_MODIFIER: "SBO"
    """mass of modifier: The amount, expressed as a mass, of a specific modifier entity pool. The participant role 'modifier' is defined in SBO:0000019."""

    SBO_0000520: "SBO"
    """number of an inhibitor: The amount, expressed as a number, of a specific inhibitor comprising an entity pool. This may be expressed, for example, as the number of molecules, or the number of moles. The participant role 'inhibitor' is defined in SBO:0000020."""

    NUMBER_OF_AN_INHIBITOR: "SBO"
    """number of an inhibitor: The amount, expressed as a number, of a specific inhibitor comprising an entity pool. This may be expressed, for example, as the number of molecules, or the number of moles. The participant role 'inhibitor' is defined in SBO:0000020."""

    SBO_0000521: "SBO"
    """concentration of inhibitor: The amount of a specific inhibitor entity pool present per unit of volume. The participant role 'inhibitor' is defined in SBO:0000020."""

    CONCENTRATION_OF_INHIBITOR: "SBO"
    """concentration of inhibitor: The amount of a specific inhibitor entity pool present per unit of volume. The participant role 'inhibitor' is defined in SBO:0000020."""

    SBO_0000522: "SBO"
    """mass of inhibitor: The amount, expressed as a mass, of a specific inhibitor entity pool. The participant role 'inhibitor' is defined in SBO:0000020."""

    MASS_OF_INHIBITOR: "SBO"
    """mass of inhibitor: The amount, expressed as a mass, of a specific inhibitor entity pool. The participant role 'inhibitor' is defined in SBO:0000020."""

    SBO_0000523: "SBO"
    """number of an activator: The amount, expressed as a number, of a specific activator comprising an entity pool. This may be expressed, for example, as the number of molecules, or the number of moles. The participant role 'activator' is defined in SBO:0000459."""

    NUMBER_OF_AN_ACTIVATOR: "SBO"
    """number of an activator: The amount, expressed as a number, of a specific activator comprising an entity pool. This may be expressed, for example, as the number of molecules, or the number of moles. The participant role 'activator' is defined in SBO:0000459."""

    SBO_0000524: "SBO"
    """concentration of activator: The amount of a specific activator entity pool present per unit of volume. The participant role 'activator' is defined in SBO:0000459."""

    CONCENTRATION_OF_ACTIVATOR: "SBO"
    """concentration of activator: The amount of a specific activator entity pool present per unit of volume. The participant role 'activator' is defined in SBO:0000459."""

    SBO_0000525: "SBO"
    """mass of activator: The amount, expressed as a mass, of a specific activator entity pool. The participant role 'activator' is defined in SBO:0000459."""

    MASS_OF_ACTIVATOR: "SBO"
    """mass of activator: The amount, expressed as a mass, of a specific activator entity pool. The participant role 'activator' is defined in SBO:0000459."""

    SBO_0000526: "SBO"
    """protein complex formation: The process by which two or more proteins interact non-covalently to form a protein complex (SBO:0000297)."""

    PROTEIN_COMPLEX_FORMATION: "SBO"
    """protein complex formation: The process by which two or more proteins interact non-covalently to form a protein complex (SBO:0000297)."""

    SBO_0000527: "SBO"
    """modular rate law: Modular rate laws are a set of rate laws that provide a means to parameterise a system in a manner that is a compromise between mathematical abstraction and biochemical detail. They share the same common form: v = u f (T/(D + Dreg)) The individual numerator and denominator terms can substituted with alternative forms, depending on reaction details and model formulation, to generate specific modular rate laws. The terms represented are; v, reaction rate; u, enzyme amount; T, modular term derived from stoichiometries, metabolite concentrations and reactant constants; D, modular term for polynomial of scaled concentrations; Dreg, competitive regulation binding states term; f, modular term for regulation factor."""

    MODULAR_RATE_LAW: "SBO"
    """modular rate law: Modular rate laws are a set of rate laws that provide a means to parameterise a system in a manner that is a compromise between mathematical abstraction and biochemical detail. They share the same common form: v = u f (T/(D + Dreg)) The individual numerator and denominator terms can substituted with alternative forms, depending on reaction details and model formulation, to generate specific modular rate laws. The terms represented are; v, reaction rate; u, enzyme amount; T, modular term derived from stoichiometries, metabolite concentrations and reactant constants; D, modular term for polynomial of scaled concentrations; Dreg, competitive regulation binding states term; f, modular term for regulation factor."""

    SBO_0000528: "SBO"
    """common modular rate law: The common modular rate law is a generalised form of reversible Michaelis Menten kinetics, using a denominator where each binding state of the enzyme is represented. It is assumed that substrates and products bind independently and randomly, and that substrates and products cannot be bound at the same time."""

    COMMON_MODULAR_RATE_LAW: "SBO"
    """common modular rate law: The common modular rate law is a generalised form of reversible Michaelis Menten kinetics, using a denominator where each binding state of the enzyme is represented. It is assumed that substrates and products bind independently and randomly, and that substrates and products cannot be bound at the same time."""

    SBO_0000529: "SBO"
    """direct binding modular rate law: The direct binding modular rate law makes the assumption that both substrates and products bind simultaneously and in a single step, hence the total binding states possible enumerate to 3; nothing bound, substrates bound, and products bound. Substrates and products cannot be bound at the same time."""

    DIRECT_BINDING_MODULAR_RATE_LAW: "SBO"
    """direct binding modular rate law: The direct binding modular rate law makes the assumption that both substrates and products bind simultaneously and in a single step, hence the total binding states possible enumerate to 3; nothing bound, substrates bound, and products bound. Substrates and products cannot be bound at the same time."""

    SBO_0000530: "SBO"
    """simultaneous binding modular rate law: The simultaneous binding modular rate law makes the assumption that substrates and products can be bound simultaneously, and in any combination."""

    SIMULTANEOUS_BINDING_MODULAR_RATE_LAW: "SBO"
    """simultaneous binding modular rate law: The simultaneous binding modular rate law makes the assumption that substrates and products can be bound simultaneously, and in any combination."""

    SBO_0000531: "SBO"
    """power-law modular rate law: For the power-law rate law, the denominator is set to be a constant, and the rate law does not saturate."""

    POWER_LAW_MODULAR_RATE_LAW: "SBO"
    """power-law modular rate law: For the power-law rate law, the denominator is set to be a constant, and the rate law does not saturate."""

    SBO_0000532: "SBO"
    """force-dependent modular rate law: Modular rate law where the D term is given by the square root of the product of terms (c/KM)^m where c, KM, and m denote the concentrations, Michaelis constants, and molecularities, respectively, and the product is taken over all reactants and products involved in the reaction."""

    FORCE_DEPENDENT_MODULAR_RATE_LAW: "SBO"
    """force-dependent modular rate law: Modular rate law where the D term is given by the square root of the product of terms (c/KM)^m where c, KM, and m denote the concentrations, Michaelis constants, and molecularities, respectively, and the product is taken over all reactants and products involved in the reaction."""

    SBO_0000533: "SBO"
    """specific activator: An essential activator that affects the apparent value of the specificity constant. Mechanistically, the activator would need to be bound before reactant and product binding can take place."""

    SPECIFIC_ACTIVATOR: "SBO"
    """specific activator: An essential activator that affects the apparent value of the specificity constant. Mechanistically, the activator would need to be bound before reactant and product binding can take place."""

    SBO_0000534: "SBO"
    """catalytic activator: An essential activator that affects the apparent value of the catalytic constant."""

    CATALYTIC_ACTIVATOR: "SBO"
    """catalytic activator: An essential activator that affects the apparent value of the catalytic constant."""

    SBO_0000535: "SBO"
    """binding activator: An essential activator that affects the apparent value of the Michaelis constant(s)."""

    BINDING_ACTIVATOR: "SBO"
    """binding activator: An essential activator that affects the apparent value of the Michaelis constant(s)."""

    SBO_0000536: "SBO"
    """partial inhibitor: Substance that, when bound, decreases enzymatic activity to a lower, nonzero value, without itself being consumed or transformed by the reaction, and without sterically hindering the interaction between reactants. The enzyme-inhibitor complex does retain some basal level of activity."""

    PARTIAL_INHIBITOR: "SBO"
    """partial inhibitor: Substance that, when bound, decreases enzymatic activity to a lower, nonzero value, without itself being consumed or transformed by the reaction, and without sterically hindering the interaction between reactants. The enzyme-inhibitor complex does retain some basal level of activity."""

    SBO_0000537: "SBO"
    """complete inhibitor: Substance that, when bound, completely negates enzymatic activity, without itself being consumed or transformed by the reaction, and without sterically hindering the interaction between reactants. The inhibitor binds to all enzyme species independently and with the same affinity, completely inhibiting any enzymatic activity."""

    COMPLETE_INHIBITOR: "SBO"
    """complete inhibitor: Substance that, when bound, completely negates enzymatic activity, without itself being consumed or transformed by the reaction, and without sterically hindering the interaction between reactants. The inhibitor binds to all enzyme species independently and with the same affinity, completely inhibiting any enzymatic activity."""

    SBO_0000538: "SBO"
    """ionic permeability: Synonym: membrane permeability"""

    IONIC_PERMEABILITY: "SBO"
    """ionic permeability: Synonym: membrane permeability"""

    SBO_0000539: "SBO"
    """probabilistic parameter: A quantitative parameter that represents a probability value, assigned to a specific event."""

    PROBABILISTIC_PARAMETER: "SBO"
    """probabilistic parameter: A quantitative parameter that represents a probability value, assigned to a specific event."""

    SBO_0000540: "SBO"
    """fraction of an entity pool: A ratio that represents the quantity of a defined constituent entity over the total number of all constituent entities present."""

    FRACTION_OF_AN_ENTITY_POOL: "SBO"
    """fraction of an entity pool: A ratio that represents the quantity of a defined constituent entity over the total number of all constituent entities present."""

    SBO_0000541: "SBO"
    """mole fraction: The number of moles of a constituent entity, divided by the total number of all constituent entities present in a system."""

    MOLE_FRACTION: "SBO"
    """mole fraction: The number of moles of a constituent entity, divided by the total number of all constituent entities present in a system."""

    SBO_0000542: "SBO"
    """basic reproductive ratio: Synonym: R0"""

    BASIC_REPRODUCTIVE_RATIO: "SBO"
    """basic reproductive ratio: Synonym: R0"""

    SBO_0000543: "SBO"
    """protein aggregate: A nonspecific coalescence of misfolded proteins which may or may not form a precipitate, depending upon particle size."""

    PROTEIN_AGGREGATE: "SBO"
    """protein aggregate: A nonspecific coalescence of misfolded proteins which may or may not form a precipitate, depending upon particle size."""

    SBO_0000544: "SBO"
    """metadata representation: Supplementary information relating to a primary item of data, traditionally termed 'data about data'. It can describe, for example, the location or type of the data, or its relationship to other data."""

    METADATA_REPRESENTATION: "SBO"
    """metadata representation: Supplementary information relating to a primary item of data, traditionally termed 'data about data'. It can describe, for example, the location or type of the data, or its relationship to other data."""

    SBO_0000545: "SBO"
    """systems description parameter: A value, numerical or symbolic, that defines certain characteristics of systems or system functions, or is necessary in their derivation."""

    SYSTEMS_DESCRIPTION_PARAMETER: "SBO"
    """systems description parameter: A value, numerical or symbolic, that defines certain characteristics of systems or system functions, or is necessary in their derivation."""

    SBO_0000546: "SBO"
    """qualitative systems description parameter: A non-numerical value that defines certain characteristics of systems or system functions."""

    QUALITATIVE_SYSTEMS_DESCRIPTION_PARAMETER: "SBO"
    """qualitative systems description parameter: A non-numerical value that defines certain characteristics of systems or system functions."""

    SBO_0000547: "SBO"
    """boolean logical framework: Equationally defined algebraic framework usually interpreted as a two-valued logic using the basic Boolean operations (conjunction, disjunction and negation), together with the constants '0' and '1' denoting false and true values, respectively."""

    BOOLEAN_LOGICAL_FRAMEWORK: "SBO"
    """boolean logical framework: Equationally defined algebraic framework usually interpreted as a two-valued logic using the basic Boolean operations (conjunction, disjunction and negation), together with the constants '0' and '1' denoting false and true values, respectively."""

    SBO_0000548: "SBO"
    """multi-valued logical framework: Extension of the boolean logical framework which associates a defined number of possible integer values (states) with the variables."""

    MULTI_VALUED_LOGICAL_FRAMEWORK: "SBO"
    """multi-valued logical framework: Extension of the boolean logical framework which associates a defined number of possible integer values (states) with the variables."""

    SBO_0000549: "SBO"
    """fuzzy logical framework: Extension of the Boolean logical framework which allows intermediate or undetermined values for the logical variables."""

    FUZZY_LOGICAL_FRAMEWORK: "SBO"
    """fuzzy logical framework: Extension of the Boolean logical framework which allows intermediate or undetermined values for the logical variables."""

    SBO_0000550: "SBO"
    """annotation: Supplementary information that does not modify the semantics of the presented information."""

    ANNOTATION: "SBO"
    """annotation: Supplementary information that does not modify the semantics of the presented information."""

    SBO_0000551: "SBO"
    """controlled short label: The use of an abbreviated name, taken from a controlled vocabulary of terms, which is used to represent some information about the entity to which it is attached."""

    CONTROLLED_SHORT_LABEL: "SBO"
    """controlled short label: The use of an abbreviated name, taken from a controlled vocabulary of terms, which is used to represent some information about the entity to which it is attached."""

    SBO_0000552: "SBO"
    """reference annotation: Additional information that supplements existing data, usually in a document, by providing a link to more detailed information, which is held externally, or elsewhere."""

    REFERENCE_ANNOTATION: "SBO"
    """reference annotation: Additional information that supplements existing data, usually in a document, by providing a link to more detailed information, which is held externally, or elsewhere."""

    SBO_0000553: "SBO"
    """bibliographical reference: An annotation which directs one to information contained within a published body of knowledge, usually a book or scientific journal."""

    BIBLIOGRAPHICAL_REFERENCE: "SBO"
    """bibliographical reference: An annotation which directs one to information contained within a published body of knowledge, usually a book or scientific journal."""

    SBO_0000554: "SBO"
    """database cross reference: Synonym: db xref"""

    DATABASE_CROSS_REFERENCE: "SBO"
    """database cross reference: Synonym: db xref"""

    SBO_0000555: "SBO"
    """controlled annotation: Annotation which complies with the full set of defined rules in its construction."""

    CONTROLLED_ANNOTATION: "SBO"
    """controlled annotation: Annotation which complies with the full set of defined rules in its construction."""

    SBO_0000556: "SBO"
    """uncontrolled annotation: Annotation which does not comply with, or is not restricted by, any rules in its construction. Examples would include free text annotations."""

    UNCONTROLLED_ANNOTATION: "SBO"
    """uncontrolled annotation: Annotation which does not comply with, or is not restricted by, any rules in its construction. Examples would include free text annotations."""

    SBO_0000557: "SBO"
    """embedded annotation: Annotation that directly incorporates information into the body of a document."""

    EMBEDDED_ANNOTATION: "SBO"
    """embedded annotation: Annotation that directly incorporates information into the body of a document."""

    SBO_0000558: "SBO"
    """specific activity: A measure of enzyme activity under standard conditions, at a specific substrate concentration (usually saturation), expressed as the amount of product formed per unit time, per amount of enzyme. This is often expressed as micromol per min per mg, rather than the less practical official unit, Katal (1 mol per second)."""

    SPECIFIC_ACTIVITY: "SBO"
    """specific activity: A measure of enzyme activity under standard conditions, at a specific substrate concentration (usually saturation), expressed as the amount of product formed per unit time, per amount of enzyme. This is often expressed as micromol per min per mg, rather than the less practical official unit, Katal (1 mol per second)."""

    SBO_0000559: "SBO"
    """enzyme activity: A measure of the amount of active enzyme present, expressed under specified conditions. This is often expressed as micromol per min (also known as enzyme unit, U), rather than the less practical official SI unit, Katal (1 mol per second). Enzyme activity normally refers to the natural substrate for the enzyme, but can also be given for standardised substrates such as gelatin, where it is then referred to as GDU (Gelatin Digesting Units)."""
    ...
    MASS_ACTION_RATE_LAW_FOR_FIRST_ORDER_IRREVERSIBLE_REACTIONS__SINGLE_ESSENTIAL_STIMULATOR__CONTINUOUS_SCHEME: "SBO"
    """mass action rate law for first order irreversible reactions, single essential stimulator, continuous scheme: Reaction scheme in which the reaction velocity is direct proportional to the activity or concentration of a single molecular species. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of the stimulator. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_RATE_LAW_FOR_FIRST_ORDER_IRREVERSIBLE_REACTIONS__SINGLE_ESSENTIAL_STIMULATOR__DISCRETE_SCHEME: "SBO"
    """mass action rate law for first order irreversible reactions, single essential stimulator, discrete scheme: Reaction scheme in which the reaction velocity is direct proportional to the activity or quantity of a single molecular species. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of the stimulator. It is to be used in a reaction modelled using a discrete framework."""
    ...
    MASS_ACTION_LIKE_RATE_LAW_FOR_SECOND_ORDER_IRREVERSIBLE_REACTIONS__ONE_REACTANT__ONE_ESSENTIAL_STIMULATOR: "SBO"
    """mass action like rate law for second order irreversible reactions, one reactant, one essential stimulator: Reaction scheme where the products are created from a reactant and the change of a product quantity is proportional to the product of the reactant and the stimulator activities. The reaction scheme does not include any reverse process that creates the reactant from the products. The change of a product quantity is proportional to the quantity of the reactant and the stimulator."""
    ...
    MASS_ACTION_LIKE_RATE_LAW_FOR_SECOND_ORDER_IRREVERSIBLE_REACTIONS__ONE_REACTANT__ONE_ESSENTIAL_STIMULATOR__CONTINUOUS_SCHEME: "SBO"
    """mass action like rate law for second order irreversible reactions, one reactant, one essential stimulator, continuous scheme: Reaction scheme where the products are created from a reactant and the change of a product quantity is proportional to the product of the reactant and the stimulator activities. The reaction scheme does not include any reverse process that creates the reactant from the products. The change of a product quantity is proportional to the quantity of the reactant and the stimulator. It is to be used in a reaction modelled using a continuous framework."""
    ...
    MASS_ACTION_LIKE_RATE_LAW_FOR_SECOND_ORDER_IRREVERSIBLE_REACTIONS__ONE_REACTANT__ONE_ESSENTIAL_STIMULATOR__DISCRETE_SCHEME: "SBO"
    """mass action like rate law for second order irreversible reactions, one reactant, one essential stimulator, discrete scheme: Reaction scheme where the products are created from a reactant and the change of a product quantity is proportional to the product of the reactant and the stimulator quantities. The reaction scheme does not include any reverse process that creates the reactant from the products. The change of a product quantity is proportional to the quantity of the reactant and the stimulator. It is to be used in a reaction modelled using a discrete framework."""

    SBO_0000565: "SBO"
    """systems description constant: A physical constant that is required in the calculation of a system parameter."""

    SYSTEMS_DESCRIPTION_CONSTANT: "SBO"
    """systems description constant: A physical constant that is required in the calculation of a system parameter."""

    SBO_0000566: "SBO"
    """relative permeability: The permeability of an ion through a channel or membrane expressed in relation to the reference ion, which is given the value 1. For example, if a membrane is most permeable to K+, then that is assigned the reference permeability value of 1, and the value for Na+ may be 0.05."""

    RELATIVE_PERMEABILITY: "SBO"
    """relative permeability: The permeability of an ion through a channel or membrane expressed in relation to the reference ion, which is given the value 1. For example, if a membrane is most permeable to K+, then that is assigned the reference permeability value of 1, and the value for Na+ may be 0.05."""

    SBO_0000567: "SBO"
    """universal gas constant: Synonym: molar gas constant"""

    UNIVERSAL_GAS_CONSTANT: "SBO"
    """universal gas constant: Synonym: molar gas constant"""

    SBO_0000568: "SBO"
    """Faraday constant: Named after Michael Faraday, it is the magnitude of electric charge per mole of electrons. It has the value 96,485.3365 C/mol (Coulombs per Mole), and the symbol F."""

    FARADAY_CONSTANT: "SBO"
    """Faraday constant: Named after Michael Faraday, it is the magnitude of electric charge per mole of electrons. It has the value 96,485.3365 C/mol (Coulombs per Mole), and the symbol F."""

    SBO_0000569: "SBO"
    """Goldman equation: Synonym: Goldman-Hodgkin-Katz voltage equation"""

    GOLDMAN_EQUATION: "SBO"
    """Goldman equation: Synonym: Goldman-Hodgkin-Katz voltage equation"""

    SBO_0000570: "SBO"
    """Nernst potential: Synonym: reversal potential"""

    NERNST_POTENTIAL: "SBO"
    """Nernst potential: Synonym: reversal potential"""

    SBO_0000571: "SBO"
    """thermodynamic parameter: Parameters used in the study of thermodynamics, a physical science that pertains to the relationship between heat and other forms of energy such as 'work done' in material bodies."""

    THERMODYNAMIC_PARAMETER: "SBO"
    """thermodynamic parameter: Parameters used in the study of thermodynamics, a physical science that pertains to the relationship between heat and other forms of energy such as 'work done' in material bodies."""

    SBO_0000572: "SBO"
    """enthalpy: A thermodynamic potential whose natural variables are entropy (S) and pressure (p). The enthalpy of a system, measured in Joules (J), is defined as H = U + pV (where H is enthalpy, U is the internal energy, p is the pressure at the system boundary, and V is the system volume). symbol: H"""
    ...
    SBO_0000574: "SBO"
    """standard enthalpy of formation: The enthalpy change observed in a constituent of a thermodynamic system when one mole of a compound, in its standard state, is formed from its elementary antecedents, in their standard state(s), under standard conditions (1 bar). The standard unit of measure is kJ/mol. Symbol: DeltaHf0, DeltafH0"""

    STANDARD_ENTHALPY_OF_FORMATION: "SBO"
    """standard enthalpy of formation: The enthalpy change observed in a constituent of a thermodynamic system when one mole of a compound, in its standard state, is formed from its elementary antecedents, in their standard state(s), under standard conditions (1 bar). The standard unit of measure is kJ/mol. Symbol: DeltaHf0, DeltafH0"""

    SBO_0000575: "SBO"
    """standard enthalpy of reaction: The enthalpy change observed in a constituent of a thermodynamic system when one mole of substance reacts completely, under standard conditions (1 bar). The standard unit of measure is kJ/mol. Symbol: DeltaHr0, DeltarH0"""

    STANDARD_ENTHALPY_OF_REACTION: "SBO"
    """standard enthalpy of reaction: The enthalpy change observed in a constituent of a thermodynamic system when one mole of substance reacts completely, under standard conditions (1 bar). The standard unit of measure is kJ/mol. Symbol: DeltaHr0, DeltarH0"""

    SBO_0000576: "SBO"
    """entropy: A thermodynamic property which acts as a measure of the state of disorder of a system. Its natural variables are the internal energy (U) and the volume (V). It is defined by dS = (1/T)dU + (p/T)dV. The second law of thermodynamics states that in an isolated system, natural processes tend to increase in disorder or entropy. The standard unit of measure is Joules per Kelvin (J/K). symbol: S"""

    ENTROPY: "SBO"
    """entropy: A thermodynamic property which acts as a measure of the state of disorder of a system. Its natural variables are the internal energy (U) and the volume (V). It is defined by dS = (1/T)dU + (p/T)dV. The second law of thermodynamics states that in an isolated system, natural processes tend to increase in disorder or entropy. The standard unit of measure is Joules per Kelvin (J/K). symbol: S"""

    SBO_0000577: "SBO"
    """entropy change: The increase or decrease of the entropy of a system. For values greater than zero, there is an implied increase in the disorder of a system, for example during a reaction, and decreased disorder where the values are less than zero. The entropy change of a process is defined as the initial system entropy value minus the final entropy value: DeltaS = Sf - Si. The standard unit of measure is J/K. symbol: DeltaS"""

    ENTROPY_CHANGE: "SBO"
    """entropy change: The increase or decrease of the entropy of a system. For values greater than zero, there is an implied increase in the disorder of a system, for example during a reaction, and decreased disorder where the values are less than zero. The entropy change of a process is defined as the initial system entropy value minus the final entropy value: DeltaS = Sf - Si. The standard unit of measure is J/K. symbol: DeltaS"""

    SBO_0000578: "SBO"
    """standard entropy of reaction : The entropy change observed in a thermodynamic system when one mole of substance reacts completely, under standard conditions (1 bar). The standard unit of measure is kJ/(mol K). This can be calculated using the entropies for products and reactants: DeltaS(reaction)=sum DeltaS (products) - sum DeltaS reactants. The standard unit of measure is kJ/(mol K). symbol: DeltaSro"""

    STANDARD_ENTROPY_OF_REACTION_: "SBO"
    """standard entropy of reaction : The entropy change observed in a thermodynamic system when one mole of substance reacts completely, under standard conditions (1 bar). The standard unit of measure is kJ/(mol K). This can be calculated using the entropies for products and reactants: DeltaS(reaction)=sum DeltaS (products) - sum DeltaS reactants. The standard unit of measure is kJ/(mol K). symbol: DeltaSro"""

    SBO_0000579: "SBO"
    """standard entropy of formation: The change in entropy associated with the formation of one mole of a substance from its elements in their standard states under standard conditions (1 bar). The standard unit of measure is kJ/(mol K). symbol: DeltaSfo"""

    STANDARD_ENTROPY_OF_FORMATION: "SBO"
    """standard entropy of formation: The change in entropy associated with the formation of one mole of a substance from its elements in their standard states under standard conditions (1 bar). The standard unit of measure is kJ/(mol K). symbol: DeltaSfo"""

    SBO_0000580: "SBO"
    """Gibbs free energy: Synonym: Gibbs function"""

    GIBBS_FREE_ENERGY: "SBO"
    """Gibbs free energy: Synonym: Gibbs function"""

    SBO_0000581: "SBO"
    """Gibbs free energy change: The increase or decrease of the Gibbs free energy of a system. During a reaction, this is equal to the change in enthalpy of the system minus the change in the product of the temperature times the entropy of the system: ΔG = ΔH - T ΔS. A negative value indicates that the reaction will be favoured and will release energy. The magnitude of the value indicates how far the reaction is from equilibrium, where there will be no free energy change. The standard unit of measure is kJ/mol. Symbol: ΔG."""

    GIBBS_FREE_ENERGY_CHANGE: "SBO"
    """Gibbs free energy change: The increase or decrease of the Gibbs free energy of a system. During a reaction, this is equal to the change in enthalpy of the system minus the change in the product of the temperature times the entropy of the system: ΔG = ΔH - T ΔS. A negative value indicates that the reaction will be favoured and will release energy. The magnitude of the value indicates how far the reaction is from equilibrium, where there will be no free energy change. The standard unit of measure is kJ/mol. Symbol: ΔG."""

    SBO_0000582: "SBO"
    """standard Gibbs free energy of formation: The change in Gibbs free energy associated with the formation of 1 mole of substance from elements in their standard states under standard conditions (1 bar). For aqueous solutions, each solute must be present in 1M concentration. The standard unit of measure is kJ/mol. Symbol: ΔGf°."""

    STANDARD_GIBBS_FREE_ENERGY_OF_FORMATION: "SBO"
    """standard Gibbs free energy of formation: The change in Gibbs free energy associated with the formation of 1 mole of substance from elements in their standard states under standard conditions (1 bar). For aqueous solutions, each solute must be present in 1M concentration. The standard unit of measure is kJ/mol. Symbol: ΔGf°."""

    SBO_0000583: "SBO"
    """standard Gibbs free energy of reaction: The Gibbs free energy change observed in a thermodynamic system when one mole of substance reacts completely, under standard conditions (1 bar). For aqueous solutions, each solute must be present in 1M concentration. The standard unit of measure is kJ/mol. Symbol: ΔG°."""

    STANDARD_GIBBS_FREE_ENERGY_OF_REACTION: "SBO"
    """standard Gibbs free energy of reaction: The Gibbs free energy change observed in a thermodynamic system when one mole of substance reacts completely, under standard conditions (1 bar). For aqueous solutions, each solute must be present in 1M concentration. The standard unit of measure is kJ/mol. Symbol: ΔG°."""

    SBO_0000584: "SBO"
    """temporal offset: A duration of time after which a phase shift occurs."""

    TEMPORAL_OFFSET: "SBO"
    """temporal offset: A duration of time after which a phase shift occurs."""

    SBO_0000585: "SBO"
    """simulation duration: The total length of time over which a model is simulated, where the time scale is indicated within the model simulation."""

    SIMULATION_DURATION: "SBO"
    """simulation duration: The total length of time over which a model is simulated, where the time scale is indicated within the model simulation."""

    SBO_0000586: "SBO"
    """model time: A conceptualisation of time which is intrinsic to a mathematical model, and which can be used to describe other variables or parameters of the model."""

    MODEL_TIME: "SBO"
    """model time: A conceptualisation of time which is intrinsic to a mathematical model, and which can be used to describe other variables or parameters of the model."""

    SBO_0000587: "SBO"
    """transcellular membrane influx reaction: A transport reaction which results in the entry of the transported entity, into the cell."""

    TRANSCELLULAR_MEMBRANE_INFLUX_REACTION: "SBO"
    """transcellular membrane influx reaction: A transport reaction which results in the entry of the transported entity, into the cell."""

    SBO_0000588: "SBO"
    """transcellular membrane efflux reaction: A transport reaction which results in the removal of the transported entity from the cell."""

    TRANSCELLULAR_MEMBRANE_EFFLUX_REACTION: "SBO"
    """transcellular membrane efflux reaction: A transport reaction which results in the removal of the transported entity from the cell."""

    SBO_0000589: "SBO"
    """genetic production: A composite biochemical process through which a gene sequence is fully converted into mature gene products. These gene products may include RNA species as well as proteins, and the process encompasses all intermediate steps required to generate the active form of the gene product."""

    GENETIC_PRODUCTION: "SBO"
    """genetic production: A composite biochemical process through which a gene sequence is fully converted into mature gene products. These gene products may include RNA species as well as proteins, and the process encompasses all intermediate steps required to generate the active form of the gene product."""

    SBO_0000590: "SBO"
    """promoter: A stretch of DNA upstream of a transcription start site, to which a promoter and other transcription factors may bind to initiate or regulate expression."""

    PROMOTER: "SBO"
    """promoter: A stretch of DNA upstream of a transcription start site, to which a promoter and other transcription factors may bind to initiate or regulate expression."""

    SBO_0000591: "SBO"
    """petri net transition: A process that can modify the state of petri net 'places'[SBO:0000593]."""

    PETRI_NET_TRANSITION: "SBO"
    """petri net transition: A process that can modify the state of petri net 'places'[SBO:0000593]."""

    SBO_0000592: "SBO"
    """discrete amount of an entity pool: A discrete value attributed to an entity pool."""

    DISCRETE_AMOUNT_OF_AN_ENTITY_POOL: "SBO"
    """discrete amount of an entity pool: A discrete value attributed to an entity pool."""

    SBO_0000593: "SBO"
    """petri net place: A defined entity pool state which can be modified by a petri net transition [SBO:0000591]."""

    PETRI_NET_PLACE: "SBO"
    """petri net place: A defined entity pool state which can be modified by a petri net transition [SBO:0000591]."""

    SBO_0000594: "SBO"
    """neutral participant: A participant whose presence does not alter the velocity of a process or event."""

    NEUTRAL_PARTICIPANT: "SBO"
    """neutral participant: A participant whose presence does not alter the velocity of a process or event."""

    SBO_0000595: "SBO"
    """dual-activity modifier: A modifier that can exhibit either inhibitory or stimulatory effects on a process depending on the context in which it occurs. For example, the observed effect may be dependent upon the concentration of the modifier."""

    DUAL_ACTIVITY_MODIFIER: "SBO"
    """dual-activity modifier: A modifier that can exhibit either inhibitory or stimulatory effects on a process depending on the context in which it occurs. For example, the observed effect may be dependent upon the concentration of the modifier."""

    SBO_0000596: "SBO"
    """modifier of unknown activity: A modifier whose activity is not known or has not been specified."""

    MODIFIER_OF_UNKNOWN_ACTIVITY: "SBO"
    """modifier of unknown activity: A modifier whose activity is not known or has not been specified."""

    SBO_0000597: "SBO"
    """silencer: A silencer is a modifier which acts in a manner that completely prevents an event or process from occurring. For example, a silencer in gene expression is usually a transcription factor that binds a DNA sequence in such a way as to completely prevent the binding of RNA polymerase, and thus fully suppresses transcription."""

    SILENCER: "SBO"
    """silencer: A silencer is a modifier which acts in a manner that completely prevents an event or process from occurring. For example, a silencer in gene expression is usually a transcription factor that binds a DNA sequence in such a way as to completely prevent the binding of RNA polymerase, and thus fully suppresses transcription."""

    SBO_0000598: "SBO"
    """promoter: A region of DNA to which various transcription factors and RNA polymerase must bind in order to initiate transcription for a gene."""

    SBO_0000599: "SBO"
    """port: A denotement that specifies a point of contact between variables or submodels in a hierarchical model."""

    PORT: "SBO"
    """port: A denotement that specifies a point of contact between variables or submodels in a hierarchical model."""

    SBO_0000600: "SBO"
    """input port: A connection point to an element in a model that indicates that the element's mathematical interpretation is defined outside the model."""

    INPUT_PORT: "SBO"
    """input port: A connection point to an element in a model that indicates that the element's mathematical interpretation is defined outside the model."""

    SBO_0000601: "SBO"
    """output port: A connection point to an element in a model that indicates that the element's mathematical interpretation is defined within the model."""

    OUTPUT_PORT: "SBO"
    """output port: A connection point to an element in a model that indicates that the element's mathematical interpretation is defined within the model."""

    SBO_0000602: "SBO"
    """logical parameter: A parameter that takes only logical values."""

    LOGICAL_PARAMETER: "SBO"
    """logical parameter: A parameter that takes only logical values."""

    SBO_0000603: "SBO"
    """side product: A substance that is produced in a chemical reaction but is not itself the primary product or focus of that reaction. Examples include, but are not limited to, currency compounds such as ATP, NADPH and protons."""

    SIDE_PRODUCT: "SBO"
    """side product: A substance that is produced in a chemical reaction but is not itself the primary product or focus of that reaction. Examples include, but are not limited to, currency compounds such as ATP, NADPH and protons."""

    SBO_0000604: "SBO"
    """side substrate: A substance that is consumed in a chemical reaction but is not itself the primary substrate or focus of that reaction. Examples include, but are not limited to, currency compounds such as ATP, NADPH and protons."""

    SIDE_SUBSTRATE: "SBO"
    """side substrate: A substance that is consumed in a chemical reaction but is not itself the primary substrate or focus of that reaction. Examples include, but are not limited to, currency compounds such as ATP, NADPH and protons."""

    SBO_0000605: "SBO"
    """high affinity receptor: A receptor where binding occurs through strong intermolecular forces such as Van der Waals, hydrogen bonds or ionic bonds."""

    HIGH_AFFINITY_RECEPTOR: "SBO"
    """high affinity receptor: A receptor where binding occurs through strong intermolecular forces such as Van der Waals, hydrogen bonds or ionic bonds."""

    SBO_0000606: "SBO"
    """low affinity receptor: A receptor where binding occurs through weak intermolecular forces."""

    LOW_AFFINITY_RECEPTOR: "SBO"
    """low affinity receptor: A receptor where binding occurs through weak intermolecular forces."""

    SBO_0000607: "SBO"
    """dimer: A macromolecular complex composed of two monomeric units, which may or may not be identical. Monomers are usually non-covalently bound."""

    DIMER: "SBO"
    """dimer: A macromolecular complex composed of two monomeric units, which may or may not be identical. Monomers are usually non-covalently bound."""

    SBO_0000608: "SBO"
    """homodimer: A macromolecular complex composed of precisely two identical monomeric units, which are usually non-covalently bound."""

    HOMODIMER: "SBO"
    """homodimer: A macromolecular complex composed of precisely two identical monomeric units, which are usually non-covalently bound."""

    SBO_0000609: "SBO"
    """heterodimer: A macromolecular complex composed of precisely two non-identical monomeric units, which are usually non-covalently bound."""

    HETERODIMER: "SBO"
    """heterodimer: A macromolecular complex composed of precisely two non-identical monomeric units, which are usually non-covalently bound."""

    SBO_0000610: "SBO"
    """growth rate: A measure of the rate of growth of an organism, usually in culture. This can be expressed as increase in cell number or, more usually as an increase in dry weight of cells (grams), measured over a unit time period. Usually expressed as hour -1."""

    GROWTH_RATE: "SBO"
    """growth rate: A measure of the rate of growth of an organism, usually in culture. This can be expressed as increase in cell number or, more usually as an increase in dry weight of cells (grams), measured over a unit time period. Usually expressed as hour -1."""

    SBO_0000611: "SBO"
    """effective catalytic rate: Under nutrient limited conditions, it may be assumed that enzymes are operating below their maximal capacity (Kcat). Keff represents the lumped turnover rate of a reaction, expressed in units per time."""

    EFFECTIVE_CATALYTIC_RATE: "SBO"
    """effective catalytic rate: Under nutrient limited conditions, it may be assumed that enzymes are operating below their maximal capacity (Kcat). Keff represents the lumped turnover rate of a reaction, expressed in units per time."""

    SBO_0000612: "SBO"
    """rate of reaction: The velocity at which a reaction occurs. This may be calculated through the accumulation of a product or consumption of a reactant, and expressed using entity concentrations or amounts per time interval. The rate of reaction may be influenced by temperature, pressure and other factors. Rate of reaction is often referred to as reaction rate or metabolic flux."""

    RATE_OF_REACTION: "SBO"
    """rate of reaction: The velocity at which a reaction occurs. This may be calculated through the accumulation of a product or consumption of a reactant, and expressed using entity concentrations or amounts per time interval. The rate of reaction may be influenced by temperature, pressure and other factors. Rate of reaction is often referred to as reaction rate or metabolic flux."""

    SBO_0000613: "SBO"
    """reaction parameter: Parameters that pertain to chemical reactions."""

    REACTION_PARAMETER: "SBO"
    """reaction parameter: Parameters that pertain to chemical reactions."""

    SBO_0000614: "SBO"
    """rate of reaction (concentration): Rate of reaction expressed as a change in concentration over time."""

    RATE_OF_REACTION__CONCENTRATION_: "SBO"
    """rate of reaction (concentration): Rate of reaction expressed as a change in concentration over time."""

    SBO_0000615: "SBO"
    """rate of reaction (amount): Rate of reaction expressed as a change in enumerated quantity over time."""

    RATE_OF_REACTION__AMOUNT_: "SBO"
    """rate of reaction (amount): Rate of reaction expressed as a change in enumerated quantity over time."""

    SBO_0000616: "SBO"
    """extent of reaction: The extent of a reaction is a measure of how far a reaction has proceeded towards equilibrium. It is denoted by the Greek letter Î¾ and is expressed in moles."""

    EXTENT_OF_REACTION: "SBO"
    """extent of reaction: The extent of a reaction is a measure of how far a reaction has proceeded towards equilibrium. It is denoted by the Greek letter Î¾ and is expressed in moles."""

    SBO_0000617: "SBO"
    """Gibbs free energy of reaction: The Gibbs free energy change observed in a thermodynamic system when a substance undergoes a reaction under non standard conditions. The unit of measure is kJ/mol. Symbol: ΔG."""

    GIBBS_FREE_ENERGY_OF_REACTION: "SBO"
    """Gibbs free energy of reaction: The Gibbs free energy change observed in a thermodynamic system when a substance undergoes a reaction under non standard conditions. The unit of measure is kJ/mol. Symbol: ΔG."""

    SBO_0000618: "SBO"
    """reaction affinity: Synonym: thermodynamic driving force"""

    REACTION_AFFINITY: "SBO"
    """reaction affinity: Synonym: thermodynamic driving force"""

    SBO_0000619: "SBO"
    """transformed Gibbs free energy change: A Gibbs free energy that is calculated from the standard Gibbs value (at 298K), and extrapolated to a desired pH and ionic strength, and may be determined at a different temperature. Symbol: ΔG´."""

    TRANSFORMED_GIBBS_FREE_ENERGY_CHANGE: "SBO"
    """transformed Gibbs free energy change: A Gibbs free energy that is calculated from the standard Gibbs value (at 298K), and extrapolated to a desired pH and ionic strength, and may be determined at a different temperature. Symbol: ΔG´."""

    SBO_0000620: "SBO"
    """transformed standard Gibbs free energy of reaction: A Gibbs free energy of reaction that is calculated from the standard Gibbs value (at 298K), and extrapolated to a desired pH and ionic strength, and may be determined at a different temperature. Symbol ΔG´."""

    TRANSFORMED_STANDARD_GIBBS_FREE_ENERGY_OF_REACTION: "SBO"
    """transformed standard Gibbs free energy of reaction: A Gibbs free energy of reaction that is calculated from the standard Gibbs value (at 298K), and extrapolated to a desired pH and ionic strength, and may be determined at a different temperature. Symbol ΔG´."""

    SBO_0000621: "SBO"
    """transformed standard Gibbs free energy of formation: A Gibbs free energy of formation that is calculated from the standard Gibbs value (at 298K), and extrapolated to a desired pH and ionic strength, and may be determined at a different temperature. Symbol ΔGf´."""

    TRANSFORMED_STANDARD_GIBBS_FREE_ENERGY_OF_FORMATION: "SBO"
    """transformed standard Gibbs free energy of formation: A Gibbs free energy of formation that is calculated from the standard Gibbs value (at 298K), and extrapolated to a desired pH and ionic strength, and may be determined at a different temperature. Symbol ΔGf´."""

    SBO_0000622: "SBO"
    """transformed Gibbs free energy of reaction: The Gibbs free energy change observed in a thermodynamic system when a substance undergoes a reaction under non standard conditions, which is extrapolated to a desired pH and ionic strength, and may be determined at a different temperature. Symbol: ΔG´."""

    TRANSFORMED_GIBBS_FREE_ENERGY_OF_REACTION: "SBO"
    """transformed Gibbs free energy of reaction: The Gibbs free energy change observed in a thermodynamic system when a substance undergoes a reaction under non standard conditions, which is extrapolated to a desired pH and ionic strength, and may be determined at a different temperature. Symbol: ΔG´."""

    SBO_0000623: "SBO"
    """ionic strength: A combined (weighted) measure of the concentration of all electrolytes present in a solution. It is calculated as a half of the sum over all the ions in the solution multiplied by the square of individual ionic valencies. Monovalent electrolytes have a concentration equal to their ionic strength while multivalent electrolytes have greater ionic strength, directly proportional to ionic valency. Symbol: I"""

    IONIC_STRENGTH: "SBO"
    """ionic strength: A combined (weighted) measure of the concentration of all electrolytes present in a solution. It is calculated as a half of the sum over all the ions in the solution multiplied by the square of individual ionic valencies. Monovalent electrolytes have a concentration equal to their ionic strength while multivalent electrolytes have greater ionic strength, directly proportional to ionic valency. Symbol: I"""

    SBO_0000624: "SBO"
    """flux balance framework: Modelling approach, typically used for metabolic models, where the flow of metabolites (flux) through a network can be calculated. This approach will generally produce a set of solutions (solution space), which may be reduced using objective functions and constraints on individual fluxes."""

    FLUX_BALANCE_FRAMEWORK: "SBO"
    """flux balance framework: Modelling approach, typically used for metabolic models, where the flow of metabolites (flux) through a network can be calculated. This approach will generally produce a set of solutions (solution space), which may be reduced using objective functions and constraints on individual fluxes."""

    SBO_0000625: "SBO"
    """flux bound: A parameter that limits the upper or lower value that a flux may assume. This parameter may be determined experimentally, or may be the result of theoretical investigation."""

    FLUX_BOUND: "SBO"
    """flux bound: A parameter that limits the upper or lower value that a flux may assume. This parameter may be determined experimentally, or may be the result of theoretical investigation."""

    SBO_0000626: "SBO"
    """default flux bound: A value used for flux bound in cases where a precise value, supported experimentally or theoretically, is not available."""

    DEFAULT_FLUX_BOUND: "SBO"
    """default flux bound: A value used for flux bound in cases where a precise value, supported experimentally or theoretically, is not available."""

    SBO_0000627: "SBO"
    """exchange reaction: A modeling process to provide matter influx or efflux to a model, for example to replenish a metabolic network with raw materials (eg carbon / energy sources). Such reactions are conceptual, created solely for modeling purposes, and do not have a physical correspondence. Exchange reactions, often represented as 'R_EX_', can operate in the negative (uptake) direction or positive (secretion) direction. By convention, a negative flux through an exchange reaction represents uptake of the corresponding metabolite, and a positive flux represent discharge."""

    EXCHANGE_REACTION: "SBO"
    """exchange reaction: A modeling process to provide matter influx or efflux to a model, for example to replenish a metabolic network with raw materials (eg carbon / energy sources). Such reactions are conceptual, created solely for modeling purposes, and do not have a physical correspondence. Exchange reactions, often represented as 'R_EX_', can operate in the negative (uptake) direction or positive (secretion) direction. By convention, a negative flux through an exchange reaction represents uptake of the corresponding metabolite, and a positive flux represent discharge."""

    SBO_0000628: "SBO"
    """demand reaction: A modeling process analogous to exchange reaction, but which operates upon 'internal' metabolites. Metabolites that are consumed by these reactions are assumed to be used in intra-cellular processes that are not part of the model. Demand reactions, often represented 'R_DM_', can also deliver metabolites (from intra-cellular processes that are not considered in the model)."""

    DEMAND_REACTION: "SBO"
    """demand reaction: A modeling process analogous to exchange reaction, but which operates upon 'internal' metabolites. Metabolites that are consumed by these reactions are assumed to be used in intra-cellular processes that are not part of the model. Demand reactions, often represented 'R_DM_', can also deliver metabolites (from intra-cellular processes that are not considered in the model)."""

    SBO_0000629: "SBO"
    """biomass production: Biomass production, often represented 'R_BIOMASS_', is usually the optimization target reaction of constraint-based models, and can consume multiple reactants to produce multiple products. It is also assumed that parts of the reactants are also consumed in unrepresented processes and hence products do not have to reflect all the atom composition of the reactants. Formulation of a biomass production process entails definition of the macromolecular content (eg. cellular protein fraction), metabolic constitution of each fraction (eg. amino acids), and subsequently the atomic composition (eg. nitrogen atoms). More complex biomass functions can additionally incorporate details of essential vitamins and cofactors required for growth."""

    BIOMASS_PRODUCTION: "SBO"
    """biomass production: Biomass production, often represented 'R_BIOMASS_', is usually the optimization target reaction of constraint-based models, and can consume multiple reactants to produce multiple products. It is also assumed that parts of the reactants are also consumed in unrepresented processes and hence products do not have to reflect all the atom composition of the reactants. Formulation of a biomass production process entails definition of the macromolecular content (eg. cellular protein fraction), metabolic constitution of each fraction (eg. amino acids), and subsequently the atomic composition (eg. nitrogen atoms). More complex biomass functions can additionally incorporate details of essential vitamins and cofactors required for growth."""

    SBO_0000630: "SBO"
    """ATP maintenance: Synonym: maintenance energy"""

    ATP_MAINTENANCE: "SBO"
    """ATP maintenance: Synonym: maintenance energy"""

    SBO_0000631: "SBO"
    """pseudoreaction: A conceptual process used for modeling purposes, often created solely to complete model structure, with respect to providing inflow or outflow of matter or material. Unlike other reactions, pseudoreactions are not usually subjected to mass balance considerations."""

    PSEUDOREACTION: "SBO"
    """pseudoreaction: A conceptual process used for modeling purposes, often created solely to complete model structure, with respect to providing inflow or outflow of matter or material. Unlike other reactions, pseudoreactions are not usually subjected to mass balance considerations."""

    SBO_0000632: "SBO"
    """sink reaction: Synonym: source/sink"""

    SINK_REACTION: "SBO"
    """sink reaction: Synonym: source/sink"""

    SBO_0000633: "SBO"
    """subsystem: Term used to indicate the grouping of model components, largely reactions, by some criterion, often processual. This can be used to indicate, for example, the subsystem of a model that is concerned with 'transport'. A designated subsystem includes reactions annotated with the term, as well as reactions participants such as enzymes, modifiers and genes encoding these subsystem components."""

    SUBSYSTEM: "SBO"
    """subsystem: Term used to indicate the grouping of model components, largely reactions, by some criterion, often processual. This can be used to indicate, for example, the subsystem of a model that is concerned with 'transport'. A designated subsystem includes reactions annotated with the term, as well as reactions participants such as enzymes, modifiers and genes encoding these subsystem components."""

    SBO_0000634: "SBO"
    """DNA segment: Fragment or region of a DNA macromolecule."""

    DNA_SEGMENT: "SBO"
    """DNA segment: Fragment or region of a DNA macromolecule."""

    SBO_0000635: "SBO"
    """RNA segment: Fragment or region of an RNA macromolecule."""

    RNA_SEGMENT: "SBO"
    """RNA segment: Fragment or region of an RNA macromolecule."""

    SBO_0000636: "SBO"
    """allosteric activator: Synonym: positive allosteric modulation"""

    ALLOSTERIC_ACTIVATOR: "SBO"
    """allosteric activator: Synonym: positive allosteric modulation"""

    SBO_0000637: "SBO"
    """non-allosteric activator: Describes an activator (ligand) which binds to the enzyme, which does not result in a conformational change, but which enhances the enzyme's activity."""

    NON_ALLOSTERIC_ACTIVATOR: "SBO"
    """non-allosteric activator: Describes an activator (ligand) which binds to the enzyme, which does not result in a conformational change, but which enhances the enzyme's activity."""

    SBO_0000638: "SBO"
    """irreversible inhibitor: An inhibitor which binds irreversibly with the enzyme such that it cannot be removed, and abolishes enzymatic function."""

    IRREVERSIBLE_INHIBITOR: "SBO"
    """irreversible inhibitor: An inhibitor which binds irreversibly with the enzyme such that it cannot be removed, and abolishes enzymatic function."""

    SBO_0000639: "SBO"
    """allosteric inhibitor: An inhibitor whose binding to an enzyme results in a conformational change, resulting in a loss of enzymatic activity. This activity can be restored upon removal of the inhibitor."""

    ALLOSTERIC_INHIBITOR: "SBO"
    """allosteric inhibitor: An inhibitor whose binding to an enzyme results in a conformational change, resulting in a loss of enzymatic activity. This activity can be restored upon removal of the inhibitor."""

    SBO_0000640: "SBO"
    """uncompetitive inhibitor: Synonym: anti-competitive inhibitor"""

    UNCOMPETITIVE_INHIBITOR: "SBO"
    """uncompetitive inhibitor: Synonym: anti-competitive inhibitor"""

    SBO_0000641: "SBO"
    """pMg: An enumeration of the concentration of magnesium (Mg) in solution (pMg = -log10[Mg2+])."""

    PMG: "SBO"
    """pMg: An enumeration of the concentration of magnesium (Mg) in solution (pMg = -log10[Mg2+])."""

    SBO_0000642: "SBO"
    """inhibited: Conceptual or material entity that is the object of an inhibition process, and is acted upon by an inhibitor."""

    INHIBITED: "SBO"
    """inhibited: Conceptual or material entity that is the object of an inhibition process, and is acted upon by an inhibitor."""

    SBO_0000643: "SBO"
    """stimulated: Conceptual or material entity that is the object of a stimulation process, and is acted upon by a stimulator."""

    STIMULATED: "SBO"
    """stimulated: Conceptual or material entity that is the object of a stimulation process, and is acted upon by a stimulator."""

    SBO_0000644: "SBO"
    """modified: Conceptual or material entity that is the object of a modification process, and is acted upon by a modifier."""

    MODIFIED: "SBO"
    """modified: Conceptual or material entity that is the object of a modification process, and is acted upon by a modifier."""

    SBO_0000645: "SBO"
    """template: An entity that acts as the starting material for genetic production (http://identifiers.org/biomodels.sbo/SBO:0000589)."""

    TEMPLATE: "SBO"
    """template: An entity that acts as the starting material for genetic production (http://identifiers.org/biomodels.sbo/SBO:0000589)."""

    SBO_0000646: "SBO"
    """mass action rate law for reversible reactions, continuous schema: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme includes a reverse process that creates the reactants from the products. It is to be used in a reaction modelled using a continuous framework."""

    MASS_ACTION_RATE_LAW_FOR_REVERSIBLE_REACTIONS__CONTINUOUS_SCHEMA: "SBO"
    """mass action rate law for reversible reactions, continuous schema: Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme includes a reverse process that creates the reactants from the products. It is to be used in a reaction modelled using a continuous framework."""

    SBO_0000647: "SBO"
    """molecular mass: Synonym: molecular weight"""

    MOLECULAR_MASS: "SBO"
    """molecular mass: Synonym: molecular weight"""

    SBO_0000648: "SBO"
    """protein molecular mass: Synonym: protein molecular weight"""

    PROTEIN_MOLECULAR_MASS: "SBO"
    """protein molecular mass: Synonym: protein molecular weight"""

    SBO_0000649: "SBO"
    """biomass: A composite representation of material entities required for organismal growth. It includes macromolecular content (eg. cellular protein fraction), metabolic constitution of each fraction (eg. amino acids), and atomic composition (eg. nitrogen atoms)."""

    BIOMASS: "SBO"
    """biomass: A composite representation of material entities required for organismal growth. It includes macromolecular content (eg. cellular protein fraction), metabolic constitution of each fraction (eg. amino acids), and atomic composition (eg. nitrogen atoms)."""

    SBO_0000650: "SBO"
    """reversible process: A sequential series of actions, motions, or occurrences, such as chemical reactions, where a reversal of states that bring the system back to its original state in a characteristic manner occurs."""

    REVERSIBLE_PROCESS: "SBO"
    """reversible process: A sequential series of actions, motions, or occurrences, such as chemical reactions, where a reversal of states that bring the system back to its original state in a characteristic manner occurs."""

    SBO_0000651: "SBO"
    """irreversible process: A sequential series of actions, motions, or occurrences, such as chemical reactions, where a reversal of states that bring the system back to its original state in a characteristic manner does not occur."""

    IRREVERSIBLE_PROCESS: "SBO"
    """irreversible process: A sequential series of actions, motions, or occurrences, such as chemical reactions, where a reversal of states that bring the system back to its original state in a characteristic manner does not occur."""

    SBO_0000652: "SBO"
    """polymerization: A chemical reaction in which one or more monomer molecules combine to form a larger polymer molecule with repeated structural units."""

    POLYMERIZATION: "SBO"
    """polymerization: A chemical reaction in which one or more monomer molecules combine to form a larger polymer molecule with repeated structural units."""

    SBO_0000653: "SBO"
    """depolymerization: A chemical reaction in which a large polymer breaks into its constituent monomers (or mixture of monomers)."""

    DEPOLYMERIZATION: "SBO"
    """depolymerization: A chemical reaction in which a large polymer breaks into its constituent monomers (or mixture of monomers)."""

    SBO_0000654: "SBO"
    """co-transport reaction: A biochemical process involving the simultaneous transport of two or more substances across a membrane via a protein or protein complex."""

    CO_TRANSPORT_REACTION: "SBO"
    """co-transport reaction: A biochemical process involving the simultaneous transport of two or more substances across a membrane via a protein or protein complex."""

    SBO_0000655: "SBO"
    """transport reaction: The movement of an entity/entities across a biological membrane mediated by a transporter protein."""

    TRANSPORT_REACTION: "SBO"
    """transport reaction: The movement of an entity/entities across a biological membrane mediated by a transporter protein."""

    SBO_0000656: "SBO"
    """activation: A conformational change in a protein resulting in its activation."""

    ACTIVATION: "SBO"
    """activation: A conformational change in a protein resulting in its activation."""

    SBO_0000657: "SBO"
    """active transport: Protein assisted movement of molecules across a membrane from a region of low concentration to high concentration involving the consumption of cellular energy (ATP molecules)."""

    ACTIVE_TRANSPORT: "SBO"
    """active transport: Protein assisted movement of molecules across a membrane from a region of low concentration to high concentration involving the consumption of cellular energy (ATP molecules)."""

    SBO_0000658: "SBO"
    """passive transport: Movement of molecules without the need for external energy, and usually from a region of high concentration to low concentration."""

    PASSIVE_TRANSPORT: "SBO"
    """passive transport: Movement of molecules without the need for external energy, and usually from a region of high concentration to low concentration."""

    SBO_0000659: "SBO"
    """symporter-mediated transport: A membrane protein mediated transport of two ore more molecules in the same relative direction across a membrane."""

    SYMPORTER_MEDIATED_TRANSPORT: "SBO"
    """symporter-mediated transport: A membrane protein mediated transport of two ore more molecules in the same relative direction across a membrane."""

    SBO_0000660: "SBO"
    """antiporter-mediated transport: A membrane protein mediated transport of two or more molecules in opposite directions across a membrane."""

    ANTIPORTER_MEDIATED_TRANSPORT: "SBO"
    """antiporter-mediated transport: A membrane protein mediated transport of two or more molecules in opposite directions across a membrane."""

    SBO_0000661: "SBO"
    """capacity: Total amount that can be contained or produced by a specific entity. This can refer to diverse items, such as the carrying capacity of a membrane with respect to proteins, the capacity of high-energy phosphate bonds, or the maximal count of bacteria in the gut, etc."""

    CAPACITY: "SBO"
    """capacity: Total amount that can be contained or produced by a specific entity. This can refer to diverse items, such as the carrying capacity of a membrane with respect to proteins, the capacity of high-energy phosphate bonds, or the maximal count of bacteria in the gut, etc."""

    SBO_0000662: "SBO"
    """occupancy: Occopancy is a quantitative systemic property that indicates which number of available places is occupied. This can refer to diverse things, such as the number of occupied high-energy phosphate bonds in ATP, the number of bacteria in the gut, or the number of electrons loaded onto redox carriers, etc."""

    OCCUPANCY: "SBO"
    """occupancy: Occopancy is a quantitative systemic property that indicates which number of available places is occupied. This can refer to diverse things, such as the number of occupied high-energy phosphate bonds in ATP, the number of bacteria in the gut, or the number of electrons loaded onto redox carriers, etc."""

    SBO_0000663: "SBO"
    """fractional occupancy: Fractional occupancy is a quantitative dynamic property of a system that can be calculated as the fraction of occupancy over capacity."""

    FRACTIONAL_OCCUPANCY: "SBO"
    """fractional occupancy: Fractional occupancy is a quantitative dynamic property of a system that can be calculated as the fraction of occupancy over capacity."""

    SBO_0000664: "SBO"
    """contained entity: an entity which physical constituents are partially or totally contained in a defined compartment."""

    CONTAINED_ENTITY: "SBO"
    """contained entity: an entity which physical constituents are partially or totally contained in a defined compartment."""

    SBO_0000665: "SBO"
    """inactivation: a conformation changes to a protein leading to its inactivation"""

    INACTIVATION: "SBO"
    """inactivation: a conformation changes to a protein leading to its inactivation"""

    SBO_0000666: "SBO"
    """chain length: describes the number of amino acids,nucleic acid in a protein/DNA/RNA chain"""

    CHAIN_LENGTH: "SBO"
    """chain length: describes the number of amino acids,nucleic acid in a protein/DNA/RNA chain"""

    SBO_0000667: "SBO"
    """protein chain length: length of amino acid sequence in a protein"""

    PROTEIN_CHAIN_LENGTH: "SBO"
    """protein chain length: length of amino acid sequence in a protein"""

    SBO_0000668: "SBO"
    """yield: output generated as biomass or product from a/set of chemical reaction/s."""

    YIELD: "SBO"
    """yield: output generated as biomass or product from a/set of chemical reaction/s."""

    SBO_0000669: "SBO"
    """biomass yield on substrate: generation of biomass for an substrate through a defined reaction/s."""

    BIOMASS_YIELD_ON_SUBSTRATE: "SBO"
    """biomass yield on substrate: generation of biomass for an substrate through a defined reaction/s."""

    SBO_0000670: "SBO"
    """product yield on substrate: generation of product from substrate in a defined chemical reaction."""

    PRODUCT_YIELD_ON_SUBSTRATE: "SBO"
    """product yield on substrate: generation of product from substrate in a defined chemical reaction."""

    SBO_0000671: "SBO"
    """non-enzymatic catalyst: agent driving non-enzymatic reaction. Non-enzymatic reactions resemble catalytic mechanisms as found in all major enzyme classes and occur spontaneously, small molecule (e.g. metal-) catalyzed or light-induced."""

    NON_ENZYMATIC_CATALYST: "SBO"
    """non-enzymatic catalyst: agent driving non-enzymatic reaction. Non-enzymatic reactions resemble catalytic mechanisms as found in all major enzyme classes and occur spontaneously, small molecule (e.g. metal-) catalyzed or light-induced."""

    SBO_0000672: "SBO"
    """spontaneous reaction: Reaction with no catalyst (no enzyme in particular) is needed to proceed."""

    SPONTANEOUS_REACTION: "SBO"
    """spontaneous reaction: Reaction with no catalyst (no enzyme in particular) is needed to proceed."""

    SBO_0000673: "SBO"
    """forward effective catalytic rate: it represent the catalytic rate driving the reaction in forward direction."""

    FORWARD_EFFECTIVE_CATALYTIC_RATE: "SBO"
    """forward effective catalytic rate: it represent the catalytic rate driving the reaction in forward direction."""

    SBO_0000674: "SBO"
    """reverse effective catalytic rate: it represent the catalytic rate driving the reaction in backward direction."""

    REVERSE_EFFECTIVE_CATALYTIC_RATE: "SBO"
    """reverse effective catalytic rate: it represent the catalytic rate driving the reaction in backward direction."""

    SBO_0000675: "SBO"
    """deterministic non-spatial continuous framework: Modeling approach where the quantities of participants are considered deterministic continuous variables, and represented by real values. The associated simulation methods make use of ordinary differential equations."""

    DETERMINISTIC_NON_SPATIAL_CONTINUOUS_FRAMEWORK: "SBO"
    """deterministic non-spatial continuous framework: Modeling approach where the quantities of participants are considered deterministic continuous variables, and represented by real values. The associated simulation methods make use of ordinary differential equations."""

    SBO_0000676: "SBO"
    """stochastic non-spatial continuous framework: Modeling approach where the quantities of participants are considered stochastic continuous variables, and represented by real values. The associated simulation methods make use of stochastic differential equations. The models do take into account the distribution of the entities."""

    STOCHASTIC_NON_SPATIAL_CONTINUOUS_FRAMEWORK: "SBO"
    """stochastic non-spatial continuous framework: Modeling approach where the quantities of participants are considered stochastic continuous variables, and represented by real values. The associated simulation methods make use of stochastic differential equations. The models do take into account the distribution of the entities."""

    SBO_0000677: "SBO"
    """population-based discrete spatial simulation: Modeling approach which tracks the sizes of populations of participants in each spatial localization. For biochemical simulations, such populations could represent types of molecular species."""

    POPULATION_BASED_DISCRETE_SPATIAL_SIMULATION: "SBO"
    """population-based discrete spatial simulation: Modeling approach which tracks the sizes of populations of participants in each spatial localization. For biochemical simulations, such populations could represent types of molecular species."""

    SBO_0000678: "SBO"
    """particle-based discrete spatial simulation: Modeling approach which tracks the state of individual particles in each spatial localization. For biochemical simulations, such particles could represent individual molecules."""

    PARTICLE_BASED_DISCRETE_SPATIAL_SIMULATION: "SBO"
    """particle-based discrete spatial simulation: Modeling approach which tracks the state of individual particles in each spatial localization. For biochemical simulations, such particles could represent individual molecules."""

    SBO_0000679: "SBO"
    """population-based discrete non-spatial simulation: Modeling approach which tracks the sizes of populations of participants with minimal or no spatial resolution. For biochemical simulations, such populations could represent types of molecular species."""

    POPULATION_BASED_DISCRETE_NON_SPATIAL_SIMULATION: "SBO"
    """population-based discrete non-spatial simulation: Modeling approach which tracks the sizes of populations of participants with minimal or no spatial resolution. For biochemical simulations, such populations could represent types of molecular species."""

    SBO_0000680: "SBO"
    """particle-based discrete non-spatial simulation: Modeling approach which tracks the state of individual particles with miimal or no spatial resolution. For biochemical simulations, such particles could represent individual molecules."""

    PARTICLE_BASED_DISCRETE_NON_SPATIAL_SIMULATION: "SBO"
    """particle-based discrete non-spatial simulation: Modeling approach which tracks the state of individual particles with miimal or no spatial resolution. For biochemical simulations, such particles could represent individual molecules."""
    ...
    HYBRID_FRAMEWORK: "SBO"
    """hybrid framework: Modeling approach which combines multiple canonical modeling frameworks. For example, a hybrid model could consider both continuous (represented by real values) and discrete (represented by integers) participants. Hybrid models are executed with hybrid simulation algorithms. For example, a hybrid continuous-discrete model may be simulation using a combination of stochastic simulation and ordinary differential equations."""

    SBO_0000682: "SBO"
    """hybrid spatial framework: Modeling approach which combines multiple canonical spatial modeling frameworks. For example, a hybrid model could consider both continuous (represented by real values) and discrete (represented by integers) participants. Hybrid models are executed with hybrid simulation algorithms. For example, a hybrid continuous-discrete model may be simulation using a combination of stochastic simulation and partial differential equations."""

    HYBRID_SPATIAL_FRAMEWORK: "SBO"
    """hybrid spatial framework: Modeling approach which combines multiple canonical spatial modeling frameworks. For example, a hybrid model could consider both continuous (represented by real values) and discrete (represented by integers) participants. Hybrid models are executed with hybrid simulation algorithms. For example, a hybrid continuous-discrete model may be simulation using a combination of stochastic simulation and partial differential equations."""

    SBO_0000683: "SBO"
    """hybrid non-spatial framework: Modeling approach which combines multiple canonical non-spatial modeling frameworks. For example, a hybrid model could consider both continuous (represented by real values) and discrete (represented by integers) participants. Hybrid models are executed with hybrid simulation algorithms. For example, a hybrid continuous-discrete model may be simulation using a combination of stochastic simulation and ordinary differential equations."""

    HYBRID_NON_SPATIAL_FRAMEWORK: "SBO"
    """hybrid non-spatial framework: Modeling approach which combines multiple canonical non-spatial modeling frameworks. For example, a hybrid model could consider both continuous (represented by real values) and discrete (represented by integers) participants. Hybrid models are executed with hybrid simulation algorithms. For example, a hybrid continuous-discrete model may be simulation using a combination of stochastic simulation and ordinary differential equations."""

    SBO_0000684: "SBO"
    """hybrid flux balance-deterministic continuous non-spatial framework: Modeling approach which combines flux-balance [SBO:0000624] and deterministic continuous non-spatial [SBO:0000675] simulation. For example, a metabolic network could be simulated using flux balance analysis, while a signaling network could be co-simulated with a method for integrating ordinary differential equations."""

    HYBRID_FLUX_BALANCE_DETERMINISTIC_CONTINUOUS_NON_SPATIAL_FRAMEWORK: "SBO"
    """hybrid flux balance-deterministic continuous non-spatial framework: Modeling approach which combines flux-balance [SBO:0000624] and deterministic continuous non-spatial [SBO:0000675] simulation. For example, a metabolic network could be simulated using flux balance analysis, while a signaling network could be co-simulated with a method for integrating ordinary differential equations."""

    SBO_0000685: "SBO"
    """hybrid flux balance-discrete non-spatial framework: Modeling approach which combines flux-balance [SBO:0000624] and discrete non-spatial [SBO:0000295] simulation. For example, a metabolic network could be simulated using flux balance analysis, while the synthesis and turnover of enzymes could be co-simulated with a discrete simulation method such as Gillespie's algorithm."""

    HYBRID_FLUX_BALANCE_DISCRETE_NON_SPATIAL_FRAMEWORK: "SBO"
    """hybrid flux balance-discrete non-spatial framework: Modeling approach which combines flux-balance [SBO:0000624] and discrete non-spatial [SBO:0000295] simulation. For example, a metabolic network could be simulated using flux balance analysis, while the synthesis and turnover of enzymes could be co-simulated with a discrete simulation method such as Gillespie's algorithm."""

    SBO_0000686: "SBO"
    """hybrid flux balance-logical-deterministic continuous non-spatial framework: Modeling approach which combines flux-balance [SBO:0000624], non-spatial deterministic continuous [SBO:0000675], and logical [SBO:0000234] simulation. For example, a metabolic network could be simulated using flux balance analysis, while the expression metabolic enzymes could be co-simulated with a logical simulation method and a signaling network could be co-simulated with a method for integrating ordinary differential equations such as CVODE."""

    HYBRID_FLUX_BALANCE_LOGICAL_DETERMINISTIC_CONTINUOUS_NON_SPATIAL_FRAMEWORK: "SBO"
    """hybrid flux balance-logical-deterministic continuous non-spatial framework: Modeling approach which combines flux-balance [SBO:0000624], non-spatial deterministic continuous [SBO:0000675], and logical [SBO:0000234] simulation. For example, a metabolic network could be simulated using flux balance analysis, while the expression metabolic enzymes could be co-simulated with a logical simulation method and a signaling network could be co-simulated with a method for integrating ordinary differential equations such as CVODE."""

    SBO_0000687: "SBO"
    """hybrid flux balance-logical non-spatial framework: Modeling approach which combines flux-balance [SBO:0000624] and logical [SBO:0000234] simulation. For example, a metabolic network could be simulated using flux balance analysis, while the expression metabolic enzymes could be co-simulated with a logical simulation method."""

    HYBRID_FLUX_BALANCE_LOGICAL_NON_SPATIAL_FRAMEWORK: "SBO"
    """hybrid flux balance-logical non-spatial framework: Modeling approach which combines flux-balance [SBO:0000624] and logical [SBO:0000234] simulation. For example, a metabolic network could be simulated using flux balance analysis, while the expression metabolic enzymes could be co-simulated with a logical simulation method."""

    SBO_0000688: "SBO"
    """hybrid flux logical-discrete non-spatial framework: Modeling approach which combines logical [SBO:0000234] and non-spatial discrete [SBO:0000295] simulation. For example, the MaBoSS simulation method simulates logical regulatory graphs with an algorithm that is similar to Gillespie's algorithm."""

    HYBRID_FLUX_LOGICAL_DISCRETE_NON_SPATIAL_FRAMEWORK: "SBO"
    """hybrid flux logical-discrete non-spatial framework: Modeling approach which combines logical [SBO:0000234] and non-spatial discrete [SBO:0000295] simulation. For example, the MaBoSS simulation method simulates logical regulatory graphs with an algorithm that is similar to Gillespie's algorithm."""

    SBO_0000689: "SBO"
    """hybrid continuous-discrete non-spatial framework: Modeling approach which combines continuous [SBO:0000293] and discrete [SBO:0000295] simulation, where some participants are represented as continuous variables and others are represented as discrete variables, without a detailed spatial representation of each participant. For example, a model may be simulated using a combination of a discrete simulation method such as Gillespie's algorithm and an ordinary differential equations integration method such as CVODE."""

    HYBRID_CONTINUOUS_DISCRETE_NON_SPATIAL_FRAMEWORK: "SBO"
    """hybrid continuous-discrete non-spatial framework: Modeling approach which combines continuous [SBO:0000293] and discrete [SBO:0000295] simulation, where some participants are represented as continuous variables and others are represented as discrete variables, without a detailed spatial representation of each participant. For example, a model may be simulated using a combination of a discrete simulation method such as Gillespie's algorithm and an ordinary differential equations integration method such as CVODE."""

    SBO_0000690: "SBO"
    """hybrid deterministic continuous-discrete non-spatial framework: Modeling approach which combines deterministic continuous [SBO:0000675] and discrete [SBO:0000295] simulation, where some participants are represented as deterministic, continuous variables and others are represented as discrete variables, without a detailed spatial representation of each participant. For example, a model may be simulated using a combination of a discrete simulation method such as Gillespie's algorithm and an ordinary differential equations integration method such as CVODE."""

    HYBRID_DETERMINISTIC_CONTINUOUS_DISCRETE_NON_SPATIAL_FRAMEWORK: "SBO"
    """hybrid deterministic continuous-discrete non-spatial framework: Modeling approach which combines deterministic continuous [SBO:0000675] and discrete [SBO:0000295] simulation, where some participants are represented as deterministic, continuous variables and others are represented as discrete variables, without a detailed spatial representation of each participant. For example, a model may be simulated using a combination of a discrete simulation method such as Gillespie's algorithm and an ordinary differential equations integration method such as CVODE."""

    SBO_0000691: "SBO"
    """hybrid stochastic continuous-discrete non-spatial framework: Modeling approach which combines stochastic continuous [SBO:0000676] and discrete [SBO:0000295] simulation, where some participants are represented as stochastic, continuous variables and others are represented as discrete variables, without a detailed spatial representation of each participant. For example, a model may be simulated using a combination of a discrete simulation method such as Gillespie's algorithm and an stochastic differential equations integration method."""

    HYBRID_STOCHASTIC_CONTINUOUS_DISCRETE_NON_SPATIAL_FRAMEWORK: "SBO"
    """hybrid stochastic continuous-discrete non-spatial framework: Modeling approach which combines stochastic continuous [SBO:0000676] and discrete [SBO:0000295] simulation, where some participants are represented as stochastic, continuous variables and others are represented as discrete variables, without a detailed spatial representation of each participant. For example, a model may be simulated using a combination of a discrete simulation method such as Gillespie's algorithm and an stochastic differential equations integration method."""

    SBO_0000692: "SBO"
    """resource balance framework: Modeling approach where the flow of resources (flux) through a network can be calculated. This approach will generally produce a set of solutions (solution space), which may be reduced using objective functions and constraints on individual fluxes."""

    RESOURCE_BALANCE_FRAMEWORK: "SBO"
    """resource balance framework: Modeling approach where the flow of resources (flux) through a network can be calculated. This approach will generally produce a set of solutions (solution space), which may be reduced using objective functions and constraints on individual fluxes."""

    SBO_0000693: "SBO"
    """constraint-based framework: Modelling approach which captures bounds on the possible behavior of a system, which may be further reduced using an objective function."""

    CONSTRAINT_BASED_FRAMEWORK: "SBO"
    """constraint-based framework: Modelling approach which captures bounds on the possible behavior of a system, which may be further reduced using an objective function."""

    SBO_0000694: "SBO"
    """optimization framework: Modelling approach for finding the optimal state of a system."""

    OPTIMIZATION_FRAMEWORK: "SBO"
    """optimization framework: Modelling approach for finding the optimal state of a system."""

    SBO_0000695: "SBO"
    """ligation: Formation of a covalent bond resulting in the creation of a link between the ends of one or more linear polymer molecules."""
...
_terms: list[TermData] = [
    (
        "SBO_0000000",
        ("SBO_0000000", "SYSTEMS_BIOLOGY_REPRESENTATION"),
    ...
    (
        "SBO_0000002",
        ("SBO_0000002", "QUANTITATIVE_SYSTEMS_DESCRIPTION_PARAMETER"),
    ...
    (
        "SBO_0000004",
        ("SBO_0000004", "MODELLING_FRAMEWORK"),
        "modelling framework",
    ...
    (
        "SBO_0000005",
        ("SBO_0000005", "OBSOLETE_MATHEMATICAL_EXPRESSION"),
    ...
    (
        "SBO_0000006",
        ("SBO_0000006", "OBSOLETE_PARAMETER"),
        "obsolete parameter",
    ...
    (
        "SBO_0000007",
        ("SBO_0000007", "OBSOLETE_PARTICIPANT_TYPE"),
    ...
    (
        "SBO_0000008",
        ("SBO_0000008", "OBSOLETE_MODELLING_FRAMEWORK"),
    ...
    (
        "SBO_0000012",
        ("SBO_0000012", "MASS_ACTION_RATE_LAW"),
    ...
    (
        "SBO_0000016",
        ("SBO_0000016", "UNIMOLECULAR_RATE_CONSTANT"),
    ...
    (
        "SBO_0000017",
        ("SBO_0000017", "BIMOLECULAR_RATE_CONSTANT"),
    ...
    (
        "SBO_0000018",
        ("SBO_0000018", "TRIMOLECULAR_RATE_CONSTANT"),
    ...
    (
        "SBO_0000022",
        ("SBO_0000022", "FORWARD_UNIMOLECULAR_RATE_CONSTANT"),
    ...
    (
        "SBO_0000023",
        ("SBO_0000023", "FORWARD_BIMOLECULAR_RATE_CONSTANT"),
    ...
    (
        "SBO_0000024",
        ("SBO_0000024", "FORWARD_TRIMOLECULAR_RATE_CONSTANT"),
    ...
    (
        "SBO_0000025",
        ("SBO_0000025", "CATALYTIC_RATE_CONSTANT"),
    ...
    (
        "SBO_0000027",
        ("SBO_0000027", "MICHAELIS_CONSTANT"),
        "Michaelis constant",
    ...
    (
        "SBO_0000029",
        ("SBO_0000029", "HENRI_MICHAELIS_MENTEN_RATE_LAW"),
    ...
    (
        "SBO_0000030",
        ("SBO_0000030", "VAN_SLYKE_CULLEN_RATE_LAW"),
    ...
    (
        "SBO_0000031",
        ("SBO_0000031", "BRIGGS_HALDANE_RATE_LAW"),
    ...
    (
        "SBO_0000032",
        ("SBO_0000032", "REVERSE_UNIMOLECULAR_RATE_CONSTANT"),
    ...
    (
        "SBO_0000033",
        ("SBO_0000033", "REVERSE_BIMOLECULAR_RATE_CONSTANT"),
    ...
    (
        "SBO_0000034",
        ("SBO_0000034", "REVERSE_TRIMOLECULAR_RATE_CONSTANT"),
    ...
    (
        "SBO_0000035",
        ("SBO_0000035", "FORWARD_UNIMOLECULAR_RATE_CONSTANT__CONTINUOUS_CASE"),
    ...
    (
        "SBO_0000036",
        ("SBO_0000036", "FORWARD_BIMOLECULAR_RATE_CONSTANT__CONTINUOUS_CASE"),
    ...
    (
        "SBO_0000037",
        ("SBO_0000037", "FORWARD_TRIMOLECULAR_RATE_CONSTANT__CONTINUOUS_CASE"),
    ...
    (
        "SBO_0000038",
        ("SBO_0000038", "REVERSE_UNIMOLECULAR_RATE_CONSTANT__CONTINUOUS_CASE"),
    ...
    (
        "SBO_0000039",
        ("SBO_0000039", "REVERSE_BIMOLECULAR_RATE_CONSTANT__CONTINUOUS_CASE"),
    ...
    (
        "SBO_0000040",
        ("SBO_0000040", "REVERSE_TRIMOLECULAR_RATE_CONSTANT__CONTINUOUS_CASE"),
    ...
    (
        "SBO_0000041",
        ("SBO_0000041", "MASS_ACTION_RATE_LAW_FOR_IRREVERSIBLE_REACTIONS"),
    ...
    (
        "SBO_0000042",
        ("SBO_0000042", "MASS_ACTION_RATE_LAW_FOR_REVERSIBLE_REACTIONS"),
    ...
    (
        "SBO_0000043",
        ("SBO_0000043", "MASS_ACTION_RATE_LAW_FOR_ZEROTH_ORDER_IRREVERSIBLE_REACTIONS"),
    ...
    (
        "SBO_0000044",
        ("SBO_0000044", "MASS_ACTION_RATE_LAW_FOR_FIRST_ORDER_IRREVERSIBLE_REACTIONS"),
    ...
    (
        "SBO_0000045",
        ("SBO_0000045", "MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_IRREVERSIBLE_REACTIONS"),
    ...
    (
        "SBO_0000046",
        ("SBO_0000046", "ZEROTH_ORDER_RATE_CONSTANT"),
    ...
    (
        "SBO_0000048",
        ("SBO_0000048", "FORWARD_ZEROTH_ORDER_RATE_CONSTANT__CONTINUOUS_CASE"),
    ...
    ("SBO_0000051", ("SBO_0000051",), "new term name", None, (), False),
    (
        "SBO_0000052",
        (
            "SBO_0000052",
    ...
    (
        "SBO_0000055",
        ("SBO_0000055", "MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_IRREVERSIBLE_REACTIONS"),
    ...
    (
        "SBO_0000062",
        ("SBO_0000062", "CONTINUOUS_FRAMEWORK"),
    ...
    (
        "SBO_0000063",
        ("SBO_0000063", "DISCRETE_FRAMEWORK"),
        "discrete framework",
    ...
    (
        "SBO_0000064",
        ("SBO_0000064", "MATHEMATICAL_EXPRESSION"),
    ...
    (
        "SBO_0000065",
        ("SBO_0000065", "FORWARD_ZEROTH_ORDER_RATE_CONSTANT__DISCRETE_CASE"),
    ...
    (
        "SBO_0000066",
        ("SBO_0000066", "FORWARD_UNIMOLECULAR_RATE_CONSTANT__DISCRETE_CASE"),
    ...
    (
        "SBO_0000067",
        ("SBO_0000067", "FORWARD_BIMOLECULAR_RATE_CONSTANT__DISCRETE_CASE"),
    ...
    (
        "SBO_0000068",
        ("SBO_0000068", "FORWARD_TRIMOLECULAR_RATE_CONSTANT__DISCRETE_CASE"),
    ...
    (
        "SBO_0000069",
        ("SBO_0000069", "MASS_ACTION_RATE_LAW_FOR_ZEROTH_ORDER_REVERSIBLE_REACTIONS"),
    ...
    (
        "SBO_0000078",
        ("SBO_0000078", "MASS_ACTION_RATE_LAW_FOR_FIRST_ORDER_REVERSIBLE_REACTIONS"),
    ...
    (
        "SBO_0000088",
        ("SBO_0000088", "MASS_ACTION_RATE_LAW_FOR_SECOND_ORDER_REVERSIBLE_REACTIONS"),
    ...
    (
        "SBO_0000109",
        ("SBO_0000109", "MASS_ACTION_RATE_LAW_FOR_THIRD_ORDER_REVERSIBLE_REACTIONS"),
    ...
    (
        "SBO_0000147",
        ("SBO_0000147", "THERMODYNAMIC_TEMPERATURE"),
    ...
    (
        "SBO_0000148",
        ("SBO_0000148", "TEMPERATURE_DIFFERENCE"),
    ...
    (
        "SBO_0000149",
        ("SBO_0000149", "NUMBER_OF_SUBSTRATES"),
    ...
    (
        "SBO_0000153",
        ("SBO_0000153", "FORWARD_RATE_CONSTANT"),
    ...
    (
        "SBO_0000154",
        ("SBO_0000154", "FORWARD_RATE_CONSTANT__CONTINUOUS_CASE"),
    ...
    (
        "SBO_0000155",
        ("SBO_0000155", "FORWARD_RATE_CONSTANT__DISCRETE_CASE"),
    ...
    (
        "SBO_0000156",
        ("SBO_0000156", "REVERSE_RATE_CONSTANT"),
    ...
    (
        "SBO_0000157",
        ("SBO_0000157", "NUMBER_OF_REACTANTS"),
        "number of reactants",
    ...
    (
        "SBO_0000158",
        ("SBO_0000158", "ORDER_OF_A_REACTION_WITH_RESPECT_TO_A_REACTANT"),
    ...
    (
        "SBO_0000159",
        ("SBO_0000159", "NON_INTEGRAL_ORDER_RATE_CONSTANT"),
    ...
    (
        "SBO_0000160",
        ("SBO_0000160", "FORWARD_NON_INTEGRAL_ORDER_RATE_CONSTANT"),
    ...
    (
        "SBO_0000161",
        ("SBO_0000161", "REVERSE_NON_INTEGRAL_ORDER_RATE_CONSTANT"),
    ...
    (
        "SBO_0000162",
        ("SBO_0000162", "FORWARD_ZEROTH_ORDER_RATE_CONSTANT"),
    ...
    (
        ...
        (
            "SBO_0000163",
            "MASS_ACTION_RATE_LAW_FOR_IRREVERSIBLE_REACTIONS__CONTINUOUS_SCHEME",
        ),
    ...
    (
        ...
        (
            "SBO_0000164",
            "SECOND_ORDER_IRREVERSIBLE_MASS_ACTION_KINETICS__CONTINUOUS_SCHEME",
        ),
    ...
    (
        ...
        (
            "SBO_0000165",
            "THIRD_ORDER_IRREVERSIBLE_MASS_ACTION_KINETICS__CONTINUOUS_SCHEME",
        ),
    ...
    (
        ...
        (
            "SBO_0000166",
            "MASS_ACTION_RATE_LAW_FOR_IRREVERSIBLE_REACTIONS__DISCRETE_SCHEME",
        ),
    ...
    (
        "SBO_0000167",
        ("SBO_0000167", "BIOCHEMICAL_OR_TRANSPORT_REACTION"),
    ...
    (
        "SBO_0000171",
        ("SBO_0000171", "NECESSARY_STIMULATION"),
    ...
    ("SBO_0000175", ("SBO_0000175", "XOR"), "xor", "Synonym: exclusive or", (), False),
    (
        "SBO_0000176",
        ("SBO_0000176", "BIOCHEMICAL_REACTION"),
    ...
    (
        "SBO_0000177",
        ("SBO_0000177", "NON_COVALENT_BINDING"),
    ...
    (
        "SBO_0000181",
        ("SBO_0000181", "CONFORMATIONAL_TRANSITION"),
    ...
    (
        "SBO_0000185",
        ("SBO_0000185", "TRANSLOCATION_REACTION"),
    ...
    (
        "SBO_0000187",
        ("SBO_0000187", "HENRI_MICHAELIS_MENTEN_EQUATION__VMAX_FORM"),
    ...
    (
        "SBO_0000188",
        ("SBO_0000188", "NUMBER_OF_BIOCHEMICAL_ITEMS"),
    ...
    (
        "SBO_0000189",
        ("SBO_0000189", "NUMBER_OF_BINDING_SITES"),
    ...
    (
        "SBO_0000192",
        ("SBO_0000192", "HILL_TYPE_RATE_LAW__GENERALISED_FORM"),
    ...
    (
        "SBO_0000193",
        ("SBO_0000193", "EQUILIBRIUM_OR_STEADY_STATE_CONSTANT"),
    ...
    (
        "SBO_0000194",
        ("SBO_0000194", "PSEUDO_DISSOCIATION_CONSTANT"),
    ...
    (
        "SBO_0000195",
        ("SBO_0000195", "HILL_TYPE_RATE_LAW__MICROSCOPIC_FORM"),
    ...
    (
        "SBO_0000196",
        ("SBO_0000196", "CONCENTRATION_OF_AN_ENTITY_POOL"),
    ...
    (
        "SBO_0000197",
        ("SBO_0000197", "SPECIFIC_CONCENTRATION_OF_AN_ENTITY"),
    ...
    (
        "SBO_0000198",
        ("SBO_0000198", "HILL_TYPE_RATE_LAW__REDUCED_FORM"),
    ...
    (
        "SBO_0000199",
        ("SBO_0000199", "NORMALISED_ENZYMATIC_RATE_LAW_FOR_UNIREACTANT_ENZYMES"),
    ...
    (
        "SBO_0000205",
        ("SBO_0000205", "COMPOSITE_BIOCHEMICAL_PROCESS"),
    ...
    (
        "SBO_0000206",
        ("SBO_0000206", "COMPETITIVE_INHIBITOR"),
    ...
    (
        "SBO_0000207",
        ("SBO_0000207", "NON_COMPETITIVE_INHIBITOR"),
    ...
    (
        "SBO_0000208",
        ("SBO_0000208", "ACID_BASE_REACTION"),
        "acid-base reaction",
    ...
    (
        "SBO_0000210",
        ("SBO_0000210", "ADDITION_OF_A_CHEMICAL_GROUP"),
    ...
    (
        "SBO_0000211",
        ("SBO_0000211", "REMOVAL_OF_A_CHEMICAL_GROUP"),
    ...
    (
        "SBO_0000226",
        ("SBO_0000226", "DENSITY_OF_AN_ENTITY_POOL"),
    ...
    (
        "SBO_0000227",
        ("SBO_0000227", "MASS_DENSITY_OF_AN_ENTITY"),
    ...
    (
        "SBO_0000228",
        ("SBO_0000228", "VOLUME_DENSITY_OF_AN_ENTITY"),
    ...
    (
        "SBO_0000229",
        ("SBO_0000229", "AREA_DENSITY_OF_AN_ENTITY"),
    ...
    (
        "SBO_0000230",
        ("SBO_0000230", "LINEAR_DENSITY_OF_AN_ENTITY"),
    ...
    (
        "SBO_0000231",
        ("SBO_0000231", "OCCURRING_ENTITY_REPRESENTATION"),
    ...
    (
        "SBO_0000236",
        ("SBO_0000236", "PHYSICAL_ENTITY_REPRESENTATION"),
    ...
    (
        "SBO_0000237",
        ("SBO_0000237", "LOGICAL_COMBINATION"),
        "logical combination",
    ...
    (
        "SBO_0000239",
        ("SBO_0000239", "ALLOSTERIC_CONTROL"),
        "allosteric control",
    ...
    (
        "SBO_0000246",
        ("SBO_0000246", "INFORMATION_MACROMOLECULE"),
    ...
    (
        "SBO_0000248",
        ("SBO_0000248", "CHEMICAL_MACROMOLECULE"),
    ...
    (
        "SBO_0000251",
        ("SBO_0000251", "DEOXYRIBONUCLEIC_ACID"),
    ...
    (
        "SBO_0000253",
        ("SBO_0000253", "NON_COVALENT_COMPLEX"),
    ...
    (
        "SBO_0000254",
        ("SBO_0000254", "ELECTRICAL_RESISTANCE"),
    ...
    (
        "SBO_0000255",
        ("SBO_0000255", "PHYSICAL_CHARACTERISTIC"),
    ...
    (
        "SBO_0000256",
        ("SBO_0000256", "BIOCHEMICAL_PARAMETER"),
    ...
    (
        "SBO_0000261",
        ("SBO_0000261", "INHIBITORY_CONSTANT"),
        "inhibitory constant",
        "Synonym: Ki",
        (),
        False,
    ...
    (
        "SBO_0000263",
        ("SBO_0000263", "RELATIVE_EQUILIBRIUM_CONSTANT"),
    ...
    (
        "SBO_0000264",
        ("SBO_0000264", "RELATIVE_INHIBITION_CONSTANT"),
    ...
    (
        "SBO_0000268",
        ("SBO_0000268", "ENZYMATIC_RATE_LAW"),
        "enzymatic rate law",
    ...
    (
        "SBO_0000269",
        ("SBO_0000269", "ENZYMATIC_RATE_LAW_FOR_UNIREACTANT_ENZYMES"),
    ...
    (
        "SBO_0000272",
        ("SBO_0000272", "NUMBER_OF_INHIBITORS"),
    ...
    (
        "SBO_0000281",
        ("SBO_0000281", "EQUILIBRIUM_CONSTANT"),
    ...
    (
        "SBO_0000282",
        ("SBO_0000282", "DISSOCIATION_CONSTANT"),
    ...
    (
        "SBO_0000283",
        ("SBO_0000283", "ACID_DISSOCIATION_CONSTANT"),
    ...
    (
        "SBO_0000285",
        ("SBO_0000285", "MATERIAL_ENTITY_OF_UNSPECIFIED_NATURE"),
    ...
    (
        "SBO_0000289",
        ("SBO_0000289", "FUNCTIONAL_COMPARTMENT"),
    ...
    (
        "SBO_0000290",
        ("SBO_0000290", "PHYSICAL_COMPARTMENT"),
    ...
    (
        "SBO_0000292",
        ("SBO_0000292", "SPATIAL_CONTINUOUS_FRAMEWORK"),
    ...
    (
        "SBO_0000293",
        ("SBO_0000293", "NON_SPATIAL_CONTINUOUS_FRAMEWORK"),
    ...
    (
        "SBO_0000294",
        ("SBO_0000294", "SPATIAL_DISCRETE_FRAMEWORK"),
    ...
    (
        "SBO_0000295",
        ("SBO_0000295", "NON_SPATIAL_DISCRETE_FRAMEWORK"),
    ...
    (
        "SBO_0000296",
        ("SBO_0000296", "MACROMOLECULAR_COMPLEX"),
    ...
    (
        "SBO_0000298",
        ("SBO_0000298", "SYNTHETIC_CHEMICAL_COMPOUND"),
    ...
    (
        "SBO_0000300",
        ("SBO_0000300", "TOTAL_CONCENTRATION_OF_ENZYME"),
    ...
    (
        "SBO_0000301",
        ("SBO_0000301", "TOTAL_CATALYTIC_EFFICIENCY"),
    ...
    (
        "SBO_0000302",
        ("SBO_0000302", "CATALYTIC_EFFICIENCY"),
    ...
    (
        "SBO_0000303",
        ("SBO_0000303", "BIOCHEMICAL_POTENTIAL"),
    ...
    (
        "SBO_0000308",
        ("SBO_0000308", "EQUILIBRIUM_OR_STEADY_STATE_CHARACTERISTIC"),
    ...
    (
        "SBO_0000309",
        ("SBO_0000309", "DISSOCIATION_CHARACTERISTIC"),
    ...
    (
        "SBO_0000310",
        ("SBO_0000310", "ACID_DISSOCIATION_CHARACTERISTIC"),
    ...
    (
        "SBO_0000311",
        ("SBO_0000311", "HETEROGENEOUS_NUCLEAR_RNA"),
    ...
    (
        "SBO_0000312",
        ("SBO_0000312", "MATURE_MESSENGER_RNA"),
    ...
    (
        "SBO_0000317",
        ("SBO_0000317", "SMALL_INTERFERING_RNA"),
    ...
    (
        "SBO_0000319",
        ("SBO_0000319", "SMALL_NUCLEOLAR_RNA"),
        "small nucleolar RNA",
        "Synonym: snoRNA",
        (),
        False,
    ...
    (
        "SBO_0000320",
        ("SBO_0000320", "PRODUCT_CATALYTIC_RATE_CONSTANT"),
    ...
    (
        "SBO_0000321",
        ("SBO_0000321", "SUBSTRATE_CATALYTIC_RATE_CONSTANT"),
    ...
    (
        "SBO_0000322",
        ("SBO_0000322", "MICHAELIS_CONSTANT_FOR_SUBSTRATE"),
    ...
    (
        "SBO_0000323",
        ("SBO_0000323", "MICHAELIS_CONSTANT_FOR_PRODUCT"),
    ...
    (
        "SBO_0000324",
        ("SBO_0000324", "FORWARD_MAXIMAL_VELOCITY"),
    ...
    (
        "SBO_0000325",
        ("SBO_0000325", "REVERSE_MAXIMAL_VELOCITY"),
    ...
    (
        "SBO_0000326",
        ("SBO_0000326", "ENZYMATIC_RATE_LAW_FOR_NON_MODULATED_UNIREACTANT_ENZYMES"),
    ...
    (
        "SBO_0000327",
        ("SBO_0000327", "NON_MACROMOLECULAR_ION"),
    ...
    (
        "SBO_0000328",
        ("SBO_0000328", "NON_MACROMOLECULAR_RADICAL"),
    ...
    (
        "SBO_0000329",
        ("SBO_0000329", "TRANSCRIPTION_START_SITE"),
    ...
    (
        "SBO_0000332",
        ("SBO_0000332", "HALF_LIFE_OF_AN_EXPONENTIAL_DECAY"),
    ...
    (
        "SBO_0000333",
        ("SBO_0000333", "MONOEXPONENTIAL_DECAY_RATE_LAW"),
    ...
    (
        "SBO_0000335",
        ("SBO_0000335", "GENE_CODING_REGION"),
        "gene coding region",
    ...
    (
        "SBO_0000337",
        ("SBO_0000337", "ASSOCIATION_CONSTANT"),
    ...
    (
        "SBO_0000338",
        ("SBO_0000338", "DISSOCIATION_RATE_CONSTANT"),
    ...
    (
        "SBO_0000339",
        ("SBO_0000339", "BIMOLECULAR_ASSOCIATION_RATE_CONSTANT"),
    ...
    (
        "SBO_0000340",
        ("SBO_0000340", "TRIMOLECULAR_ASSOCIATION_RATE_CONSTANT"),
    ...
    (
        "SBO_0000341",
        ("SBO_0000341", "ASSOCIATION_RATE_CONSTANT"),
    ...
    (
        "SBO_0000342",
        ("SBO_0000342", "MOLECULAR_OR_GENETIC_INTERACTION"),
    ...
    (
        "SBO_0000343",
        ("SBO_0000343", "GENETIC_INTERACTION"),
        "genetic interaction",
    ...
    (
        "SBO_0000344",
        ("SBO_0000344", "MOLECULAR_INTERACTION"),
    ...
    (
        "SBO_0000348",
        ("SBO_0000348", "EXPONENTIAL_TIME_CONSTANT"),
    ...
    (
        "SBO_0000349",
        ("SBO_0000349", "INACTIVATION_RATE_CONSTANT"),
    ...
    (
        "SBO_0000350",
        ("SBO_0000350", "FORWARD_REACTION_VELOCITY"),
    ...
    (
        "SBO_0000352",
        ("SBO_0000352", "REVERSE_ZEROTH_ORDER_RATE_CONSTANT"),
    ...
    (
        "SBO_0000353",
        ("SBO_0000353", "REVERSE_REACTION_VELOCITY"),
    ...
    (
        "SBO_0000354",
        ("SBO_0000354", "INFORMATIONAL_MOLECULE_SEGMENT"),
    ...
    (
        "SBO_0000357",
        ("SBO_0000357", "BIOLOGICAL_EFFECT_OF_A_PERTURBATION"),
    ...
    (
        "SBO_0000359",
        ("SBO_0000359", "MASS_CONSERVATION_LAW"),
    ...
    (
        "SBO_0000360",
        ("SBO_0000360", "QUANTITY_OF_AN_ENTITY_POOL"),
    ...
    (
        "SBO_0000361",
        ("SBO_0000361", "AMOUNT_OF_AN_ENTITY_POOL"),
    ...
    (
        "SBO_0000362",
        ("SBO_0000362", "CONCENTRATION_CONSERVATION_LAW"),
    ...
    (
        "SBO_0000363",
        ("SBO_0000363", "ACTIVATION_CONSTANT"),
        "activation constant",
        "Synonym: Kx",
        (),
        False,
    ...
    (
        "SBO_0000364",
        ("SBO_0000364", "MULTIMER_CARDINALITY"),
    ...
    (
        "SBO_0000365",
        ("SBO_0000365", "FORWARD_NON_INTEGRAL_ORDER_RATE_CONSTANT__CONTINUOUS_CASE"),
    ...
    (
        "SBO_0000366",
        ("SBO_0000366", "FORWARD_NON_INTEGRAL_ORDER_RATE_CONSTANT__DISCRETE_CASE"),
    ...
    (
        "SBO_0000367",
        ("SBO_0000367", "REVERSE_NON_INTEGRAL_ORDER_RATE_CONSTANT__DISCRETE_CASE"),
    ...
    (
        "SBO_0000368",
        ("SBO_0000368", "REVERSE_NON_INTEGRAL_ORDER_RATE_CONSTANT__CONTINUOUS_CASE"),
    ...
    (
        "SBO_0000369",
        ("SBO_0000369", "GENE_REGULATORY_REGION"),
    ...
    (
        "SBO_0000370",
        ("SBO_0000370", "MICHAELIS_CONSTANT_IN_NON_EQUILIBRIUM_SITUATION"),
    ...
    (
        "SBO_0000371",
        ("SBO_0000371", "MICHAELIS_CONSTANT_IN_QUASI_STEADY_STATE_SITUATION"),
    ...
    (
        "SBO_0000372",
        ("SBO_0000372", "MICHAELIS_CONSTANT_IN_IRREVERSIBLE_SITUATION"),
    ...
    (
        "SBO_0000373",
        ("SBO_0000373", "MICHAELIS_CONSTANT_IN_FAST_EQUILIBRIUM_SITUATION"),
    ...
    (
        "SBO_0000380",
        ("SBO_0000380", "BIOCHEMICAL_COEFFICIENT"),
    ...
    (
        "SBO_0000381",
        ("SBO_0000381", "BIOCHEMICAL_PROPORTIONALITY_COEFFICIENT"),
    ...
    (
        "SBO_0000382",
        ("SBO_0000382", "BIOCHEMICAL_EXPONENTIAL_COEFFICIENT"),
    ...
    (
        "SBO_0000383",
        ("SBO_0000383", "BIOCHEMICAL_COOPERATIVE_INHIBITION_COEFFICIENT"),
    ...
    (
        "SBO_0000384",
        ("SBO_0000384", "BIOCHEMICAL_INHIBITORY_PROPORTIONALITY_COEFFICIENT"),
    ...
    (
        "SBO_0000385",
        ("SBO_0000385", "BIOCHEMICAL_COOPERATIVE_INHIBITOR_SUBSTRATE_COEFFICIENT"),
    ...
    (
        "SBO_0000391",
        ("SBO_0000391", "STEADY_STATE_EXPRESSION"),
    ...
    (
        "SBO_0000395",
        ("SBO_0000395", "ENCAPSULATING_PROCESS"),
    ...
    (
        "SBO_0000398",
        ("SBO_0000398", "LOGICAL_RELATIONSHIP"),
    ...
    (
        "SBO_0000402",
        ("SBO_0000402", "TRANSFER_OF_A_CHEMICAL_GROUP"),
    ...
    (
        "SBO_0000404",
        ("SBO_0000404", "UNIT_OF_GENETIC_INFORMATION"),
    ...
    (
        "SBO_0000407",
        ("SBO_0000407", "ABSOLUTE_INHIBITION"),
        "absolute inhibition",
    ...
    (
        "SBO_0000408",
        ("SBO_0000408", "BIOLOGICAL_ACTIVITY"),
        "biological activity",
    ...
    (
        "SBO_0000409",
        ("SBO_0000409", "INTERACTION_OUTCOME"),
        "interaction outcome",
    ...
    (
        "SBO_0000410",
        ("SBO_0000410", "IMPLICIT_COMPARTMENT"),
    ...
    (
        "SBO_0000411",
        ("SBO_0000411", "ABSOLUTE_STIMULATION"),
    ...
    (
        "SBO_0000413",
        ("SBO_0000413", "POSITIONAL_RELATIONSHIP"),
    ...
    (
        "SBO_0000418",
        ("SBO_0000418", "MULTIMER_OF_COMPLEXES"),
    ...
    (
        "SBO_0000419",
        ("SBO_0000419", "MULTIMER_OF_INFORMATIONAL_MOLECULE_SEGMENT"),
    ...
    (
        "SBO_0000420",
        ("SBO_0000420", "MULTIMER_OF_MACROMOLECULES"),
    ...
    (
        "SBO_0000421",
        ("SBO_0000421", "MULTIMER_OF_SIMPLE_CHEMICALS"),
    ...
    (
        "SBO_0000422",
        ("SBO_0000422", "ISOINHIBITION_CONSTANT"),
    ...
    (
        "SBO_0000423",
        ("SBO_0000423", "PSEUDO_DISSOCIATION_CONSTANT_FOR_PRODUCT"),
    ...
    (
        "SBO_0000424",
        ("SBO_0000424", "PSEUDO_DISSOCIATION_CONSTANT_FOR_SUBSTRATE"),
    ...
    (
        "SBO_0000425",
        ("SBO_0000425", "REVERSIBLE_HILL_TYPE_ENZYMATIC_RATE_LAW"),
    ...
    (
        "SBO_0000426",
        ("SBO_0000426", "MODULATED_REVERSIBLE_HILL_TYPE_RATE_LAW"),
    ...
    (
        "SBO_0000427",
        ("SBO_0000427", "MODULATED_REVERSIBLE_HILL_TYPE_RATE_LAW_WITH_ONE_MODIFIER"),
    ...
    (
        "SBO_0000428",
        ("SBO_0000428", "MODULATED_REVERSIBLE_HILL_TYPE_RATE_LAW_WITH_TWO_MODIFIERS"),
    ...
    (
        "SBO_0000429",
        ("SBO_0000429", "ENZYMATIC_RATE_LAW_FOR_MULTIREACTANT_ENZYMES"),
    ...
    (
        "SBO_0000430",
        ("SBO_0000430", "ENZYMATIC_RATE_LAW_FOR_MODULATED_UNIREACTANT_ENZYMES"),
    ...
    (
        "SBO_0000431",
        ("SBO_0000431", "UNMODULATED_REVERSIBLE_HILL_TYPE_RATE_LAW"),
    ...
    (
        "SBO_0000432",
        ("SBO_0000432", "IRREVERSIBLE_MICHAELIS_MENTEN_RATE_LAW_FOR_TWO_SUBSTRATES"),
    ...
    (
        "SBO_0000433",
        ("SBO_0000433", "ORDERED_BI_BI_MECHANISM_RATE_LAW"),
    ...
    (
        "SBO_0000434",
        ("SBO_0000434", "ORDERED_BI_UNI_MECHANISM_RATE_LAW"),
    ...
    (
        "SBO_0000435",
        ("SBO_0000435", "ORDERED_UNI_BI_MECHANISM_RATE_LAW"),
    ...
    (
        "SBO_0000436",
        ("SBO_0000436", "PING_PONG_BI_BI_MECHANISM_RATE_LAW"),
    ...
    (
        "SBO_0000437",
        ("SBO_0000437", "REVERSIBLE_ISO_UNI_UNI"),
    ...
    (
        "SBO_0000438",
        ("SBO_0000438", "REVERSIBLE_UNI_UNI"),
        "reversible Uni-Uni",
    ...
    (
        "SBO_0000439",
        ("SBO_0000439", "UNI_UNI_REVERSIBLE_USING_HALDANE_RELATIONSHIP"),
    ...
    (
        "SBO_0000440",
        ("SBO_0000440", "ENZYMATIC_RATE_LAW_FOR_IRREVERSIBLE_ALLOSTERIC_INHIBITION"),
    ...
    (
        "SBO_0000443",
        ("SBO_0000443", "ENZYMATIC_RATE_LAW_FOR_REVERSIBLE_ESSENTIAL_ACTIVATION"),
    ...
    (
        "SBO_0000444",
        ("SBO_0000444", "ENZYMATIC_RATE_LAW_FOR_REVERSIBLE_MIXED_ACTIVATION"),
    ...
    (
        "SBO_0000445",
        ("SBO_0000445", "ENZYMATIC_RATE_LAW_FOR_IRREVERSIBLE_SUBSTRATE_ACTIVATION"),
    ...
    (
        "SBO_0000446",
        ("SBO_0000446", "ENZYMATIC_RATE_LAW_FOR_IRRREVERSIBLE_MIXED_ACTIVATION"),
    ...
    (
        "SBO_0000448",
        ("SBO_0000448", "ENZYMATIC_RATE_LAW_FOR_REVERSIBLE_SPECIFIC_ACTIVATION"),
        "enzymatic rate law for reversible specific activation",
    ...
    (
        "SBO_0000450",
        ("SBO_0000450", "ENZYMATIC_RATE_LAW_FOR_IRREVERSIBLE_SPECIFIC_ACTIVATION"),
        "enzymatic rate law for irreversible specific activation",
    ...
    (
        "SBO_0000454",
        ("SBO_0000454", "ENZYMATIC_RATE_LAW_FOR_REVERSIBLE_SUBSTRATE_INHIBITION"),
    ...
    (
        "SBO_0000455",
        ("SBO_0000455", "ENZYMATIC_RATE_LAW_FOR_IRREVERSIBLE_SUBSTRATE_INHIBITION"),
    ...
    (
        "SBO_0000460",
        ("SBO_0000460", "ENZYMATIC_CATALYST"),
        "enzymatic catalyst",
    ...
    (
        "SBO_0000461",
        ("SBO_0000461", "ESSENTIAL_ACTIVATOR"),
        "essential activator",
    ...
    (
        "SBO_0000462",
        ("SBO_0000462", "NON_ESSENTIAL_ACTIVATOR"),
    ...
    (
        "SBO_0000463",
        ("SBO_0000463", "STANDARD_BIOCHEMICAL_POTENTIAL"),
    ...
    (
        "SBO_0000464",
        ("SBO_0000464", "STATE_VARIABLE_ASSIGNMENT"),
    ...
    (
        "SBO_0000471",
        ("SBO_0000471", "MOLAL_CONCENTRATION_OF_AN_ENTITY"),
    ...
    (
        "SBO_0000472",
        ("SBO_0000472", "MOLAR_CONCENTRATION_OF_AN_ENTITY"),
    ...
    (
        "SBO_0000474",
        ("SBO_0000474", "CONVENIENCE_FUNCTION"),
    ...
    (
        "SBO_0000475",
        ("SBO_0000475", "PERIODIC_FORCING_FUNCTION"),
    ...
    (
        "SBO_0000478",
        ("SBO_0000478", "POWERED_PRODUCT_OF_MICHAELIS_CONSTANT"),
    ...
    (
        "SBO_0000479",
        ("SBO_0000479", "POWERED_PRODUCT_OF_SUBSTRATE_MICHAELIS_CONSTANTS"),
    ...
    (
        "SBO_0000480",
        ("SBO_0000480", "POWERED_PRODUCT_OF_PRODUCT_MICHAELIS_CONSTANTS"),
    ...
    (
        "SBO_0000481",
        ("SBO_0000481", "STOICHIOMETRIC_COEFFICIENT"),
    ...
    (
        "SBO_0000482",
        ("SBO_0000482", "GEOMETRIC_MEAN_RATE_CONSTANT"),
    ...
    (
        "SBO_0000483",
        ("SBO_0000483", "FORWARD_GEOMETRIC_MEAN_RATE_CONSTANT"),
    ...
    (
        "SBO_0000484",
        ("SBO_0000484", "REVERSE_GEOMETRIC_MEAN_RATE_CONSTANT"),
    ...
    (
        "SBO_0000485",
        ("SBO_0000485", "BASAL_RATE_CONSTANT"),
        "basal rate constant",
    ...
    (
        "SBO_0000486",
        ("SBO_0000486", "RELATIVE_BASAL_RATE_CONSTANT"),
    ...
    (
        "SBO_0000487",
        ("SBO_0000487", "RELATIVE_ACTIVITY_FUNCTION"),
    ...
    (
        "SBO_0000488",
        ("SBO_0000488", "RELATIVE_ACTIVATION_FUNCTION"),
    ...
    (
        "SBO_0000489",
        ("SBO_0000489", "RELATIVE_INHIBITION_FUNCTION"),
    ...
    (
        "SBO_0000490",
        ("SBO_0000490", "NUMBER_OF_PRODUCTS"),
        "number of products",
    ...
    (
        "SBO_0000491",
        ("SBO_0000491", "DIFFUSION_COEFFICIENT"),
    ...
    (
        "SBO_0000496",
        ("SBO_0000496", "TRANSMEMBRANE_DOMAIN"),
    ...
    (
        "SBO_0000500",
        ("SBO_0000500", "GENETIC_SUPPRESSION"),
        "genetic suppression",
    ...
    (
        "SBO_0000501",
        ("SBO_0000501", "GENETIC_ENHANCEMENT"),
        "genetic enhancement",
    ...
    (
        "SBO_0000502",
        ("SBO_0000502", "SYNTHETIC_LETHALITY"),
        "synthetic lethality",
    ...
    (
        "SBO_0000503",
        ("SBO_0000503", "NUMBER_OF_ENTITY_POOL_CONSTITUENTS"),
    ...
    (
        "SBO_0000504",
        ("SBO_0000504", "MASS_OF_AN_ENTITY_POOL"),
    ...
    (
        "SBO_0000505",
        ("SBO_0000505", "CONCENTRATION_OF_ENZYME"),
    ...
    (
        "SBO_0000507",
        ("SBO_0000507", "NUMBER_OF_AN_ENZYME"),
        "number of an enzyme",
    ...
    (
        "SBO_0000508",
        ("SBO_0000508", "NUMBER_OF_A_REACTANT"),
    ...
    (
        "SBO_0000509",
        ("SBO_0000509", "CONCENTRATION_OF_REACTANT"),
    ...
    (
        "SBO_0000511",
        ("SBO_0000511", "NUMBER_OF_A_PRODUCT"),
        "number of a product",
    ...
    (
        "SBO_0000512",
        ("SBO_0000512", "CONCENTRATION_OF_PRODUCT"),
    ...
    (
        "SBO_0000514",
        ("SBO_0000514", "NUMBER_OF_A_SUBSTRATE"),
    ...
    (
        "SBO_0000515",
        ("SBO_0000515", "CONCENTRATION_OF_SUBSTRATE"),
    ...
    (
        "SBO_0000517",
        ("SBO_0000517", "NUMBER_OF_A_MODIFIER"),
    ...
    (
        "SBO_0000518",
        ("SBO_0000518", "CONCENTRATION_OF_MODIFIER"),
    ...
    (
        "SBO_0000520",
        ("SBO_0000520", "NUMBER_OF_AN_INHIBITOR"),
    ...
    (
        "SBO_0000521",
        ("SBO_0000521", "CONCENTRATION_OF_INHIBITOR"),
    ...
    (
        "SBO_0000523",
        ("SBO_0000523", "NUMBER_OF_AN_ACTIVATOR"),
    ...
    (
        "SBO_0000524",
        ("SBO_0000524", "CONCENTRATION_OF_ACTIVATOR"),
    ...
    (
        "SBO_0000526",
        ("SBO_0000526", "PROTEIN_COMPLEX_FORMATION"),
    ...
    (
        "SBO_0000528",
        ("SBO_0000528", "COMMON_MODULAR_RATE_LAW"),
    ...
    (
        "SBO_0000529",
        ("SBO_0000529", "DIRECT_BINDING_MODULAR_RATE_LAW"),
    ...
    (
        "SBO_0000530",
        ("SBO_0000530", "SIMULTANEOUS_BINDING_MODULAR_RATE_LAW"),
    ...
    (
        "SBO_0000531",
        ("SBO_0000531", "POWER_LAW_MODULAR_RATE_LAW"),
    ...
    (
        "SBO_0000532",
        ("SBO_0000532", "FORCE_DEPENDENT_MODULAR_RATE_LAW"),
    ...
    (
        "SBO_0000533",
        ("SBO_0000533", "SPECIFIC_ACTIVATOR"),
        "specific activator",
    ...
    (
        "SBO_0000534",
        ("SBO_0000534", "CATALYTIC_ACTIVATOR"),
        "catalytic activator",
    ...
    (
        "SBO_0000537",
        ("SBO_0000537", "COMPLETE_INHIBITOR"),
        "complete inhibitor",
    ...
    (
        "SBO_0000538",
        ("SBO_0000538", "IONIC_PERMEABILITY"),
        "ionic permeability",
    ...
    (
        "SBO_0000539",
        ("SBO_0000539", "PROBABILISTIC_PARAMETER"),
    ...
    (
        "SBO_0000540",
        ("SBO_0000540", "FRACTION_OF_AN_ENTITY_POOL"),
    ...
    (
        "SBO_0000542",
        ("SBO_0000542", "BASIC_REPRODUCTIVE_RATIO"),
    ...
    (
        "SBO_0000544",
        ("SBO_0000544", "METADATA_REPRESENTATION"),
    ...
    (
        "SBO_0000545",
        ("SBO_0000545", "SYSTEMS_DESCRIPTION_PARAMETER"),
    ...
    (
        "SBO_0000546",
        ("SBO_0000546", "QUALITATIVE_SYSTEMS_DESCRIPTION_PARAMETER"),
    ...
    (
        "SBO_0000547",
        ("SBO_0000547", "BOOLEAN_LOGICAL_FRAMEWORK"),
    ...
    (
        "SBO_0000548",
        ("SBO_0000548", "MULTI_VALUED_LOGICAL_FRAMEWORK"),
    ...
    (
        "SBO_0000549",
        ("SBO_0000549", "FUZZY_LOGICAL_FRAMEWORK"),
    ...
    (
        "SBO_0000551",
        ("SBO_0000551", "CONTROLLED_SHORT_LABEL"),
    ...
    (
        "SBO_0000552",
        ("SBO_0000552", "REFERENCE_ANNOTATION"),
    ...
    (
        "SBO_0000553",
        ("SBO_0000553", "BIBLIOGRAPHICAL_REFERENCE"),
    ...
    (
        "SBO_0000554",
        ("SBO_0000554", "DATABASE_CROSS_REFERENCE"),
    ...
    (
        "SBO_0000555",
        ("SBO_0000555", "CONTROLLED_ANNOTATION"),
    ...
    (
        "SBO_0000556",
        ("SBO_0000556", "UNCONTROLLED_ANNOTATION"),
    ...
    (
        "SBO_0000557",
        ("SBO_0000557", "EMBEDDED_ANNOTATION"),
        "embedded annotation",
    ...
    (
        "SBO_0000565",
        ("SBO_0000565", "SYSTEMS_DESCRIPTION_CONSTANT"),
    ...
    (
        "SBO_0000566",
        ("SBO_0000566", "RELATIVE_PERMEABILITY"),
    ...
    (
        "SBO_0000567",
        ("SBO_0000567", "UNIVERSAL_GAS_CONSTANT"),
    ...
    (
        "SBO_0000571",
        ("SBO_0000571", "THERMODYNAMIC_PARAMETER"),
    ...
    (
        "SBO_0000574",
        ("SBO_0000574", "STANDARD_ENTHALPY_OF_FORMATION"),
    ...
    (
        "SBO_0000575",
        ("SBO_0000575", "STANDARD_ENTHALPY_OF_REACTION"),
    ...
    (
        "SBO_0000578",
        ("SBO_0000578", "STANDARD_ENTROPY_OF_REACTION_"),
    ...
    (
        "SBO_0000579",
        ("SBO_0000579", "STANDARD_ENTROPY_OF_FORMATION"),
    ...
    (
        "SBO_0000581",
        ("SBO_0000581", "GIBBS_FREE_ENERGY_CHANGE"),
    ...
    (
        "SBO_0000582",
        ("SBO_0000582", "STANDARD_GIBBS_FREE_ENERGY_OF_FORMATION"),
    ...
    (
        "SBO_0000583",
        ("SBO_0000583", "STANDARD_GIBBS_FREE_ENERGY_OF_REACTION"),
    ...
    (
        "SBO_0000585",
        ("SBO_0000585", "SIMULATION_DURATION"),
        "simulation duration",
    ...
    (
        "SBO_0000587",
        ("SBO_0000587", "TRANSCELLULAR_MEMBRANE_INFLUX_REACTION"),
    ...
    (
        "SBO_0000588",
        ("SBO_0000588", "TRANSCELLULAR_MEMBRANE_EFFLUX_REACTION"),
    ...
    (
        "SBO_0000589",
        ("SBO_0000589", "GENETIC_PRODUCTION"),
        "genetic production",
    ...
    (
        "SBO_0000591",
        ("SBO_0000591", "PETRI_NET_TRANSITION"),
    ...
    (
        "SBO_0000592",
        ("SBO_0000592", "DISCRETE_AMOUNT_OF_AN_ENTITY_POOL"),
    ...
    (
        "SBO_0000594",
        ("SBO_0000594", "NEUTRAL_PARTICIPANT"),
        "neutral participant",
    ...
    (
        "SBO_0000595",
        ("SBO_0000595", "DUAL_ACTIVITY_MODIFIER"),
    ...
    (
        "SBO_0000596",
        ("SBO_0000596", "MODIFIER_OF_UNKNOWN_ACTIVITY"),
    ...
    (
        "SBO_0000605",
        ("SBO_0000605", "HIGH_AFFINITY_RECEPTOR"),
    ...
    (
        "SBO_0000606",
        ("SBO_0000606", "LOW_AFFINITY_RECEPTOR"),
    ...
    (
        "SBO_0000611",
        ("SBO_0000611", "EFFECTIVE_CATALYTIC_RATE"),
    ...
    (
        "SBO_0000613",
        ("SBO_0000613", "REACTION_PARAMETER"),
        "reaction parameter",
    ...
    (
        "SBO_0000614",
        ("SBO_0000614", "RATE_OF_REACTION__CONCENTRATION_"),
    ...
    (
        "SBO_0000615",
        ("SBO_0000615", "RATE_OF_REACTION__AMOUNT_"),
    ...
    (
        "SBO_0000616",
        ("SBO_0000616", "EXTENT_OF_REACTION"),
        "extent of reaction",
    ...
    (
        "SBO_0000617",
        ("SBO_0000617", "GIBBS_FREE_ENERGY_OF_REACTION"),
    ...
    (
        "SBO_0000619",
        ("SBO_0000619", "TRANSFORMED_GIBBS_FREE_ENERGY_CHANGE"),
    ...
    (
        "SBO_0000620",
        ("SBO_0000620", "TRANSFORMED_STANDARD_GIBBS_FREE_ENERGY_OF_REACTION"),
    ...
    (
        "SBO_0000621",
        ("SBO_0000621", "TRANSFORMED_STANDARD_GIBBS_FREE_ENERGY_OF_FORMATION"),
    ...
    (
        "SBO_0000622",
        ("SBO_0000622", "TRANSFORMED_GIBBS_FREE_ENERGY_OF_REACTION"),
    ...
    (
        "SBO_0000624",
        ("SBO_0000624", "FLUX_BALANCE_FRAMEWORK"),
    ...
    (
        "SBO_0000626",
        ("SBO_0000626", "DEFAULT_FLUX_BOUND"),
        "default flux bound",
    ...
    (
        "SBO_0000629",
        ("SBO_0000629", "BIOMASS_PRODUCTION"),
        "biomass production",
    ...
    (
        "SBO_0000636",
        ("SBO_0000636", "ALLOSTERIC_ACTIVATOR"),
    ...
    (
        "SBO_0000637",
        ("SBO_0000637", "NON_ALLOSTERIC_ACTIVATOR"),
    ...
    (
        "SBO_0000638",
        ("SBO_0000638", "IRREVERSIBLE_INHIBITOR"),
    ...
    (
        "SBO_0000639",
        ("SBO_0000639", "ALLOSTERIC_INHIBITOR"),
    ...
    (
        "SBO_0000640",
        ("SBO_0000640", "UNCOMPETITIVE_INHIBITOR"),
    ...
    (
        ...
        (
            "SBO_0000646",
            "MASS_ACTION_RATE_LAW_FOR_REVERSIBLE_REACTIONS__CONTINUOUS_SCHEMA",
        ),
    ...
    (
        "SBO_0000648",
        ("SBO_0000648", "PROTEIN_MOLECULAR_MASS"),
    ...
    (
        "SBO_0000650",
        ("SBO_0000650", "REVERSIBLE_PROCESS"),
        "reversible process",
    ...
    (
        "SBO_0000651",
        ("SBO_0000651", "IRREVERSIBLE_PROCESS"),
    ...
    (
        "SBO_0000654",
        ("SBO_0000654", "CO_TRANSPORT_REACTION"),
    ...
    (
        "SBO_0000655",
        ("SBO_0000655", "TRANSPORT_REACTION"),
        "transport reaction",
    ...
    (
        "SBO_0000659",
        ("SBO_0000659", "SYMPORTER_MEDIATED_TRANSPORT"),
    ...
    (
        "SBO_0000660",
        ("SBO_0000660", "ANTIPORTER_MEDIATED_TRANSPORT"),
    ...
    (
        "SBO_0000663",
        ("SBO_0000663", "FRACTIONAL_OCCUPANCY"),
    ...
    (
        "SBO_0000667",
        ("SBO_0000667", "PROTEIN_CHAIN_LENGTH"),
    ...
    (
        "SBO_0000669",
        ("SBO_0000669", "BIOMASS_YIELD_ON_SUBSTRATE"),
    ...
    (
        "SBO_0000670",
        ("SBO_0000670", "PRODUCT_YIELD_ON_SUBSTRATE"),
    ...
    (
        "SBO_0000671",
        ("SBO_0000671", "NON_ENZYMATIC_CATALYST"),
    ...
    (
        "SBO_0000672",
        ("SBO_0000672", "SPONTANEOUS_REACTION"),
    ...
    (
        "SBO_0000673",
        ("SBO_0000673", "FORWARD_EFFECTIVE_CATALYTIC_RATE"),
    ...
    (
        "SBO_0000674",
        ("SBO_0000674", "REVERSE_EFFECTIVE_CATALYTIC_RATE"),
    ...
    (
        "SBO_0000675",
        ("SBO_0000675", "DETERMINISTIC_NON_SPATIAL_CONTINUOUS_FRAMEWORK"),
    ...
    (
        "SBO_0000676",
        ("SBO_0000676", "STOCHASTIC_NON_SPATIAL_CONTINUOUS_FRAMEWORK"),
    ...
    (
        "SBO_0000677",
        ("SBO_0000677", "POPULATION_BASED_DISCRETE_SPATIAL_SIMULATION"),
    ...
    (
        "SBO_0000678",
        ("SBO_0000678", "PARTICLE_BASED_DISCRETE_SPATIAL_SIMULATION"),
    ...
    (
        "SBO_0000679",
        ("SBO_0000679", "POPULATION_BASED_DISCRETE_NON_SPATIAL_SIMULATION"),
    ...
    (
        "SBO_0000680",
        ("SBO_0000680", "PARTICLE_BASED_DISCRETE_NON_SPATIAL_SIMULATION"),
    ...
    (
        "SBO_0000682",
        ("SBO_0000682", "HYBRID_SPATIAL_FRAMEWORK"),
    ...
    (
        "SBO_0000683",
        ("SBO_0000683", "HYBRID_NON_SPATIAL_FRAMEWORK"),
    ...
    (
        ...
        (
            "SBO_0000684",
            "HYBRID_FLUX_BALANCE_DETERMINISTIC_CONTINUOUS_NON_SPATIAL_FRAMEWORK",
        ),
    ...
    (
        "SBO_0000685",
        ("SBO_0000685", "HYBRID_FLUX_BALANCE_DISCRETE_NON_SPATIAL_FRAMEWORK"),
    ...
    (
        "SBO_0000687",
        ("SBO_0000687", "HYBRID_FLUX_BALANCE_LOGICAL_NON_SPATIAL_FRAMEWORK"),
    ...
    (
        "SBO_0000688",
        ("SBO_0000688", "HYBRID_FLUX_LOGICAL_DISCRETE_NON_SPATIAL_FRAMEWORK"),
    ...
    (
        "SBO_0000689",
        ("SBO_0000689", "HYBRID_CONTINUOUS_DISCRETE_NON_SPATIAL_FRAMEWORK"),
    ...
    (
        ...
        (
            "SBO_0000690",
            "HYBRID_DETERMINISTIC_CONTINUOUS_DISCRETE_NON_SPATIAL_FRAMEWORK",
        ),
    ...
    (
        "SBO_0000691",
        ("SBO_0000691", "HYBRID_STOCHASTIC_CONTINUOUS_DISCRETE_NON_SPATIAL_FRAMEWORK"),
    ...
    (
        "SBO_0000692",
        ("SBO_0000692", "RESOURCE_BALANCE_FRAMEWORK"),
    ...
    (
        "SBO_0000693",
        ("SBO_0000693", "CONSTRAINT_BASED_FRAMEWORK"),
    ...
    (
        "SBO_0000694",
        ("SBO_0000694", "OPTIMIZATION_FRAMEWORK"),
    ...
    ("part_of", ("part_of", "PART_OF"), "part of", None, (), False),
]

SBO._register(_terms)
