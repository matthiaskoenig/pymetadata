...
> König, M. (2026). *pymetadata are python utilities for working with metadata* (Version 0.6.5) [Computer software]. Zenodo. https://doi.org/10.5281/zenodo.22903506
...
@software{konig_pymetadata,
  ...
  version   = {0.6.5},
  publisher = {Zenodo},
  doi       = {10.5281/zenodo.22903506},
  url       = {https://doi.org/10.5281/zenodo.22903506},
}
```
